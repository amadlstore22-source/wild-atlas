...
export const TOURS: Tour[] = [
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "Wie sind die Sanitäranlagen und Duschen im Camp?", a: "Die festen Camps, die wir nutzen, haben Sanitärzelte mit fließendem Wasser und einer richtigen Dusche — privat oder gemeinschaftlich je nach Camp. Der Wasserdruck mitten im Erg ist bescheiden und warmes Wasser nicht zu jeder Stunde garantiert, aber es ist eine echte Dusche und kein Eimer. Wenn Ihnen ein Zelt mit eigenem Bad wichtig ist, sagen Sie es bei der Buchung, und wir kalkulieren ein Camp, das solche hat." },
      { q: "Kann ich mein Handy in der Wüste laden?", a: "Am Abend gibt es im Camp Strom über einen Generator, genug für Handy oder Kamera-Akku. Nachts wird er abgeschaltet, und das ist Absicht — die Stille und die Dunkelheit machen den größten Teil des Reizes aus. Nehmen Sie eine Powerbank mit, wenn Sie für Fotos auf Ihr Handy angewiesen sind." },
