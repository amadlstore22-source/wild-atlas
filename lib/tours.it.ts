...
export const TOURS: Tour[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seoTitle: "Trekking Vetta Toubkal 4 Giorni",
    seoDescription: "Conquista il Jbel Toubkal (4.167 m) con una guida berbera autorizzata. Trekking di 4 giorni da Marrakech — rifugi, tutti i pasti e trasferimento incluso.",
    featured: true,
  },
  {
    id: "2",
    ...
    faq: [
      ...
      { q: "Com'è la notte nel campo nel deserto?", a: "Letti con coperte in tenda, cena insieme e silenzio assoluto una volta che il campo si addormenta. Le dune sono davvero buie, motivo per cui la maggior parte dei viaggiatori ricorda il cielo stellato più della cavalcata in cammello. Porta uno strato caldo — le notti nel deserto sono fredde fuori dall'estate." },
      ...
      { q: "Come sono i servizi igienici e le docce al campo?", a: "I campi permanenti che utilizziamo hanno tende bagno con acqua corrente e una vera doccia — privata o condivisa a seconda del campo. La pressione in mezzo all'Erg è modesta, ma è una vera doccia calda e non un secchio. Se vi interessa una tenda con bagno privato, ditecelo alla prenotazione e vi proporremo un campo che ne dispone." },
      { q: "Posso ricaricare il telefono nel deserto?", a: "Sì. Il campo ha la corrente, quindi telefoni e batterie della fotocamera si ricaricano, e c'è il wifi: lento in mezzo alle dune, ma sufficiente per messaggi e foto." },
    ...
    seoTitle: "Tour del Deserto del Sahara 3 Giorni",
    seoDescription: "Trekking in cammello nell'Erg Chebbi al tramonto e notte sotto le stelle. Tour di 3 giorni da Marrakech al Sahara con Aït Ben Haddou.",
    featured: true,
  },
  {
    id: "3",
    ...
    seoDescription: "Escursione alle cascate di Setti Fatma tra villaggi berberi e torrenti di montagna, a soli 45 minuti da Marrakech.",
    featured: true,
  },
  {
    id: "4",
    ...
    seoTitle: "Gita alle Cascate di Ouzoud da Marrakech",
    seoDescription: "Visita la cascata più alta del Marocco — 110 metri di acqua che precipita, macachi della Barberia selvatici e un giro in barca nella gola.",
    featured: false,
  },
  {
    id: "5",
  ...
  },
  {
    ...
    seoTitle: "Tour Culturale della Medina di Marrakech",
    seoDescription: "Esplora la medina UNESCO di Marrakech con una guida locale — conce artigianali, Madrasa Ben Youssef, Jemaa el-Fna e giardini nascosti nei riad.",
    featured: false,
  },
  {
    id: "7",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Tour di 3 Giorni da Marrakech a Fes",
    seoDescription: "Viaggia da Marrakech a Fes via Tizi n'Tichka, Aït Ben Haddou e le foreste di cedri del Medio Atlante. Tour privato 4x4 di 3 giorni con alloggio in riad.",
    featured: false,
  },
  {
    id: "8",
    ...
    brief: [
      "Sette giorni attraverso il massiccio del M'Goun, la parte dell'Alto Atlante che il traffico da trekking non raggiunge mai. Il primo giorno prevede 5 ore di strada fino ad Aït M'hamed e una notte presso una famiglia berbera. Il secondo attraversa gli Aït Bouguemez — la «valle felice» — fino al campo di Agouti, a 2.600 m. Il terzo valica il primo passo elevato, il Tizi n'Ait Imi a 3.650 m, con 1.050 m di dislivello. Il quarto parte prima dell'alba per la vetta del Jbel M'Goun a 4.068 m, la seconda cima del Marocco, e scende poi nella gola del Tessaoute.",
      "Il quinto e il sesto giorno sono la ragione per cui i trekker esperti scelgono questo itinerario anziché una via al Toubkal. Il quinto attraversa la gola del Tessaoute dalle pareti rosse, con bagno libero nel fiume; il sesto esce dalla gola verso Bou Tharar e una notte presso una famiglia del villaggio. Il settimo rientra a Marrakech per la valle delle rose, con arrivo verso le 16. Quattro notti in campo tendato, due presso famiglie.",
      "È classificato esperto, e la classificazione riguarda l'accumulo più che la tecnica. Nessuna singola giornata richiede capacità alpinistiche. Ma sono sette giorni consecutivi in quota in un territorio con pochi punti di uscita, e la squadra di muli trasporta il campo perché non c'è modo di rifornirsi. Chi ha portato a termine il Toubkal senza difficoltà e cerca il passo successivo scoprirà che questo è davvero il passo successivo.",
      "A persona: 1.350 € da soli, 760 € in due, 710 € in tre, 680 € in quattro, 625 € in cinque e 596 € in sei, in un gruppo limitato a otto. Sono inclusi una guida di alta montagna abilitata ed esperta, tutti i pasti per sette giorni, la squadra di muli, i campi e i pernottamenti presso le famiglie, le tasse del parco nazionale e — cosa degna di nota in un trek così remoto — la comunicazione satellitare di emergenza.",
      "Qui l'assicurazione di viaggio e medica è obbligatoria anziché consigliata, e va letta alla lettera: dal terzo al sesto giorno siete molto lontani da una strada. L'attrezzatura alpinistica tecnica e le mance non sono incluse. Se state confrontando questo con il Toubkal, la distinzione onesta è che il Toubkal è una vetta che si può inserire in una vacanza, mentre il M'Goun è una spedizione che diventa la vacanza.",
    ],
    ...
    seoTitle: "Trekking Massiccio del M'Goun 7 Giorni",
    seoDescription: "Trekking expert di 7 giorni attraverso il remoto Massiccio del M'Goun — vetta del Jbel M'Goun (4.068 m).",
    featured: false,
  },
  ...
  },
  {
    ...
    seoDescription: "Avvista l'Ibis eremita, in pericolo critico, e i fenicotteri nella riserva naturale più importante del Marocco. Guida naturalistica esperta.",
    featured: true,
  },
  {
    id: "11",
  ...
  },
  {
    ...
    seoTitle: "Lezione di Surf ad Agadir",
    seoDescription: "Impara a surfare sulle calde onde atlantiche della baia di Agadir con un istruttore certificato ISA. Tavola, muta e briefing sulla sicurezza inclusi.",
    featured: false,
  },
  {
    id: "13",
    ...
    seoTitle: "Trekking nei Monti Anti-Atlante 3 Giorni",
    seoDescription: "Trekking di 3 giorni nella catena montuosa più sottovalutata del Marocco — vette di granito rosa, gole in fiore di mandorli e remoti villaggi berberi.",
    featured: true,
  },
  {
    id: "14",
    ...
    brief: [
      "Quasi tutti i viaggi nel Sahara in Marocco partono da Marrakech. Questo parte da Agadir e prende la via meridionale per Tata e Foum Zguid fino all'Erg Chegaga, che è un deserto davvero diverso da quello delle cartoline. Chegaga è il campo dunare più vasto e remoto del paese, raggiunto in 4x4 attraverso spazi aperti anziché in pullman fino a un campo a bordo strada.",
      "Siate lucidi sul viaggio in auto, perché è la caratteristica determinante: circa 8 ore e 450 km per tratta, in entrambi i giorni. È molto tempo in veicolo per un viaggio di due giorni, ed è il prezzo per raggiungere Chegaga dalla costa. In cambio ottenete un campo dunare dove non condividete il tramonto con altre cinquanta persone. Se il problema sono i lunghi trasferimenti più che la distanza, la versione di 4 giorni da Marrakech è più adatta.",
      "Il primo giorno segue Agadir–Tata–Foum Zguid ed entra tra le dune, con arrivo per il giro in cammello al tramonto e la cena al campo. Il secondo giorno è l'alba sull'erg, poi il ritorno attraverso la palmeraie della valle del Draa e le sue kasbah. Una notte sotto la tela, e il campo è abbastanza lontano da qualsiasi centro abitato perché la Via Lattea sia visibile senza sforzo.",
      "A persona: 790 € da soli, 400 € in due, 340 € in tre, 310 € in quattro e 280 € in cinque. Comprende il trasporto in 4x4 per tutto il percorso, una guida del deserto esperta, la notte al campo in tenda privata con cena e colazione e tutti i giri in cammello. È disponibile una tenda con bagno privato se preferite non usare i servizi comuni: conviene chiederlo al momento della prenotazione anziché all'arrivo.",
      "Il pranzo del primo giorno non è incluso, così come gli effetti personali e le mance. Il gruppo va da 2 a 10 persone e il viaggio è privato. È classificato facile: non si cammina praticamente per nulla, e l'unica vera richiesta è tollerare una lunga giornata in auto su una strada che la maggior parte dei visitatori del Marocco non vede mai.",
    ],
    ...
    highlights: [
      ...
      "Campo berbero nel deserto sotto la Via Lattea — tenda con bagno privato opzionale",
    ...
    faq: [
      ...
      { q: "Com'è il campo?", a: "Un campo permanente nelle dune di Chegaga per una notte, con cena e colazione incluse. La tariffa standard comprende una tenda privata per dormire con un blocco servizi condiviso a pochi passi. Una tenda con bagno privato (doccia e servizi all'interno) è disponibile a +30 € a persona: il tour ha una sola notte nel deserto, quindi il supplemento si applica una volta. Il cielo stellato e il silenzio sono ciò che la maggior parte ricorda." },
      { q: "Cosa è incluso?", a: "Trasporto in 4x4 per tutto il viaggio, una guida del deserto esperta, una notte al campo in tenda privata con cena e colazione, e tutti i giri in cammello. I servizi alla tariffa standard sono un blocco condiviso; la tenda con bagno privato costa +30 € a persona. Il pranzo del giorno 1, gli effetti personali e le mance non sono inclusi." },
    ...
    seoTitle: "Tour nel Sahara 2 Giorni da Agadir",
    seoDescription: "Le remote dune dell'Erg Chegaga via la rotta meridionale della Valle del Draa — trekking in cammello, campo berbero nel deserto e un'alba sul Sahara.",
    featured: true,
  },
  {
    id: "15",
    ...
    seoTitle: "Valle del Souss: argan e cultura",
    seoDescription: "Una cooperativa dell'argan gestita da donne, un apicoltore e un pranzo con una famiglia berbera nella Valle del Souss.",
    featured: false,
  },
  {
    id: "16",
    ...
    seoDescription: "Gita giornaliera da Agadir alla medina blu e bianca di Essaouira, patrimonio UNESCO — mura portoghesi del XVIII secolo.",
    featured: false,
  },
  {
    id: "17",
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Città Imperiali del Marocco, 5 giorni",
    seoDescription: "Grande circuito tra le quattro capitali imperiali del Marocco in 5 giorni. Rovine romane di Volubilis, concerie Chouara, Bab Mansour e Torre Hassan.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    featured: false,
    seoTitle: "Tour Deserto 2 Giorni da Marrakech a Zagora",
    seoDescription: "La via più rapida al Sahara — Aït Ben Haddou, i 200 km di palmeria della Valle del Draa e un trekking in cammello tra le dune.",
  },
  {
    id: "24",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    featured: true,
    seoTitle: "Tour del Deserto Erg Chegaga 3 Giorni",
    seoDescription: "L'esperienza del deserto più remota del Marocco — 3 giorni da Marrakech all'Erg Chegaga via attraversamento fuoristrada in 4x4.",
  },
  {
    id: "25",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    featured: true,
    seoTitle: "Tour del Deserto 4 Giorni da Marrakech",
    seoDescription: "Il circuito completo del deserto: 4 giorni tra Aït Ben Haddou, la Gola del Todra, l'Erg Chebbi e la Strada delle Mille Kasbah.",
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — il tuo hotel o riad" },
    featured: false,
    seoTitle: "Tour Deserto 3 Giorni da Agadir a Merzouga",
    seoDescription: "Dalla costa atlantica di Agadir al Sahara — via Taroudant, Taliouine, Aït Ben Haddou e un trekking in cammello al tramonto sull'Erg Chebbi.",
  },
  {
    id: "27",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — il tuo hotel o riad" },
    featured: false,
    seoTitle: "Tour Deserto 2 Giorni da Agadir a Zagora",
    seoDescription: "Dalla costa di Agadir al deserto di Zagora in 2 giorni — via Taroudant, i 200 km di palmeria della Valle del Draa e un trekking in cammello al tramonto.",
  },
  {
    id: "28",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — il tuo hotel o riad" },
    featured: false,
    seoTitle: "Erg Chegaga 3 giorni da Agadir",
    seoDescription: "Il deserto più remoto del Marocco da Agadir — 3 giorni attraverso l'Anti-Atlante fino all'Erg Chegaga in 4x4, una notte in un campo berbero privato.",
  },
  {
    id: "29",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — il tuo hotel o riad" },
    featured: false,
    seoTitle: "Tour del Deserto 4 Giorni da Agadir",
    seoDescription: "Il grand tour completo del deserto da Agadir — 4 giorni tra Taroudant, Aït Ben Haddou, la Gola del Todra.",
  },
  ...
  },
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — il tuo hotel o riad" },
    seoTitle: "Tour di 5 Giorni da Agadir a Chefchaouen",
    seoDescription: "Tour di 5 giorni da Agadir alla Città Blu del Marocco via Marrakech, le rovine romane di Volubilis e le porte imperiali di Meknes. 4x4 privato con riad.",
    featured: false,
  },
  {
    id: "21",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — il tuo hotel o riad" },
    seoTitle: "Città Imperiali del Marocco, 6 giorni",
    seoDescription: "Grande circuito di 6 giorni da Agadir attraverso le quattro città imperiali del Marocco — Marrakech, Meknes, Fes e Rabat. 4x4 privato con alloggio in riad.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Circuito Toubkal 6 giorni, Lago Ifni",
    seoDescription: "Il circuito completo del Toubkal di 6 giorni da Marrakech — passi in quota, il turchese Lago Ifni e la vetta del Jbel Toubkal (4.167 m).",
    featured: false,
  },
  {
    id: "31",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trekking Toubkal 2 Giorni da Marrakech",
    seoDescription: "Scala il Jbel Toubkal (4.167 m) in 2 giorni da Marrakech — la via più rapida verso la cima più alta del Nord Africa. Notte in rifugio, tutti i pasti.",
    featured: false,
  },
  {
    id: "32",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Toubkal 3 giorni via Aguelzim",
    seoDescription: "Scala il Toubkal (4.167 m) per la via panoramica — 3 giorni via la Valle dell'Azzaden, le cascate di Ighouliden e il Passo di Aguelzim (3.560 m).",
    featured: false,
  },
  {
    id: "33",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Sfida Toubkal Tre Vette Oltre i 4.000 m",
    seoDescription: "Sali su tre vette dell'Alto Atlante oltre i 4.000 m in 3 giorni — Timesguida (4.089 m), Ras Ouanoukrim (4.083 m) e Toubkal (4.167 m).",
    featured: false,
  },
  {
    id: "34",
    ...
    seoTitle: "Tour del Cibo e dei Mercati di Marrakech",
    seoDescription: "Tour gastronomico di mezza giornata a Marrakech: assapora il tuo percorso tra i souk delle spezie, poi cucina un vero tagine con una famiglia locale.",
    faq: [
  ...
  },
  {
    ...
    brief: [
      "Quasi tutti i tour nel deserto citano le stelle nella brochure e poi vi lasciano guardarle da soli. Questo è costruito attorno al cielo: dopo il giro in cammello al tramonto e la cena, una guida astronoma monta un telescopio al campo e passa in rassegna i pianeti, le costellazioni e gli oggetti del cielo profondo visibili quella notte, spiegati in linguaggio normale anziché in gergo. Non servono attrezzatura né conoscenze pregresse.",
      "Il motivo per cui funziona proprio all'Erg Chebbi è la distanza da qualsiasi luce elettrica. Non c'è alcun bagliore urbano in nessuna direzione, quindi la Via Lattea è visibile a occhio nudo in una notte serena — non come una macchia tenue, ma come una struttura che attraversa il cielo. È più raro di quanto si pensi; in Europa non è rimasto quasi nulla di così buio.",
      "Il compromesso è il viaggio. L'Erg Chebbi dista circa 560 km e all'incirca 8 ore da Marrakech, per tratta, e questo è un viaggio di due giorni: una lunga giornata di strada, una notte al campo e un'altra lunga giornata di ritorno. Il primo giorno si arriva per il giro in cammello e la cena; il secondo è l'alba sulle dune e il rientro. Chi preferisse spezzare quel trasferimento dovrebbe valutare un itinerario nel deserto di 3 o 4 giorni.",
      "A persona: 518 € da soli, 260 € in due, 191 € in tre, 160 € in quattro, 139 € in cinque e 121 € in sei. Sono inclusi il trasporto andata e ritorno da Marrakech, il giro in cammello al tramonto, la notte al campo, la cena e la colazione e la sessione al telescopio con la guida astronoma. Il pranzo lungo il percorso non è incluso, anche se sono previste soste, e assicurazione di viaggio e mance sono a parte.",
      "Due note pratiche. La fase lunare conta più della stagione: la luna piena cancella gli oggetti deboli, quindi se venite per il cielo profondo prenotate attorno alla luna nuova. E le notti del deserto sono fredde dall'autunno alla primavera, più di quanto la maggior parte dei visitatori preveda; l'osservazione avviene all'aperto, fermi, ben dopo il calar del buio. Portate uno strato caldo che vi sembri eccessivo. Gruppo privato di 2-10 persone.",
    ],
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Notte stellata a Merzouga, 2 giorni",
    seoDescription: "Due giorni da Marrakech a Merzouga per osservare le stelle: cammelli al tramonto, telescopio guidato e una notte nell'Erg Chebbi.",
    faq: [
  ...
  },
  {
    ...
    brief: [
      "L'Azzaden è la valle immediatamente a ovest del corridoio Imlil–Toubkal, e la differenza di affluenza è proprio il punto. Il primo giorno prevede 1,5 ore di strada da Marrakech a Imlil, poi circa 700 m di salita per il valico di Tizi Mzik a 2.684 m — con il massiccio del Toubkal che si apre alle vostre spalle — e la discesa tra i ginepri fino al villaggio di Tizi Oussem a 1.850 m. Cinque-sei ore di cammino. Il secondo giorno attraversa il Tizi Oudid e scende ad Aguersioual, circa 12 km e cinque ore, poi il rientro in auto.",
      "È classificato moderato, e qui la classificazione significa davvero qualcosa. Nessuna vetta, nessun ghiaione e niente sopra i 2.700 m circa, quindi la quota non diventa mai il problema che rappresenta sul Toubkal. Serve la capacità di camminare cinque-sei ore su sentieri di montagna per due giorni di fila. Chi cammina regolarmente lo trova confortevole; chi non lo fa lo vive come uno sforzo reale ma gestibile.",
      "La notte si passa in una casa per ospiti a conduzione familiare a Tizi Oussem, non in un rifugio o in tenda. Conta più di quanto sembri: un rifugio è una camerata piena di persone che fanno la stessa salita, mentre una casa di villaggio è la casa di qualcuno, con la cena preparata dalla famiglia e una valle che si azzittisce al calare del buio. È la parte di cui i viaggiatori ci scrivono dopo.",
      "A persona: 285 € da soli, 161 € in due, 142 € in tre, 133 € in quattro, 124 € in cinque e 116 € in sei. Comprende la guida alpina abilitata, la notte nella casa per ospiti, tutti i pasti del trek, un mulo per i bagagli del gruppo e il transfer andata e ritorno da Marrakech. Portate solo uno zaino da giornata. Qui l'assicurazione di viaggio è consigliata anziché obbligatoria, l'attrezzatura personale è a vostro carico e le mance per guida e mulattiere sono a parte.",
      "Se state scegliendo tra questo e un trek sul Toubkal, la domanda è che cosa volete dalla montagna. Il Toubkal è una vetta e una giornata in quota. L'Azzaden sono villaggi, terrazzamenti e noceti, percorsi a un ritmo che vi lascia il tempo di guardarvi intorno. Gruppo privato di 2-12 persone, quindi il ritmo è il vostro.",
    ],
  ...
  },
  {
    ...
    brief: [
      "Tre giorni di cammino di valle in valle, senza alcuna vetta in programma. Da Imlil si passa nell'Azzaden il primo giorno (4-5 ore), si salgono circa 800 m per i pascoli alti fino a Tacheddirt a 2.300 m il secondo giorno (6 ore), poi si scende lungo il bacino dell'Ourika fino alla strada il terzo giorno (5 ore) e si rientra a Marrakech. Ogni notte in una casa per ospiti di villaggio diversa: attraversate quindi un territorio abitato invece di tornare a un campo base.",
      "L'assenza di una vetta è il progetto, non un compromesso. Nulla su questo percorso supera i 2.700 m circa, il che toglie del tutto la quota dall'equazione, e non ci sono ghiaioni né partenze prima dell'alba. Resta un cammino moderato e costante, con il tempo e l'energia per accorgersi di dove siete: i terrazzamenti, gli azib da pascolo, i pastori, il cambio di carattere da una valle all'altra.",
      "Questo ne fa un ottimo primo trek di più giorni. Chi cammina occasionalmente riesce qui a mettere in fila tre giorni senza che il viaggio diventi una prova di resistenza, e poiché le case per ospiti sono nei villaggi e non su un circuito di trekking, le serate sono tranquille e locali anziché condivise con altri quaranta camminatori diretti alla stessa vetta.",
      "A persona: 416 € da soli, 235 € in due, 206 € in tre, 192 € in quattro, 181 € in cinque e 169 € in sei. Sono inclusi la guida alpina abilitata, entrambe le notti in casa per ospiti, tutti i pasti del trek, un mulo che trasporta i bagagli del gruppo e il transfer andata e ritorno da Marrakech. Si cammina con uno zaino da giornata. L'assicurazione di viaggio è consigliata, l'attrezzatura personale è a vostro carico e le mance per guida e mulattiere sono a parte.",
      "Vale la pena dirlo chiaramente: se l'obiettivo è salire sul Toubkal, questo non è quel trek e non lo sostituisce. Se l'obiettivo è l'Alto Atlante in sé — i villaggi, i valichi, tre giorni di cammino senza orologio — questo itinerario copre più terreno e più varietà di qualsiasi via di vetta. Gruppo privato di 2-12 persone.",
    ],
  ...
  },
  {
    ...
    brief: [
      "Il trekking con i bambini funziona quando le giornate sono brevi e c'è qualcosa da guardare, e questo itinerario è costruito su quella regola anziché adattato dopo. Primo giorno: 1,5 ore di auto fino a Imlil e 2-3 ore di cammino fino al primo villaggio. Secondo: 4 ore attorno alle cascate della valle. Terzo: passaggio sul versante dell'Ourika in 4-5 ore. Quarto: 3 ore di discesa e il rientro in auto. Mezze giornate, non marce forzate.",
      "Il terreno è volutamente facile: la bassa valle di Imlil e l'Ourika, guadi, noceti e cascate anziché valichi elevati. I muli portano tutti i bagagli e possono portare anche un bambino stanco, ed è il dettaglio che trasforma un pomeriggio difficile in un non evento. Nessuno porta uno zaino e nessuno viene messo fretta.",
      "Le notti sono in case per ospiti di villaggio presso famiglie berbere per tre notti, con tutti i pasti inclusi. La cottura del pane e il tè alla menta fanno parte delle serate anziché essere una dimostrazione costruita, e per la maggior parte delle famiglie è proprio questo ciò che i bambini ricordano, più del cammino.",
      "Questo viaggio ha un minimo di tre persone, quindi la scala parte da lì: 276 € a persona in tre, 257 € in quattro, 241 € in cinque e 225 € in sei, fino a un gruppo di quattordici. Sono inclusi una guida alpina abilitata ed esperta con le famiglie, tutte e tre le notti in casa per ospiti, ogni pasto, i muli e il transfer andata e ritorno da Marrakech. L'assicurazione di viaggio è consigliata, l'attrezzatura da escursionismo personale è a vostro carico e le mance per guida e mulattieri sono a parte.",
      "Sull'età: il vincolo è camminare qualche ora su terreno irregolare, non la distanza o la quota. I bambini in età scolare se la cavano quindi bene e i più piccoli riescono grazie ai muli a disposizione. Se volete una risposta netta per la vostra famiglia, indicateci le età al momento della richiesta e vi diremo francamente se è adatto invece di vendervi il viaggio.",
    ],
  ...
  },
  {
    ...
    brief: [
      "Questo è il classico circuito Marrakech–Erg Chebbi con i trasferimenti ristrutturati perché funzioni con i bambini. Il percorso è quello che fanno tutti: attraverso l'Atlante fino ad Aït Ben Haddou e al Dades il primo giorno, per le gole del Dades e del Todra fino alle dune il secondo, ritorno via Ouarzazate il terzo e il quarto. Ciò che cambia è la forma delle giornate: circa 5 ore di auto il primo giorno, poi 4, 4 e 4, suddivise in tappe più brevi con soste vere anziché in due lunghi trasferimenti.",
      "La cosa più utile da sapere è che il deserto è davvero lontano da Marrakech. L'Erg Chebbi dista circa 560 km per tratta e nessun itinerario può accorciare quella distanza. Quattro giorni sono ciò che rende il viaggio confortevole: tre notti, tre letti diversi e una notte tra le dune che non è incastrata tra due trasferimenti di otto ore. Le versioni di 2 giorni percorrono la stessa distanza in metà tempo, ed è esattamente ciò che rende i bambini infelici.",
      "Le notti sono un hotel nel Dades con cena e colazione, il campo tendato per famiglie all'Erg Chebbi con cena e colazione e un hotel a Ouarzazate con colazione. Il campo è pensato per le famiglie e non gestito come un bivacco spartano: giri in cammello al tramonto e all'alba, sandboard sulle dune e spazio perché i bambini siano bambini. Aït Ben Haddou all'andata è la kasbah di Game of Thrones e del Gladiatore, cosa che di solito piace ai più grandi.",
      "La scala parte da due persone perché questo viaggio non si vende in singolo: 526 € a persona in due, 399 € in tre, 346 € in quattro, 314 € in cinque, 270 € in sei, 252 € in sette, 245 € in dieci e 229 € in quattordici. Sono inclusi il veicolo climatizzato per tutto il percorso, un autista-guida bilingue inglese/francese, le tre notti descritte, entrambi i giri in cammello e tutti i trasferimenti e i diritti d'ingresso.",
      "I pranzi non sono inclusi — calcolate circa 12-15 € a pasto — e il biglietto degli Atlas Film Studios è facoltativo, intorno ai 7 €. Assicurazione di viaggio e mance sono a parte. Il gruppo va da 2 a 12 persone e il viaggio è privato, il che in una vacanza in famiglia significa soprattutto che ci si può fermare quando qualcuno ne ha bisogno.",
    ],
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Tour del deserto in famiglia 4 giorni",
    seoDescription: "Tour del deserto in famiglia, 4 giorni da Marrakech alle dune dell'Erg Chebbi: cammelli, sandboard, kasbah del cinema e campo familiare. Da 607 $.",
    faq: [
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Tour 5 giorni Cima del Toubkal e Sahara",
    seoDescription:
      "Combina le due avventure di punta del Marocco: raggiungere la cima del Jbel Toubkal (4.167 m) e poi le dune sahariane dell'Erg Chebbi.",
    faq: [
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    featured: false,
    seoTitle: "Trek in cammello di 8 giorni a Chegaga",
    seoDescription:
      "Camminate nel Sahara con una carovana di cammelli: sei giorni a piedi dalla valle del Draa alle dune dell’erg Chegaga e a M’hamid. Campi mobili, guida berbera.",
    faq: [
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Deserto di Merzouga tour condiviso — €120",
    seoDescription: "Partenza giornaliera condivisa da Marrakech verso le dune dell'Erg Chebbi: Aït Ben Haddou, gole del Dades e del Todra.",
    featured: false,
  },
  {
    id: "45",
    ...
    brief: [
      "Zagora è la notte nel deserto più vicina a Marrakech, ed è esattamente questo il suo richiamo. Il percorso valica il Tizi n'Tichka, passa da Aït Ben Haddou e Ouarzazate, entra nei palmeti della valle del Draa, poi un giro in cammello porta tra le dune per la cena, i tamburi e una notte al campo. Il secondo giorno rifà la stessa strada. Circa 360 km e all'incirca 8 ore per tratta.",
      "Siate onesti con voi stessi sulle dune prima di prenotare. Quelle di Zagora sono piccole — nulla a che vedere con le pareti di 150 metri dell'Erg Chebbi — perché Zagora è una città del deserto con della sabbia e non un grande erg. È il compromesso che accettate per un viaggio che sta in due giorni anziché in tre o quattro. Chi ci va aspettandosi Lawrence d'Arabia resta deluso; chi ci va sapendo che questa è la versione breve se lo gode.",
      "A 85 € a persona è la notte nel deserto più economica che proponiamo, e il prezzo è fisso anziché a scaglioni perché si tratta di una partenza condivisa venduta a posto. Si viaggia in minibus climatizzato con fino ad altre sedici persone e un autista che parla inglese o francese. L'acconto è di 19 €. Inclusi: trasporto, la notte al campo, cena e colazione e il giro in cammello.",
      "Non inclusi: pranzi, bevande, mance e biglietti d'ingresso — Aït Ben Haddou in particolare ha un costo d'accesso in loco. Mettete a budget queste voci separatamente perché la giornata non vi riservi sorprese.",
      "Se avete tre o quattro giorni, Merzouga e l'Erg Chebbi sono un deserto migliore. Se avete due giorni, o preferite spendere la differenza altrove in Marocco, questo itinerario fa onestamente il suo lavoro: una vera notte sotto la tela nel sud, a un prezzo che lascia intatto il resto del viaggio.",
    ],
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Deserto di Zagora 2 giorni — €85",
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Cascate di Ouzoud escursione — €40",
    seoDescription: "Partenza giornaliera condivisa verso le cascate di Ouzoud: salti di 110 m, bertucce in libertà, passeggiata nella gola e giro in barca.",
    featured: false,
  },
  {
    id: "47",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Agafay: cena e giro in cammello — €30",
    seoDescription: "Serata nel deserto di pietra di Agafay: giro in cammello al tramonto, cena di tre portate, musica dal vivo e spettacolo del fuoco, a 40 minuti da Marrakech.",
    featured: false,
  },
  {
    id: "48",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — il tuo hotel o riad" },
    seoTitle: "Essaouira escursione condivisa — €30",
    seoDescription: "Partenza giornaliera condivisa per Essaouira: medina patrimonio UNESCO, mura del XVIII secolo, porto peschereccio blu e cooperativa di argan lungo il percorso.",
    featured: false,
  },
  {
    id: "50",
