...
export const TOURS: Tour[] = [
  ...
  },
  {
    ...
    faq: [
      { q: "Ist diese Wanderung für Familien und Anfänger geeignet?", a: "Ja. Sie ist als leicht eingestuft und für Familien und Wandereinsteiger konzipiert – die Route folgt den Talwegen bis zu den Wasserfällen von Setti Fatma, ohne echten Anstieg. Kinder, die auf unebenem Gelände sicher gehen, kommen gut zurecht." },
      { q: "Was ist im Preis enthalten?", a: "Ein zertifizierter Wanderführer, Hin- und Rücktransport ab Marrakesch, ein traditionelles Berber-Mittagessen bei einer einheimischen Familie und Mineralwasser über den Tag. Persönliche Wanderausrüstung und Trinkgelder sind nicht enthalten." },
      { q: "Kann man im Tal baden?", a: "Ja – entlang der Strecke gibt es natürliche Bergpools, bringen Sie also bei warmem Wetter Badesachen mit. Die sieben Kaskaden von Setti Fatma am oberen Talende sind das Highlight." },
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 15 Personen. Es ist eine Tour in geteilter Gruppe, Sie wandern also möglicherweise mit anderen." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Wie viel muss man in Ouzoud laufen?", a: "Nicht viel – es ist ein leichter Tag. Der Hauptaufwand ist der Abstieg in die Schlucht bis zum Fuß der 110 m hohen Fälle und zurück, den jeder in seinem eigenen Tempo bewältigt." },
  ...
  },
  {
    ...
    faq: [
      { q: "Was passiert auf diesem Nachmittags- bis Abendausflug?", a: "Sie werden von Marrakesch in die felsige Agafay-Wüste gefahren, fahren eine Stunde Quad, machen einen Kamelritt und genießen dann ein traditionelles Berber-Abendessen mit Minztee-Zeremonie bei Sonnenuntergang. Ein leichter halber Tag rund um den Abend." },
      { q: "Ist die Agafay eine echte Sandwüste?", a: "Nein – die Agafay ist eine felsige, mondartige Hammada etwa 30 km von Marrakesch, keine Sahara-Dünen. Ihr Reiz liegt in einer echten Wüstenstimmung bei Sonnenuntergang in Stadtnähe, ohne die lange Fahrt in den Süden." },
      { q: "Was ist inbegriffen?", a: "Hin- und Rücktransport ab Marrakesch, eine Stunde Quadfahren, ein Kamelritt, ein traditionelles Berber-Abendessen und die Minztee-Zeremonie. Alkoholische Getränke und Trinkgelder sind nicht enthalten." },
      { q: "Brauche ich Quad-Erfahrung?", a: "Nein. Die Quad-Einheit umfasst eine kurze Einweisung und läuft in einem leichten Tempo, das für Anfänger geeignet ist." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Ist das eine private Tour?", a: "Ja. Es ist eine private, halbtägige (4-stündige) geführte Tour mit Ihrem eigenen Guide, verfügbar auf Englisch, Französisch, Spanisch oder Arabisch, sodass Tempo und Inhalt Ihren Interessen folgen." },
      { q: "Was deckt die Tour ab und was ist enthalten?", a: "Ein 4-stündiger geführter Rundgang durch die Medina, mit Eintrittsgeldern für die besuchten Sehenswürdigkeiten und einer traditionellen Minztee-Zeremonie. Mittagessen, Einkäufe und Trinkgelder sind nicht enthalten." },
      { q: "Wie viel muss ich laufen?", a: "Sie ist als leicht eingestuft, aber es ist ein Rundgang durch die Souks und Sehenswürdigkeiten, tragen Sie also bequeme Schuhe. Die Route lässt sich Ihrem Tempo anpassen." },
      { q: "Wie groß ist die Gruppe?", a: "Klein – zwischen 2 und 8 Personen und privat für Ihre Gruppe." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Endet diese Reise in Fès statt zurück nach Marrakesch?", a: "Ja. Es ist eine Einwegfahrt von Marrakesch nach Fès über drei Tage, daher ist der Rücktransport ab Fès nicht enthalten – planen Sie Ihre Weiterreise von dort." },
      { q: "Was ist inbegriffen?", a: "Privater 4x4-Transport durchgehend, ein englisch-/französischsprachiger Guide, zwei Nächte in einem Riad, tägliches Frühstück sowie alle Transfers und Mautgebühren. Mittag- und Abendessen sowie Trinkgelder sind nicht enthalten." },
      { q: "Ist es anstrengend?", a: "Leicht. Die Strecke wird im privaten 4x4 mit Stopps unterwegs zurückgelegt, der Aufwand beschränkt sich also auf kurze Spaziergänge an den Sehenswürdigkeiten, kein Trekking." },
      { q: "Welche Art von Unterkunft ist es?", a: "Zwei Nächte in Riads – traditionellen Gästehäusern mit Innenhof – mit Frühstück jeden Morgen." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Welche Tierwelt kann man sehen?", a: "Souss-Massa ist ein Vogelbeobachtungspark – eines der letzten Rückzugsgebiete des Waldrapps, und Flamingos und andere Wasservögel sind entlang des Ästuars häufig. Ein erfahrener Naturführer leitet den Tag, Ferngläser werden gestellt." },
      { q: "Ist das auch für Gelegenheitsbesucher geeignet, nicht nur für Vogelkundler?", a: "Ja. Es ist ein leichter Tag, der Ästuar, Küste und Parklandschaften verbindet; der Naturführer richtet ihn nach den Interessen der Gruppe aus, Sie müssen also kein Vogelfan sein." },
      { q: "Was ist inbegriffen?", a: "Hin- und Rücktransport ab Agadir, ein erfahrener Naturführer, der Parkeintritt, Ferngläser und ein Picknick. Persönliche Fotoausrüstung und Trinkgelder sind nicht enthalten." },
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 12 Personen – eine kleine geteilte Gruppe, damit der Naturführer allen weiterhin Vögel und Wildtiere zeigen kann." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Wofür ist Taroudant bekannt?", a: "Für seine intakten Stadtmauern – Taroudant wird wegen seiner Lehmmauern und ruhigen Souks manchmal „Klein-Marrakesch“ genannt. Der Tag umfasst einen Spaziergang entlang der Mauern und Minztee in einem Riad." },
      { q: "Was umfasst der Ausflug?", a: "Hin- und Rücktransport ab Agadir, einen ortskundigen Guide, den Mauerrundgang und Minztee in einem Riad. Mittagessen, Einkäufe und Trinkgelder sind nicht enthalten." },
      { q: "Ist es anstrengend?", a: "Leicht. Es ist ein entspannter Kulturtag entlang der Mauern und der Altstadt, ohne Wandern." },
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 14 Personen auf einer Tour in geteilter Gruppe, Sie reisen also möglicherweise mit anderen statt in einer privaten Gruppe." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Brauche ich Surf-Erfahrung?", a: "Nein. Die Einheit ist als leicht eingestuft und für Anfänger konzipiert – sie beginnt mit Aufwärmen und einem Sicherheitsbriefing durch einen ISA-zertifizierten Instructor, bevor es ins Wasser geht." },
      { q: "Wird die Ausrüstung gestellt?", a: "Ja. Der Verleih von Board und Neoprenanzug ist enthalten, ebenso die 2-stündige Stunde und der zertifizierte Instructor. Trinkgelder sind nicht enthalten." },
      { q: "Wie komme ich zum Strand?", a: "Der Transport ist nicht enthalten, da der Strand etwa 5 Gehminuten vom Zentrum entfernt liegt. Treffpunkt für die Stunde ist der Strand." },
      { q: "Wie lange dauert die Stunde?", a: "Die Einheit dauert insgesamt 2–3 Stunden, inklusive Aufwärmen, Sicherheitsbriefing und Zeit im Wasser, in einer kleinen Gruppe von 2 bis 8 Personen." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Wie schwer ist dieses Trekking?", a: "Es ist als mittel eingestuft – drei Tage zu Fuß im Anti-Atlas mit zwei Nächten in Berber-Gästehäusern. Anspruchsvoller als eine Tageswanderung, aber ohne vorherige Höhenerfahrung." },
      { q: "Muss ich mein eigenes Gepäck tragen?", a: "Nein. Ein Maultier transportiert die Ausrüstung zwischen den Etappen, Sie gehen also mit einem Tagesrucksack. Persönliche Wanderausrüstung wird nicht gestellt." },
      { q: "Was ist inbegriffen?", a: "Ein zertifizierter Bergführer, zwei Nächte im Berber-Gästehaus, alle Mahlzeiten, Hin- und Rücktransport ab Agadir und ein Maultier für die Ausrüstung. Reiseversicherung (empfohlen), persönliche Wanderausrüstung und Trinkgelder sind nicht enthalten." },
      { q: "Wo übernachtet man?", a: "In Berber-Gästehäusern in Bergdörfern – einfache, gastgebende Unterkünfte statt Hotels, mit allen Mahlzeiten inklusive." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Erreicht man die Wüste von Agadir wirklich in zwei Tagen?", a: "Ja – diese zweitägige Reise nutzt einen 4x4, um für eine Nacht ein Wüstencamp zu erreichen, alle Kamelritte inklusive. Es ist die kürzeste echte Wüstenübernachtung ab Agadir." },
      { q: "Wie ist das Camp?", a: "Ein Luxus-Wüstencamp für eine Nacht, mit Abendessen und Frühstück. Der Sternenhimmel und die Stille bleiben den meisten in Erinnerung." },
      { q: "Was ist inbegriffen?", a: "4x4-Transport durchgehend, ein erfahrener Wüstenführer, eine Nacht im Luxuscamp mit Abendessen und Frühstück sowie alle Kamelritte. Das Mittagessen an Tag 1, persönliche Dinge und Trinkgelder sind nicht enthalten." },
      { q: "Ist es anstrengend?", a: "Leicht. Die Strecke wird im 4x4 zurückgelegt und die Kamelritte sind kurz und optional." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Worauf konzentriert sich dieser Tag?", a: "Auf die Arganöl-Geschichte und die ländliche Souss-Kultur – Sie besuchen eine Arganöl-Kooperative für eine Verkostung, probieren lokalen Honig und teilen ein traditionelles Berber-Mittagessen. Ein leichter Kulturtag ab Agadir." },
      { q: "Ist der Besuch der Arganöl-Kooperative ein Verkaufsstopp?", a: "Sie besuchen eine arbeitende Kooperative, Eintritt und Verkostung inklusive; der Kauf von Arganprodukten ist optional und nicht Teil des Preises." },
      { q: "Was ist inbegriffen?", a: "Hin- und Rücktransport ab Agadir, ein zweisprachiger Guide (Englisch/Französisch), Eintritt und Verkostung in der Arganöl-Kooperative, ein traditionelles Berber-Mittagessen und eine Honigverkostung. Arganöl-Käufe und Trinkgelder sind nicht enthalten." },
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 14 Personen." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Wie viel Zeit haben wir in Essaouira?", a: "Der Tag umfasst einen 2-stündigen geführten Rundgang durch die Medina, mit Freizeit drum herum, um Stadtmauern, Hafen und Cafés in Ihrem eigenen Tempo zu erkunden." },
      { q: "Was ist inbegriffen?", a: "Hin- und Rücktransport ab Agadir, ein englischsprachiger Guide und der 2-stündige geführte Medina-Rundgang. Mittagessen, persönliche Einkäufe und Trinkgelder sind nicht enthalten." },
      { q: "Ist es viel Fahrerei?", a: "Es ist ein leichter Ganztagesausflug die Küste entlang; die Fahrt wird durch den geführten Rundgang und die Freizeit in der Mauerstadt unterbrochen." },
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 14 Personen auf einer Tour in geteilter Gruppe." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Welche Städte deckt sie ab?", a: "Marokkos Königsstädte in fünf Tagen ab Marrakesch, im privaten 4x4, mit allen Transfers, Mautgebühren und Eintrittsgeldern inklusive, sodass Sie nicht an jedem Monument zahlen." },
      { q: "Was ist inbegriffen?", a: "Privater 4x4-Transport, ein englisch-/französisch-/spanischsprachiger Guide, vier Nächte in einem Riad, tägliches Frühstück sowie alle Transfers, Mautgebühren und Eintritte. Mittag- und Abendessen sowie Trinkgelder sind nicht enthalten." },
      { q: "Wie viel muss man laufen?", a: "Als leicht eingestuft, aber jeder Tag beinhaltet viel Gehen durch Medinas und Monumente, bequeme Schuhe sind also wichtig." },
      { q: "Ist sie privat?", a: "Ja, sie läuft als private Tour für Ihre Gruppe von 2 bis 12 Personen mit eigenem Guide und Fahrzeug." },
    ],
  ...
  // ─────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "Ist Zagora die echte Sahara oder eine nähere Wüste?", a: "Zagora ist die nähere Wüstenoption ab Marrakesch, in einer zweitägigen Reise erreichbar. Sie bietet eine echte Campnacht und einen Kamelritt ohne die lange Fahrt zu den großen Erg-Chebbi-Dünen." },
      { q: "Wie ist die Nacht in der Wüste?", a: "Eine Nacht in einem Berber-Wüstencamp mit Abendessen und Frühstück, erreicht über einen Kamelritt bei Sonnenuntergang. Die Nächte sind außerhalb des Sommers kühl, nehmen Sie also eine warme Schicht mit." },
      { q: "Was ist inbegriffen?", a: "Transport im klimatisierten Minibus, ein englischsprachiger Fahrer-Guide, eine Nacht im Berbercamp mit Abendessen und Frühstück, der Kamelritt bei Sonnenuntergang sowie Mineralwasser und Tee. Die Mittagessen beider Tage, die persönliche Reiseversicherung und Trinkgelder sind nicht enthalten." },
      { q: "Ist es anstrengend?", a: "Leicht – die Strecke wird im Minibus zurückgelegt und der Kamelritt ist kurz." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Wie viel Gehen oder Anstrengung ist dabei?", a: "Sehr wenig – als leicht eingestuft. Der Großteil der Strecke erfolgt im klimatisierten Minibus oder 4x4; der Aufwand beschränkt sich auf kurze Spaziergänge an der Todra-Schlucht und in Ait Ben Haddou sowie die optionalen Kamelritte." },
      { q: "Wo übernachtet man jede Nacht?", a: "Eine Nacht in einem Hotel im Dades-Tal, eine Nacht in einem Berbercamp am Erg Chebbi und eine Nacht in einem Hotel in Ouarzazate. Abendessen und Frühstück sind inklusive, außer am letzten Morgen in Ouarzazate (nur Frühstück)." },
      { q: "Was ist nicht enthalten?", a: "Die Mittagessen (Budget etwa 12–15 € pro Mahlzeit), das optionale Ticket für die Atlas-Filmstudios (~7 €), alkoholische Getränke, die persönliche Reiseversicherung und Trinkgelder." },
      { q: "Erreicht man die echte Sahara?", a: "Ja – Sie erreichen das Erg Chebbi mit einer ganzen Nacht im Wüstencamp sowie Kamelritten bei Sonnenuntergang und Sonnenaufgang. Die vier Tage sind, was die richtige Überquerung des Atlas erfordert." },
    ],
    meetingPoint: { lat: 31.0580, lng: -4.0127, name: "Merzouga, Erg Chebbi Sahara" },
    featured: true,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "Erreicht diese Reise die großen Erg-Chebbi-Dünen?", a: "Ja – in drei Tagen ab Agadir erreichen Sie die Erg-Chebbi-Dünen bei Merzouga, mit einer Campnacht und Kamelritten bei Sonnenuntergang und Sonnenaufgang." },
      { q: "Wo übernachtet man?", a: "Eine Nacht in einem Hotel im Dades-Tal oder in Tinghir und eine Nacht in einem Berber-Wüstencamp am Erg Chebbi, beide mit Abendessen und Frühstück." },
      { q: "Was ist inbegriffen?", a: "Klimatisierter 4x4-Transport, ein englischsprachiger Fahrer-Guide, die zwei beschriebenen Nächte mit Abendessen und Frühstück, die Kamelritte bei Sonnenuntergang und Sonnenaufgang sowie Mineralwasser und Minztee durchgehend. Die Mittagessen aller drei Tage, die persönliche Reiseversicherung und Trinkgelder sind nicht enthalten." },
      { q: "Ist es anstrengend?", a: "Leicht – die Route erfolgt im 4x4 mit Stopps und die Kamelritte sind kurz und optional." },
    ],
  ...
  },
  {
    ...
    faq: [
      { q: "Ist das die echte Sahara?", a: "Zagora ist die nächste Wüste ab Agadir, als zweitägige Reise mit einer Berbercamp-Nacht und einem Kamelritt bei Sonnenuntergang – eine echte Wüstenübernachtung ohne die längsten Fahrten." },
      { q: "Was ist inbegriffen?", a: "Klimatisierter Transport, ein englischsprachiger Fahrer-Guide, eine Nacht im Berber-Wüstencamp mit Abendessen und Frühstück, der Kamelritt bei Sonnenuntergang sowie Mineralwasser und Minztee. Die Mittagessen beider Tage, die persönliche Reiseversicherung und Trinkgelder sind nicht enthalten." },
      { q: "Wie ist die Nacht im Camp?", a: "Ein Berber-Wüstencamp mit Abendessen und Frühstück; nehmen Sie eine warme Schicht mit, da die Wüstennächte außerhalb des Sommers kühl sind." },
      { q: "Ist es anstrengend?", a: "Leicht – der Transport übernimmt die Strecke und der Kamelritt ist kurz." },
    ],
    meetingPoint: { lat: 30.4202, lng: -9.5981, name: "Agadir City Centre" },
    featured: false,
  ...
  },
  {
    ...
    faq: [
      { q: "Ist diese viertägige Wüstenreise anstrengend?", a: "Leicht. Die Strecken werden im klimatisierten 4x4 zurückgelegt; der Aufwand beschränkt sich auf kurze Spaziergänge an den Sehenswürdigkeiten und die optionalen Kamelritte am Erg Chebbi." },
      { q: "Wo übernachtet man?", a: "Eine Nacht in einem Hotel im Dades-Tal, eine Nacht in einem Berbercamp am Erg Chebbi und eine Nacht in einem Hotel in Ouarzazate. Abendessen und Frühstück sind inklusive, außer am letzten Morgen in Ouarzazate (nur Frühstück)." },
      { q: "Was ist nicht enthalten?", a: "Die Mittagessen durchgehend (Budget 12–15 € pro Mahlzeit), der optionale Eintritt zu den Atlas-Filmstudios (~7 €), alkoholische Getränke, die persönliche Reiseversicherung und Trinkgelder." },
      { q: "Erreicht man die echten Dünen?", a: "Ja – das Erg Chebbi bei Merzouga, mit Kamelritten bei Sonnenuntergang und Sonnenaufgang und einer ganzen Campnacht." },
    ],
    meetingPoint: { lat: 30.4202, lng: -9.5981, name: "Agadir City Centre" },
    featured: false,
  ...
  // ─────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "Endet diese Reise in Fès?", a: "Ja – es ist eine Einwegfahrt von Agadir nach Fès über vier Tage, daher ist der Rücktransport ab Fès nicht enthalten." },
      { q: "Was ist inbegriffen?", a: "Privater 4x4-Transport durchgehend, ein englisch-/französischsprachiger Guide, drei Nächte in einem Riad, tägliches Frühstück sowie alle Transfers und Mautgebühren. Mittag- und Abendessen sowie Trinkgelder sind nicht enthalten." },
      { q: "Ist es anstrengend?", a: "Leicht – eine Straßenreise im privaten 4x4 mit Besichtigungsstopps statt Trekking." },
      { q: "Wo übernachtet man?", a: "Drei Nächte in Riads mit Frühstück jeden Morgen." },
    ],
    meetingPoint: { lat: 34.0331, lng: -5.0003, name: "Fes el-Bali, Imperial City" },
  ...
  },
  {
    ...
    faq: [
      { q: "Endet diese Reise in Chefchaouen?", a: "Ja – eine Einwegfahrt von Agadir in die blaue Stadt über fünf Tage, daher ist der Rücktransport ab Chefchaouen nicht enthalten." },
      { q: "Was ist inbegriffen?", a: "Privater 4x4-Transport, ein englisch-/französischsprachiger Guide, vier Nächte in einem Riad, tägliches Frühstück sowie alle Transfers und Mautgebühren. Mittag- und Abendessen sowie Trinkgelder sind nicht enthalten." },
      { q: "Ist die Reise anstrengend?", a: "Leicht – es ist eine private Straßenreise mit Stopps, kein Trekking." },
      { q: "Wo übernachtet man?", a: "Vier Nächte in Riads mit Frühstück jeden Morgen." },
    ],
    meetingPoint: { lat: 35.1688, lng: -5.2636, name: "Chefchaouen, Rif Mountains" },
  ...
  },
  {
    ...
    faq: [
      { q: "Was deckt diese sechstägige Tour ab?", a: "Marokkos Königsstädte in sechs Tagen ab Agadir, im privaten 4x4, mit allen Transfers, Mautgebühren und Eintrittsgeldern inklusive." },
      { q: "Was ist inbegriffen?", a: "Privater 4x4-Transport, ein englisch-/französisch-/spanischsprachiger Guide, fünf Nächte in einem Riad, tägliches Frühstück sowie alle Transfers, Mautgebühren und Eintritte. Mittag- und Abendessen sowie Trinkgelder sind nicht enthalten." },
      { q: "Wie viel muss man laufen?", a: "Als leicht eingestuft, aber jeder Tag beinhaltet viel Gehen durch Medinas und Monumente, bequeme Schuhe helfen also." },
      { q: "Ist sie privat?", a: "Ja – eine private Tour für Ihre Gruppe von 2 bis 12 Personen mit eigenem Guide und Fahrzeug." },
    ],
    meetingPoint: { lat: 34.0209, lng: -6.8416, name: "Rabat, Atlantic Capital" },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    faq: [
      { q: "Wie schwer ist die Ifni-See-Runde?", a: "Sie ist als anspruchsvoll eingestuft – sechs Tage im hohen Toubkal-Massiv, einschließlich Gipfel und der abgelegenen Ifni-See-Seite, mit mehreren aufeinanderfolgenden Tagen auf grobem Gelände in der Höhe. Gute Fitness und etwas Trekking-Vorerfahrung helfen." },
      { q: "Wo übernachtet man über die sechs Tage?", a: "Eine Mischung aus Berghütten, Dorf-Gîtes und Zelten, alle mit Mahlzeiten während des Treks. Ein Schlafsack wird nicht gestellt." },
      { q: "Muss ich meine eigene Ausrüstung tragen?", a: "Nein – Maultiere und Maultiertreiber transportieren die Gruppenausrüstung und das Camp, Sie gehen also mit einem Tagesrucksack. Persönliche Trekkingausrüstung und ein Schlafsack sind Ihre eigene Sache." },
      { q: "Was ist erforderlich, aber nicht enthalten?", a: "Die Reiseversicherung ist obligatorisch und nicht enthalten, ebenso wie persönliche Trekkingausrüstung und Trinkgelder für Guide, Koch und Maultiertreiber." },
    ],
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
  ...
  },
  {
    ...
    faq: [
      { q: "Wie schwer ist das im Vergleich zur Standardroute auf den Toubkal?", a: "Sie ist als anspruchsvoll eingestuft. Die Schwierigkeit ist kein technisches Klettern, sondern der hohe Aguelzim-Pass (3.560 m) im Aufstieg plus der Gipfel auf 4.167 m, die Höhe ist also die Hauptprüfung. Es ist ein schönerer, ruhigerer Zugang." },
      { q: "Wo übernachtet man?", a: "Zwei Nächte in Berghütten – arbeitende Hütten mit geteilten Schlaflagern, Decken und gemeinsamen Mahlzeiten. Bringen Sie einen Hüttenschlafsack und eine Stirnlampe mit." },
      { q: "Muss ich meine gesamte Ausrüstung tragen?", a: "Nein – ein Maultiertreiber transportiert die Gruppenausrüstung, Sie tragen also nur einen Tagesrucksack. Persönliche Trekkingausrüstung ist Ihre eigene Sache." },
      { q: "Ist eine Reiseversicherung erforderlich?", a: "Ja, sie ist für dieses Trekking obligatorisch und nicht enthalten. Trinkgelder für Guide und Maultiertreiber sind ebenfalls nicht enthalten." },
    ],
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
  ...
  },
  {
    ...
    faq: [
      { q: "Für wen ist diese Drei-Gipfel-Route?", a: "Für erfahrene Trekker – sie ist als Experte eingestuft und verbindet drei 4.000-m-Gipfel im Toubkal-Massiv in drei Tagen. Sie sollten bereits in der Höhe und bei anhaltenden Aufstiegen sicher sein." },
      { q: "Brauche ich spezielle Ausrüstung?", a: "Im Winter sind Steigeisen und Eispickel erforderlich (Verleih möglich) und der Guide ist höhenqualifiziert. Persönliche Trekkingausrüstung ist Ihre eigene Sache, und eine Reiseversicherung mit Höhendeckung ist obligatorisch." },
      { q: "Wo übernachtet man?", a: "Zwei Nächte in der Toubkal-Hütte, alle Trek-Mahlzeiten inklusive. Es ist eine arbeitende Berghütte – geteilte Schlaflager und kühle Nächte." },
      { q: "Muss ich meine eigene Ausrüstung tragen?", a: "Nein – ein Maultiertreiber transportiert die Gruppenausrüstung zur Hütte, Sie steigen an den Gipfeltagen also mit einem Tagesrucksack auf." },
    ],
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
  ...
  },
  {
    ...
    title: "Azzaden-Tal — 2-Tage-Trek im Atlasgebirge",
    category: "trekking",
    origin: "marrakech",
    difficulty: "moderate",
    ...
    shortDescription: "Eine zweitägige Überquerung ins ruhige Azzaden-Tal über den Tizi-Mzik-Pass, mit einer Nacht in einem Berber-Gästehaus abseits der Toubkal-Menge.",
    description: "Das Azzaden ist das Nachbartal des belebten Imlil–Toubkal-Korridors und bleibt gerade deshalb weit ruhiger. In zwei Tagen überqueren Sie den Tizi-Mzik-Pass (2.684 m), während sich das ganze Toubkal-Massiv hinter Ihnen öffnet, steigen durch Wacholderwald zu den entlang des Azzaden-Flusses verstreuten Dörfern ab und verbringen eine Nacht in einem familiengeführten Gästehaus in Tizi Oussem. Der zweite Tag überquert den Tizi-Oudid-Pass und steigt durch terrassierte Weiler nach Aguersioual ab. Kein technisches Gelände, keine Höhenextreme — nur ein echter Vorgeschmack auf das Berber-Bergleben, in zwei Tagen ab Marrakesch.",
    highlights: [
      "Den Tizi-Mzik-Pass (2.684 m) mit Panoramablick auf den Hohen Atlas überqueren",
      "Übernachtung in einem familiengeführten Berber-Gästehaus im Dorf Tizi Oussem",
      "Durch das ruhige Azzaden-Tal wandern — Wacholderwald, Terrassenfelder, Walnusshaine",
      "Eine echte Dorf-zu-Dorf-Überquerung, weit abseits der Toubkal-Menge",
    ],
    includes: [
      "Professioneller lizenzierter Bergführer",
      "1 Nacht im Berber-Gästehaus",
      "Alle Mahlzeiten während des Treks",
      "Maultier für das Gruppengepäck",
      "Hin- und Rücktransfer ab Marrakesch",
    ],
    excludes: [
  ...
  },
  {
    ...
    title: "Dörfer des Hohen Atlas — 3-Tage-Trek",
    category: "trekking",
    origin: "marrakech",
    difficulty: "moderate",
    ...
    highlights: [
      "Drei Atlas-Täler verbinden — Imlil, Azzaden und das Ourika-Einzugsgebiet",
      "Mehrere Berber-Pässe mit Panoramen auf den Hohen Atlas überqueren",
      "Zwei Nächte in verschiedenen Dorf-Gästehäusern, von einheimischen Familien beherbergt",
      "Stetiges, mittleres Gehen ohne Gipfelanstieg und ohne Höhennächte",
    ],
    includes: [
      "Professioneller lizenzierter Bergführer",
      "2 Nächte im Berber-Gästehaus",
      "Alle Mahlzeiten während des Treks",
      "Maultier für das Gruppengepäck",
      "Hin- und Rücktransfer ab Marrakesch",
    ],
  ...
  },
  {
    ...
    title: "Hoher Atlas für Familien — 4-Tage-Sanfttrek",
    category: "trekking",
    origin: "marrakech",
    difficulty: "easy",
    ...
    highlights: [
      "Kurze, sanfte Gehtage im Familientempo (3–4 Stunden)",
      "Nächte in Dorf-Gästehäusern bei Berberfamilien — Brotbacken, Minztee",
      "Wasserfälle, Flusspools und Walnusshaine statt hoher Pässe",
      "Maultiere tragen das gesamte Gepäck und können müde jüngere Kinder tragen",
    ],
    includes: [
      "Professioneller lizenzierter Bergführer mit Familienerfahrung",
      "3 Nächte im Berber-Gästehaus",
      "Alle Mahlzeiten während des Treks",
      "Maultiere für das Gepäck (und müde Kinder)",
      "Hin- und Rücktransfer ab Marrakesch",
    ],
    excludes: [
      "Reiseversicherung (empfohlen)",
  ...
  },
  {
    ...
    title: "Familien-Wüstenabenteuer — 4 Tage von Marrakesch in die Sahara",
    category: "desert",
    origin: "marrakech",
    difficulty: "easy",
    duration: "4 days / 3 nights",
    ...
    shortDescription: "Ein viertägiger Marrakesch-Sahara-Rundtrip im Familientempo: ein komfortables Fahrzeug, eine Kasbah-Filmkulisse, eine Nacht auf den Dünen, Kamelritte und kurze, leichte Stopps.",
    description: "Der klassische Wüsten-Rundtrip ab Marrakesch, so angepasst, dass er mit Kindern funktioniert. Die Distanzen sind gleich — über den Atlas nach Aït Ben Haddou, durchs Schluchtenland zu den Erg-Chebbi-Dünen und zurück — aber die Fahrt ist in kürzere, komfortable Etappen mit richtigen Stopps aufgeteilt, mit Hotelnächten mit Pool und einem Wüstencamp, das für Familien gebaut ist statt eines spartanischen Biwaks. Kinder bekommen Kamelritte, eine Game-of-Thrones-Filmkulisse zum Erkunden, Sandboarding auf den Dünen und eine Nacht unter einem sternenvollen Himmel. Alles bewegt sich im klimatisierten Fahrzeug, es gibt also keinen Gehanspruch — nur ein großes, unvergessliches Abenteuer, das die ganze Familie teilen kann.",
    highlights: [
      "Eine ganze Nacht auf den Erg-Chebbi-Dünen in einem familienfreundlichen Wüstencamp",
      "Kamelritte und Sandboarding auf den Dünen für die Kinder",
      "Die Kasbah Aït Ben Haddou erkunden — eine Game-of-Thrones- und Gladiator-Filmkulisse",
      "Komfortables klimatisiertes Fahrzeug mit kurzer, aufgeteilter Fahrt",
    ],
    includes: [
      "Klimatisierter Minibus-/4x4-Transport durchgehend",
      "Professioneller zweisprachiger Fahrer-Guide (Englisch/Französisch)",
      "1 Nacht Hotel im Dades-Tal (Abendessen + Frühstück)",
      "1 Nacht Familien-Wüstencamp am Erg Chebbi (Abendessen + Frühstück)",
      "1 Nacht Hotel in Ouarzazate (Frühstück)",
      "Kamelritte bei Sonnenuntergang und Sonnenaufgang am Erg Chebbi",
      "Alle Transfers und Zugangsgebühren",
    ],
    excludes: [
      "Mittagessen (empfohlenes Budget: 12–15 € pro Mahlzeit)",
      "Eintrittskarte für die Atlas-Filmstudios (optional, ~7 €)",
    ...
    faq: [
      ...
      { q: "Wie lang ist jeder Tag im Auto?", a: "Die längsten Fahrtage sind der erste und der letzte, über den Atlas — jeweils mehrere Stunden, aber durch Kasbah, Schluchten und Fotostopps unterbrochen statt in einem Zug. Die mittleren Tage sind kürzer, mit mehr Zeit tatsächlich in der Wüste." },
      { q: "Was ist nicht enthalten?", a: "Mittagessen (Budget etwa 12–15 € pro Mahlzeit), die optionale Eintrittskarte für die Atlas-Filmstudios (~7 €), persönliche Reiseversicherung und Trinkgelder. Alles andere — Transport, drei Nächte Unterkunft mit den genannten Mahlzeiten, Kamelritte und Zugangsgebühren — ist abgedeckt." },
    ],
    featured: false,
  },
  {
    ...
    title: "Große Durchquerung des Hohen Atlas — 15-Tage-Trek vom M'Goun zum Toubkal",
    category: "trekking",
    origin: "marrakech",
    difficulty: "expert",
    ...
    shortDescription: "Die vollständige West-Ost-Durchquerung des Hohen Atlas zu Fuß: vom Aït-Bougmez-Tal, dem „Glücklichen Tal“, über den M'Goun (4.068 m) zu einem Toubkal-Gipfel (4.167 m) — die zwei höchsten Gipfel Nordafrikas in fünfzehn Tagen verbunden.",
    description: "Dies ist die große Wanderung des Hohen Atlas — eine echte Gebirgsdurchquerung statt einer Einzelgipfel-Tour. Beginnend im Aït-Bougmez-Tal, dem „Glücklichen Tal“ mit Terrassenfeldern und Lehmdörfern, überqueren Sie das M'Goun-Massiv und stehen auf seinem 4.068-m-Gipfel, dann verbringen Sie eineinhalb Wochen damit, westwärts durch Schluchten, Hochplateaus, Hirtenweiden und Dörfer zu ziehen, die kaum Besucher von außen sehen — darunter Magdaz, das die UNESCO als das schönste Dorf Marokkos bezeichnet hat. Die Durchquerung endet im Toubkal-Massiv mit einem Gipfel des Jbel Toubkal (4.167 m), dem höchsten Punkt Nordafrikas, bevor es nach Imlil hinabgeht. Fünfzehn Tage abgelegenes, hohes und körperlich forderndes Trekking mit voller Maultier-Unterstützung — die anspruchsvollste Reise, die wir anbieten, und die schönste.",
    highlights: [
      "Die zwei höchsten Gipfel Nordafrikas besteigen — M'Goun (4.068 m) und Toubkal (4.167 m)",
      "Im „Glücklichen Tal“ Aït Bougmez beginnen, dem klassischen westlichen Ausgangspunkt",
      "Durch Magdaz kommen — von der UNESCO als schönstes Dorf Marokkos bezeichnet",
      "Abgelegene Hochplateaus und Schluchten überqueren, die Außentrekker selten sehen",
      "Volle Maultier-Unterstützung und ein Bergteam über die gesamte 15-tägige Durchquerung",
    ],
    includes: [
      "Professioneller lizenzierter Höhen-Bergführer",
      "14 Nächte Unterkunft (Dorf-Gîtes, Berghütten und Zelten)",
      "Alle Mahlzeiten während des Treks",
      "Koch und komplettes Maultierteam, das Ausrüstung, Verpflegung und Camp trägt",
      "Nationalpark- / Zugangsgebühren für Toubkal und M'Goun",
      "Hin- und Rücktransfer von Marrakesch zu den Ausgangspunkten",
    ],
    excludes: [
      "Reiseversicherung mit Höhendeckung (obligatorisch)",
      "Persönliche Trekkingausrüstung und Schlafsack",
      "Steigeisen und Eispickel bei Winterbedingungen (Verleih möglich)",
      "Trinkgelder für Führer, Koch und Maultiertreiber",
    ],
    itinerary: [
      {
        day: 1,
    ...
    faq: [
      ...
      { q: "Wo übernachtet man über die fünfzehn Tage?", a: "Eine Mischung aus Dorf-Gîtes (einfache Familien-Gästehäuser), der Toubkal-Hütte und Wildcamping auf den Hochplateaus, wo es keine Dörfer gibt. Das Team trägt und baut das Camp auf; Sie tragen nur einen Tagesrucksack. Ein Schlafsack ist nicht enthalten." },
      { q: "Was ist die beste Jahreszeit für diesen Trek?", a: "Später Frühling (Mai–Juni) und Herbst (September–Oktober) sind ideal: Die hohen Pässe sind größtenteils schneefrei und die Temperaturen machbar. Im Winter wird die Durchquerung zu einem ernsthaften bergsteigerischen Unterfangen, das Steigeisen und Eispickel erfordert, und einige Pässe können unpassierbar sein." },
      { q: "Wie wird der Trek unterstützt?", a: "Vollständig. Ein lizenzierter Höhenführer leitet, ein Koch übernimmt alle Mahlzeiten, und ein Maultierteam trägt Ausrüstung, Verpflegung und Camp über die gesamte Durchquerung. Diese Unterstützung macht fünfzehn Tage im abgelegenen Hochgebirge machbar — Sie gehen mit einem Tagesrucksack, während die Logistik übernommen wird." },
    ],
    featured: true,
  },
];
