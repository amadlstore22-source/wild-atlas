...
export interface Tour {
  ...
  priceMax?: number;
  /**
   * A set-date departure sold as individual seats, rather than a private trip
   * run for whoever books. Presence of this field is what makes a tour a fixed
   * departure; absence keeps every existing tour behaving exactly as before.
   *
   * WHY THIS IS NOT `groupPricing`
   * The ladder assumes we run YOUR group and the per-person cost falls as fixed
   * costs (guide, vehicle) are shared out. A fixed departure inverts that: the
   * seat price is flat because the trip runs regardless, and what varies is how
   * many seats are left. So `price` is the seat price and the ladder is absent.
   *
   * `listPrice` is the rate charged outside a promotion. It exists so a
   * discount can be shown with a real reference price — under the EU Omnibus
   * Directive a struck-through "was" figure must be a price genuinely charged,
   * never an invented anchor. If the discount ever becomes permanent, delete
   * `listPrice` rather than leaving a figure nobody actually pays.
   */
  fixedDeparture?: {
    /** ISO dates (YYYY-MM-DD) this trip departs. */
    dates: string[];
...
export const TOURS: Tour[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    title: "4-Day Toubkal Summit Trek from Marrakech",
    category: "trekking",
    origin: "marrakech",
    ...
    description:
      "This 4-day Toubkal summit trek leaves Marrakech for Imlil (1,740 m) and climbs to 4,167 m — the highest peak in North Africa. Our family is from the southern slopes of the High Atlas, where these paths begin. You walk the old mule track up the Mizane Valley past the Sidi Chamharouch shrine to the refuge at 3,207 m, then start for the summit at 5:00 am on day three and reach the top at sunrise. It asks for fitness and a head for long days, not for climbing experience: there is no rope and no technical ground, and your licensed mountain guide has walked this route in every season.",
    highlights: [
  ...
  },
  {
    ...
    seoTitle: "3-Day Merzouga Desert Tour, Marrakech",
    seoDescription: "Camel trek into Erg Chebbi, overnight Berber camp, Aït Ben Haddou & Todra Gorge. Private 4x4, licensed guides. From €230 pp for 6+.",
    featured: true,
  },
  {
    id: "3",
    ...
    seoTitle: "Ourika Valley Day Hike from Marrakech | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: "Ouzoud Waterfalls Day Trip from Marrakech | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: "Agafay Desert Sunset Tour from Marrakech | Marrakech Eco Tours",
  ...
  },
  {
    ...
    seoTitle: "Marrakech Medina Cultural Tour | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "3-Day Marrakech to Fes Tour | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: "Mgoun Massif Trek 7 Days | Marrakech Eco Tours",
    seoDescription:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seoTitle: "Paradise Valley Day Trip from Agadir | Marrakech Eco Tours",
  ...
  },
  {
    ...
    seoTitle: "Souss-Massa National Park Wildlife Tour | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: "Taroudant Day Trip from Agadir | Marrakech Eco Tours",
  ...
  },
  {
    ...
    seoTitle: "Surf Lessons in Agadir — Atlantic Coast | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    itinerary: [
      {
        ...
        walking: "3–4 h",
        driving: "≈3 h",
        stop: { name: "Tafraoute", lat: 29.717, lng: -8.967 },
    ...
    seoTitle: "Anti-Atlas Mountains Trek 3 Days | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: "Souss Valley Argan & Culture Day Trip | Marrakech Eco Tours",
  ...
  },
  {
    ...
    seoTitle: "Essaouira Day Trip from Agadir | Marrakech Eco Tours",
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "Marrakech to Chefchaouen 4-Day Blue City | Marrakech Eco Tours",
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "All 4 Imperial Cities Morocco 5-Day Tour | Marrakech Eco Tours",
    seoDescription:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    featured: false,
    seoTitle: "Marrakech to Zagora 2-Day Desert Tour | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    itinerary: [
      ...
      },
      {
        ...
        driving: "≈4 h",
        distance: "≈220 km",
        stop: { name: "Todra Gorge", lat: 31.55, lng: -5.55 },
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    featured: true,
    seoTitle: "4-Day Desert Tour from Marrakech | Marrakech Eco Tours",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — your hotel or riad" },
    featured: false,
    seoTitle: "Agadir to Merzouga 3-Day Desert Tour | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — your hotel or riad" },
    featured: false,
    seoTitle: "4-Day Desert Tour from Agadir | Marrakech Eco Tours",
    seoDescription:
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — your hotel or riad" },
    seoTitle: "4-Day Agadir to Fes Tour | Marrakech Eco Tours",
  ...
  },
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — your hotel or riad" },
    seoTitle: "5-Day Agadir to Chefchaouen Tour | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — your hotel or riad" },
    seoTitle: "All 4 Imperial Cities Morocco 6-Day Tour | Marrakech Eco Tours",
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "6-Day Toubkal Circuit Trek via Lake Ifni | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "3-Day Toubkal Trek via Aguelzim Pass | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Toubkal Three Peaks 4,000 m Challenge | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    seoTitle: "Marrakech Food & Market Tour | Marrakech Eco Tours",
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "Merzouga Stargazing Tour | Marrakech Eco Tours",
    ...
    faq: [
      ...
      { q: "What will I actually be able to see?", a: "With no light pollution for tens of kilometres, the Milky Way is visible to the naked eye from roughly March to October, along with the major planets and, in a good year, meteor showers. Moon phase matters more than season — a full moon washes out the fainter detail, so check the calendar if the night sky is the reason you are booking." },
      { q: "Is there a telescope, or is this naked-eye?", a: "The dunes are dark enough that most of what makes the night memorable is naked-eye. Bring binoculars if you have them; they show more of the Milky Way's structure than people expect." },
      { q: "Will the camp lights spoil it?", a: "The generator goes off at night, which is deliberate. Once it does, the camp is genuinely dark — that is the whole reason to sleep out there rather than in Merzouga town." },
    ],
    featured: false,
  },
  {
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Azzaden Valley 2-Day Trek | Marrakech Eco Tours",
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "3-Day Atlas Mountains Trek | Marrakech Eco Tours",
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Family Atlas Mountains Trek 4 Days | Marrakech Eco Tours",
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "What ages does this work for?", a: "It is graded easy and families book it across a wide age range. The camel ride is short and optional, and the walking is minimal. The limiting factor is the driving — a child who struggles with several hours in a car will find day one long, which is exactly why this is the four-day version rather than the three." },
      { q: "Are there activities for children at the camp?", a: "The dunes themselves do most of the work — sandboarding and running up and down them occupies most children until dinner. Evenings are drumming and a fire rather than anything scheduled." },
      { q: "Can you cater for fussy eaters and dietary needs?", a: "Yes. Tagine and couscous are the staples, and plainer options are always available. Tell us about allergies or dietary requirements when you book so the camp knows before you arrive." },
      { q: "Are there family rooms, or do we split up?", a: "Tents and rooms are allocated to keep families together — you will not be separated across the camp. Tell us the ages and group make-up when booking and we will arrange it." },
    ],
    featured: false,
  },
  {
    ...
    seoTitle: "High Atlas Grand Traverse 15 Days | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "Toubkal Summit & Sahara 5-Day Tour | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    featured: false,
    seoTitle: "8-Day Chegaga Camel Trek from Marrakech | Marrakech Eco Tours",
    seoDescription:
  ...
  },
  {
    ...
    description:
      "The same route as our private 3-day tour, on a fixed daily departure you share with other travellers. Over the Tizi n'Tichka pass, past the UNESCO ksar at Aït Ben Haddou, through the Dades and Todra gorges, then a camel ride into Erg Chebbi and a night at a desert camp. You give up the flexibility to stop where you like; you get the Sahara at a third of the private price.",
    highlights: [
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "Merzouga Desert 3-Day Shared Tour — €120 | Marrakech Eco Tours",
  ...
  },
  {
    ...
    description:
      "Zagora is the closest desert overnight to Marrakech, which is exactly its appeal: one long driving day instead of two. Over the Tizi n'Tichka, past Aït Ben Haddou and Ouarzazate, into the Draa Valley palm groves, then a camel ride to a camp for dinner and drumming. The dunes are smaller than Erg Chebbi — this is the trade for the shorter trip.",
    highlights: [
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "Zagora Desert 2-Day Shared Tour — €85 | Marrakech Eco Tours",
  ...
  },
  {
    ...
    shortDescription:
      "North Africa's highest waterfall on a shared daily departure — 110 m of cascades, wild macaques and a boat ride at the base.",
    description:
      "The Ouzoud Falls drop 110 metres in three stages through a gorge full of olive groves and old watermills, with a resident colony of wild Barbary macaques along the upper trail. A shared minibus leaves Marrakech each morning; you walk down to the base, take the small boat under the spray, and are back in the city by evening.",
    highlights: [
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "Ouzoud Waterfalls Shared Day Trip — €40 | Marrakech Eco Tours",
  ...
  },
  {
    ...
    description:
      "Agafay is a rocky desert rather than a sand sea, and its appeal is proximity: forty minutes from Marrakech, with the Atlas on the horizon and no light pollution. The evening runs camel ride at golden hour, then dinner in a camp with music and a fire show, and back to your riad the same night. It is not the Sahara, and we say so — but as an evening out it is hard to beat.",
    highlights: [
    ...
    faq: [
      { q: "Is Agafay the Sahara?", a: "No, and any operator telling you otherwise is selling you something. Agafay is a rocky, lunar-looking desert about 30 km from Marrakech — no sand dunes. It is a genuinely beautiful evening and a poor substitute for Erg Chebbi. For real dunes you need [Merzouga](/en/tours/shared-merzouga-3day-marrakech) or [Zagora](/en/tours/shared-zagora-2day-marrakech)." },
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "Agafay Desert Dinner & Camel Ride — €30 | Marrakech Eco Tours",
  ...
  },
  {
    ...
    relatedPosts: ["private-vs-shared-desert-tour-morocco", "essaouira-day-trip-from-agadir", "best-day-trips-from-agadir"],
    title: "Essaouira — Shared Day Trip from Marrakech",
    category: "day-tours",
    origin: "marrakech",
    difficulty: "easy",
    duration: "1 day",
    ...
    shortDescription:
      "The Atlantic port city on a shared daily departure — ramparts, blue fishing boats, the medina and argan cooperatives on the road.",
    description:
      "Essaouira is a fortified port on the Atlantic, three hours west of Marrakech: whitewashed and blue, walkable, and far cooler than the city in summer. The shared day trip stops at an argan cooperative on the way, then leaves you several free hours in the UNESCO medina, on the ramparts and at the fishing harbour before the drive back.",
    highlights: [
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — your hotel or riad" },
    seoTitle: "Essaouira Shared Day Trip — €30 | Marrakech Eco Tours",
  ...
  },
  {
    ...
    tourType: "shared",
    // Both fields are @deprecated placeholders (see the Tour interface): not
    // rendered and not emitted as schema. reviewCount stays 0 because this
    // departure has genuinely not run yet; rating carries the neutral 5 the
    ...
    faq: [
      ...
      { q: "What is the weather like on these dates?", a: "The departures span March to mid-April, and the mountain changes across that window. March is still winter on Toubkal -- snow on the upper slopes and sub-zero at the summit at dawn, with crampons and an ice axe supplied where conditions require them. By the April dates the snowline has usually retreated and the walking is easier, though the summit can still be below freezing before sunrise. The desert leg is the opposite on every date: warm days and cold, clear nights." },
