  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <Link
          href={`/${lang}/guides`}
          className="inline-flex items-center gap-2 text-charcoal/50 hover:text-forest text-sm font-medium transition-colors"
        >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-[300px_1fr] gap-12 items-start">
          ...
          <div className="lg:sticky lg:top-24">
            <div className="bg-white rounded-3xl border border-sand-dark overflow-hidden shadow-sm">
              {/* Avatar */}
              <div className="relative h-72 bg-gradient-to-br from-forest/10 to-forest/25 flex items-center justify-center">
                ...
                {guide.isLegacy && (
                  <div className="absolute top-4 right-4 bg-charcoal/90 text-white text-xs font-bold px-3 py-1 rounded-full">
                    Legacy
                  </div>
                )}
              </div>
              ...
              <div className="p-6 space-y-4">
                <div>
                  <h1 className="font-serif text-charcoal text-2xl font-bold">{guide.name}</h1>
          ...
          <div className="space-y-12">
            ...
            {/* Bio */}
            <div>
              <p className="text-sunset text-xs font-bold uppercase tracking-[0.2em] mb-5">About</p>
            ...
            {/* Specialties */}
            <div>
              <p className="text-sunset text-xs font-bold uppercase tracking-[0.2em] mb-5">Specialties</p>
            ...
            {guidedTours.length > 0 && (
              <div>
                <p className="text-sunset text-xs font-bold uppercase tracking-[0.2em] mb-5">Tours led by {guide.name.split(" ")[0]}</p>
            ...
            {guide.isLegacy && (
              <div className="bg-charcoal rounded-2xl p-8 text-white">
                <h3 className="font-serif text-xl font-bold mb-3">The story behind the guides</h3>
