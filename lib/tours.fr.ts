...
export const TOURS: Tour[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seoTitle: "Trek au sommet du Toubkal en 4 jours",
    seoDescription: "Conquérez le Jbel Toubkal (4 167 m) avec un guide berbère diplômé. Trek de 4 jours au départ de Marrakech — refuges.",
    featured: true,
  },
  {
    id: "2",
    ...
    faq: [
      ...
      { q: "Comment se passe la nuit au camp du désert ?", a: "Des lits avec couvertures sous tente, un dîner tous ensemble, et un silence complet une fois le camp endormi. Les dunes sont vraiment plongées dans le noir, c'est pourquoi la plupart des voyageurs se souviennent davantage du ciel étoilé que de la balade à dos de chameau. Prévoyez une couche chaude — les nuits désertiques sont fraîches hors été." },
      ...
      { q: "Comment sont les sanitaires et les douches au camp ?", a: "Les camps permanents que nous utilisons disposent de tentes sanitaires avec eau courante et une vraie douche — privative ou partagée selon le camp. La pression au milieu de l'Erg reste modeste, mais il s'agit bien d'une vraie douche chaude et non d'un seau. Si une tente avec salle de bain privative compte pour vous, dites-le à la réservation et nous vous proposerons un camp qui en possède." },
      { q: "Puis-je recharger mon téléphone dans le désert ?", a: "Oui. Le camp a l'électricité, donc téléphones et batteries d'appareil photo se rechargent, et il y a le Wi-Fi — lent au milieu des dunes, mais suffisant pour les messages et les photos." },
    ...
    seoTitle: "Circuit désert du Sahara de 3 jours",
    seoDescription: "Balade à dos de chameau dans l'Erg Chebbi au coucher du soleil et nuit sous les étoiles. Circuit de 3 jours Marrakech-Sahara avec Aït Ben Haddou.",
    featured: true,
  },
  {
    id: "3",
    ...
    includes: [
      "Guide de randonnée diplômé",
      "Transport aller-retour depuis Marrakech",
      "Déjeuner berbère traditionnel",
      "Eau minérale tout au long du circuit",
    ],
    excludes: ["Équipement de randonnée personnel", "Pourboires"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    faq: [
      ...
      { q: "Quelle est la taille du groupe ?", a: "Entre 2 et 15 personnes, et l'excursion est privée — le groupe est le vôtre, vous ne marchez donc qu'avec les personnes avec qui vous avez réservé. Le prix par personne baisse à mesure que le groupe s'agrandit." },
    ],
    meetingPoint: { lat: 31.3489, lng: -7.7411, name: "Ourika Valley, High Atlas" },
    seoTitle: "Randonnée la vallée de l'Ourika",
    seoDescription: "Randonnée jusqu'aux cascades de Setti Fatma à travers villages berbères et torrents de montagne, à seulement 45 minutes de Marrakech.",
    featured: true,
  },
  {
    id: "4",
    ...
    includes: [
      "Transport aller-retour depuis Marrakech",
      "Guide diplômé",
      "Tour en barque au pied des cascades",
      "Eau minérale",
    ],
    excludes: ["Déjeuner", "Pourboires", "Achats personnels"],
    itinerary: [
      {
        day: 1,
        walking: "2–3 h",
    ...
    faq: [
      ...
      { q: "Quelle est la taille du groupe ?", a: "Entre 2 et 15 personnes, et l'excursion est privée — le groupe est le vôtre, vous ne voyagez donc qu'avec les personnes avec qui vous avez réservé. Le prix par personne baisse à mesure que le groupe s'agrandit." },
    ...
    seoTitle: "Excursion cascades d'Ouzoud de Marrakech",
    seoDescription: "Visitez la plus haute cascade du Maroc — 110 mètres d'eau en chute, des macaques de Barbarie sauvages et une balade en barque dans les gorges.",
    featured: false,
  },
  {
    id: "5",
    ...
    seoTitle: "Coucher de soleil au désert d'Agafay",
    seoDescription: "Le désert en 30 minutes : quad, chameaux au coucher du soleil et dîner berbère dans le désert de pierre d'Agafay, près de Marrakech.",
    featured: false,
  },
  {
    id: "6",
    ...
    excludes: ["Déjeuner", "Achats et souvenirs", "Pourboires"],
    itinerary: [
      {
        day: 1,
        walking: "4 h (on foot)",
    ...
    seoTitle: "Circuit culturel de la médina de Marrakech",
    seoDescription: "Explorez la médina de Marrakech classée UNESCO avec un guide local — tanneries en cuir, médersa Ben Youssef, place Jemaa el-Fnaa et jardins de riads cachés.",
    featured: false,
  },
  {
    id: "7",
    ...
    excludes: ["Déjeuners et dîners", "Pourboires", "Transport retour depuis Fès"],
    itinerary: [
      {
        day: 1,
        meals: "D",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Circuit Marrakech-Fès de 3 jours",
    seoDescription: "Route de Marrakech à Fès via le Tizi n'Tichka, Aït Ben Haddou et les forêts de cèdres du Moyen Atlas. Circuit privé de 3 jours en 4x4 avec hébergement en riad.",
    featured: false,
  },
  {
    id: "8",
    ...
    brief: [
      "Sept jours à travers le massif du Mgoun, cette partie du Haut Atlas que la fréquentation touristique n'atteint jamais. Le premier jour, 5 heures de route jusqu'à Aït M'hamed et une nuit chez une famille berbère. Le deuxième traverse les Aït Bouguemez — la « vallée heureuse » — jusqu'au campement d'Agouti, à 2 600 m. Le troisième franchit le premier col élevé, le Tizi n'Ait Imi à 3 650 m, avec 1 050 m de dénivelé. Le quatrième commence avant l'aube pour le sommet du Jbel Mgoun à 4 068 m, deuxième plus haut sommet du Maroc, puis descend dans les gorges de la Tessaoute.",
      "Les cinquième et sixième jours sont la raison pour laquelle les trekkeurs expérimentés choisissent ce circuit plutôt qu'un itinéraire vers le Toubkal. Le cinquième traverse les gorges de la Tessaoute aux parois rouges, avec baignade sauvage dans la rivière ; le sixième sort des gorges vers Bou Tharar et une nuit chez une famille du village. Le septième rentre à Marrakech par la vallée des roses, avec une arrivée vers 16 h. Quatre nuits en bivouac, deux chez l'habitant.",
      "Le niveau est expert, et cette classification tient à l'accumulation plutôt qu'à la technique. Aucune journée ne demande de compétences d'alpinisme. Mais ce sont sept jours consécutifs en altitude dans un pays offrant peu de points de sortie, et l'équipe de mulets transporte le campement parce qu'il n'y a nulle part où se réapprovisionner. Quiconque a bouclé le Toubkal sans difficulté et cherche l'étape suivante trouvera ici, réellement, l'étape suivante.",
      "Par personne : 1 350 € seul, 760 € à deux, 710 € à trois, 680 € à quatre, 625 € à cinq et 596 € à six, dans un groupe limité à huit. Sont inclus un guide de haute montagne diplômé et expert, tous les repas pendant sept jours, l'équipe de mulets, les campements et les nuits chez l'habitant, les frais du parc national et — ce qui mérite d'être souligné sur un trek aussi isolé — un moyen de communication satellite d'urgence.",
      "L'assurance voyage et médicale est ici obligatoire et non recommandée, et il faut le lire au pied de la lettre : du troisième au sixième jour, vous êtes très loin d'une route. L'équipement technique d'alpinisme et les pourboires ne sont pas inclus. Si vous comparez ce circuit au Toubkal, la distinction honnête est la suivante : le Toubkal est un sommet que l'on peut insérer dans des vacances, le Mgoun est une expédition qui devient les vacances.",
    ],
    ...
    includes: [
      ...
      "Tous les repas du circuit",
      "Mules pour le portage du matériel",
    ...
    seoTitle: "Trek du massif du M'Goun en 7 jours",
    seoDescription: "Trek de 7 jours dans le massif reculé du M'Goun : sommet à 4 068 m, cols d'altitude et nuits chez l'habitant, sans autre touriste.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    excludes: ["Affaires de bain personnelles", "Pourboires"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    seoTitle: "Excursion Paradise Valley depuis Agadir",
    seoDescription: "Gorge de palmiers cachée avec bassins naturels à 35 km d'Agadir. Randonnée guidée dans un canyon spectaculaire, cascade d'Immouzer et déjeuner berbère inclus.",
    featured: true,
  },
  {
    id: "10",
    ...
    excludes: ["Matériel photo personnel", "Pourboires"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    faq: [
      ...
      { q: "Quelle est la taille du groupe ?", a: "Entre 2 et 12 personnes, et l'excursion est privée — le groupe est le vôtre. Le petit effectif est voulu : le guide naturaliste peut montrer les oiseaux et la faune à chacun." },
    ],
    meetingPoint: { lat: 30.0559, lng: -9.6320, name: "Souss-Massa National Park, Massa" },
    seoTitle: "Souss-Massa : faune et ibis chauve",
    seoDescription: "Observez l'ibis chauve, gravement menacé, et des flamants roses dans la réserve naturelle la plus importante du Maroc. Guide naturaliste expert.",
    featured: true,
  },
  {
    id: "11",
    ...
    excludes: ["Déjeuner", "Achats", "Pourboires"],
    itinerary: [
      {
        day: 1,
        walking: "2–3 h",
    ...
    faq: [
      ...
      { q: "Quelle est la taille du groupe ?", a: "Entre 2 et 14 personnes, et l'excursion est privée — le groupe est le vôtre, vous ne voyagez donc qu'avec les personnes avec qui vous avez réservé. Le prix par personne baisse à mesure que le groupe s'agrandit." },
    ],
    meetingPoint: { lat: 30.4702, lng: -8.8773, name: "Taroudant, Souss Valley" },
    seoTitle: "Excursion Taroudant depuis Agadir",
    seoDescription: "Découvrez les remparts du XVIe siècle les mieux conservés du Maroc et les marchés berbères authentiques de Taroudant — à 80 km d'Agadir.",
    featured: false,
  },
  {
    id: "12",
    ...
    excludes: ["Transport jusqu'à la plage (5 min à pied du centre)", "Pourboires"],
    itinerary: [
      {
        day: 1,
        walking: "2 h session",
    ...
    seoTitle: "Cours de surf à Agadir",
    seoDescription: "Apprenez à surfer sur les vagues atlantiques chaudes de la baie d'Agadir avec un moniteur ISA certifié. Planche, combinaison et briefing sécurité inclus.",
    featured: false,
  },
  {
    id: "13",
    ...
    includes: [
      ...
      "Tous les repas",
      "Transport aller-retour depuis Agadir",
      "Mule pour le portage du matériel",
    ],
    excludes: ["Assurance voyage (recommandée)", "Équipement de randonnée personnel", "Pourboires"],
    itinerary: [
      {
        day: 1,
        meals: "L,D",
    ...
    seoTitle: "Trek 3 jours montagnes de l'Anti-Atlas",
    seoDescription: "Trek de 3 jours à travers la chaîne de montagnes la plus méconnue du Maroc — pics de granit rose, gorges en fleurs d'amandiers et villages berbères reculés.",
    featured: true,
  },
  {
    id: "14",
    ...
    brief: [
      "Presque tous les circuits vers le Sahara au Maroc partent de Marrakech. Celui-ci part d'Agadir et emprunte la route du sud par Tata et Foum Zguid jusqu'à l'Erg Chegaga, qui est un désert véritablement différent de celui des cartes postales. Chegaga est le plus vaste et le plus isolé champ de dunes du pays, atteint en 4x4 à travers des étendues ouvertes plutôt qu'en autocar jusqu'à un campement au bord de la route.",
      "Soyez lucide sur la route, car c'est la caractéristique déterminante : environ 8 heures et 450 km dans chaque sens, les deux jours. Cela représente beaucoup de véhicule pour un circuit de deux jours, et c'est le prix à payer pour atteindre Chegaga depuis la côte. En échange, vous obtenez un champ de dunes où vous ne partagez pas le coucher de soleil avec cinquante autres personnes. Si ce sont les longs trajets qui posent problème plutôt que la distance, la version en 4 jours au départ de Marrakech convient mieux.",
      "Le premier jour suit Agadir–Tata–Foum Zguid puis rejoint les dunes, avec une arrivée pour la balade à dromadaire au coucher du soleil et le dîner au campement. Le deuxième jour, c'est le lever du soleil sur l'erg, puis le retour par la palmeraie de la vallée du Draa et ses kasbahs. Une nuit sous la toile, et le campement est assez éloigné de toute ville pour que la Voie lactée soit visible sans effort.",
      "Par personne : 790 € seul, 400 € à deux, 340 € à trois, 310 € à quatre et 280 € à cinq. Cela comprend le transport en 4x4 sur tout le trajet, un guide du désert expérimenté, la nuit au campement en tente de couchage privative avec dîner et petit-déjeuner, et toutes les balades à dromadaire. Une tente avec salle de bain privative est disponible si vous préférez éviter les sanitaires communs — mieux vaut le demander à la réservation qu'à l'arrivée.",
      "Le déjeuner du premier jour n'est pas inclus, pas plus que les effets personnels et les pourboires. Le groupe compte de 2 à 10 personnes et le circuit est privé. Le niveau est facile : il n'y a pratiquement pas de marche, et la seule véritable exigence est de tolérer une longue journée en véhicule sur une route que la plupart des visiteurs du Maroc ne voient jamais.",
    ],
    ...
    highlights: [
      ...
      "Camp berbère dans le désert, sous la Voie lactée — tente avec salle de bain privative en option",
      "Route méridionale via Tata et Foum Zguid",
    ],
    includes: [
      "Transport en 4x4 sur tout le circuit",
      "Guide du désert expérimenté",
      "1 nuit en campement, tente de couchage privative (dîner et petit-déjeuner)",
      "Toutes les balades à dos de chameau",
    ],
    excludes: ["Déjeuner le jour 1", "Dépenses personnelles et pourboires"],
    itinerary: [
      {
        day: 1,
        meals: "D",
    ...
    faq: [
      ...
      { q: "Comment est le camp ?", a: "Un campement permanent dans les dunes de Chegaga pour une nuit, dîner et petit-déjeuner inclus. Le tarif standard comprend une tente de couchage privative avec un bloc sanitaire commun à quelques pas. Une tente avec salle de bain privative (douche et toilettes à l'intérieur) est disponible pour +30 € par personne — le circuit ne compte qu'une nuit au désert, le supplément ne s'applique donc qu'une fois. Le ciel étoilé et le calme sont ce dont la plupart des gens se souviennent." },
      { q: "Qu'est-ce qui est inclus ?", a: "Le transport en 4x4 tout au long, un guide du désert expérimenté, une nuit au campement en tente de couchage privative avec dîner et petit-déjeuner, et toutes les balades à dos de chameau. Les sanitaires au tarif standard sont un bloc commun ; une tente avec salle de bain privative est à +30 € par personne. Le déjeuner du jour 1, les effets personnels et les pourboires ne sont pas inclus." },
      { q: "Est-ce exigeant ?", a: "Facile. La distance est couverte en 4x4, et les balades à dos de chameau sont courtes et facultatives." },
    ],
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — votre hôtel ou riad" },
    seoTitle: "Circuit Sahara de 2 jours depuis Agadir",
    seoDescription: "Les dunes reculées de l'Erg Chegaga via la route méridionale de la vallée du Drâa — balade à dos de chameau, campement berbère et lever de soleil sur le Sahara.",
    featured: true,
  },
  {
    id: "15",
    ...
    excludes: ["Achats de produits à l'argan", "Pourboires"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    seoTitle: "Vallée du Souss : argan et culture",
    seoDescription: "Visitez une coopérative d'huile d'argan gérée par des femmes, un village de miel et partagez un déjeuner en famille berbère dans la vallée du Souss.",
    featured: false,
  },
  {
    id: "16",
    ...
    excludes: ["Déjeuner et achats personnels", "Pourboires"],
    itinerary: [
      {
        day: 1,
        walking: "2–3 h",
    ...
    seoTitle: "Excursion Essaouira depuis Agadir",
    seoDescription: "Excursion d'une journée d'Agadir à la médina bleu et blanc d'Essaouira classée UNESCO — remparts portugais du XVIIIe siècle.",
    featured: false,
  },
  {
    id: "17",
    ...
    seoDescription: "Circuit de 4 jours de Marrakech aux ruelles bleutées de Chefchaouen via Fès, les ruines romaines de Volubilis et Meknès. 4x4 privé avec hébergement en riad.",
    featured: false,
  },
  {
    id: "18",
    ...
    excludes: ["Déjeuners et dîners", "Pourboires"],
    itinerary: [
      {
        day: 1,
        meals: "D",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Villes impériales du Maroc, 5 jours",
    seoDescription: "Grand circuit à travers les quatre capitales impériales du Maroc en 5 jours. Ruines romaines de Volubilis, tanneries Chouara, Bab Mansour et tour Hassan.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    featured: false,
    seoTitle: "Circuit Zagora 2 jours",
    seoDescription: "La route la plus rapide vers le Sahara — Aït Ben Haddou, les 200 km de palmeraie de la vallée du Drâa et une balade à dos de chameau dans les dunes.",
  },
  {
    id: "24",
    ...
    includes: [
      ...
      "Toutes les randonnées à dos de chameau",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    featured: true,
    seoTitle: "Circuit désert de 3 jours à l'Erg Chegaga",
    seoDescription: "L'expérience désertique la plus reculée du Maroc — 3 jours de Marrakech à l'Erg Chegaga via une traversée hors piste en 4x4.",
  },
  {
    id: "25",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    featured: true,
    seoTitle: "Circuit désert de 4 jours depuis Marrakech",
    seoDescription: "Le circuit désertique complet au départ de Marrakech — 4 jours à travers Aït Ben Haddou, les gorges du Todra.",
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — votre hôtel ou riad" },
    featured: false,
    seoTitle: "Merzouga 3 jours depuis Agadir",
    seoDescription: "De la côte atlantique d'Agadir au Sahara — via Taroudant, Taliouine, Aït Ben Haddou et une balade à dos de chameau au coucher du soleil sur l'Erg Chebbi.",
  },
  {
    id: "27",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — votre hôtel ou riad" },
    featured: false,
    seoTitle: "Circuit désert d'Agadir à Zagora en 2 jours",
    seoDescription: "D'Agadir au désert de Zagora en 2 jours, via Taroudant et la palmeraie du Drâa. Chameaux au coucher du soleil et camp berbère sous les étoiles.",
  },
  {
    id: "28",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — votre hôtel ou riad" },
    featured: false,
    seoTitle: "Erg Chegaga 3 jours depuis Agadir",
    seoDescription: "Le désert le plus reculé du Maroc au départ d'Agadir — 3 jours à travers l'Anti-Atlas jusqu'à l'Erg Chegaga en 4x4, une nuit dans un camp berbère privé.",
  },
  {
    id: "29",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — votre hôtel ou riad" },
    featured: false,
    seoTitle: "Circuit désert de 4 jours depuis Agadir",
    seoDescription: "Le grand circuit désertique complet au départ d'Agadir — 4 jours à travers Taroudant, Aït Ben Haddou, les gorges du Todra.",
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — votre hôtel ou riad" },
    seoTitle: "Circuit de 4 jours d'Agadir à Fès",
    seoDescription: "Route d'Agadir à Fès via Marrakech, le Tizi n'Tichka et les forêts de cèdres du Moyen Atlas. Circuit privé de 4 jours en 4x4 avec hébergement en riad.",
    featured: false,
  },
  {
    id: "20",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — votre hôtel ou riad" },
    seoTitle: "Circuit de 5 jours d'Agadir à Chefchaouen",
    seoDescription: "Circuit de 5 jours d'Agadir à la ville bleue du Maroc via Marrakech, Fès, les ruines romaines de Volubilis et les portes impériales de Meknès.",
    featured: false,
  },
  {
    id: "21",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — votre hôtel ou riad" },
    seoTitle: "Villes impériales du Maroc, 6 jours",
    seoDescription: "Grand circuit de 6 jours au départ d'Agadir à travers les quatre villes impériales marocaines — Marrakech, Meknès, Fès et Rabat.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Circuit Toubkal 6 jours, lac d'Ifni",
    seoDescription: "Le circuit complet du Toubkal en 6 jours au départ de Marrakech — cols d'altitude, le lac turquoise d'Ifni et le sommet du Jbel Toubkal (4 167 m).",
    featured: false,
  },
  {
    id: "31",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trek du Mont Toubkal en 2 jours",
    seoDescription: "Gravissez le Jbel Toubkal (4 167 m) en 2 jours depuis Marrakech — la route la plus rapide vers le plus haut sommet d'Afrique du Nord. Nuit en refuge.",
    featured: false,
  },
  {
    id: "32",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trek Toubkal 3 jours via le col d'Aguelzim",
    seoDescription: "Gravissez le Toubkal (4 167 m) par la route pittoresque — 3 jours via la vallée d'Azzaden, les cascades d'Ighouliden et le col d'Aguelzim (3 560 m).",
    featured: false,
  },
  {
    id: "33",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Défi des trois sommets à 4 000 m du Toubkal",
    seoDescription: "Gravissez trois sommets de 4 000 m du Haut Atlas en 3 jours — Timesguida (4 089 m), Ras Ouanoukrim (4 083 m) et Toubkal (4 167 m).",
    featured: false,
  },
  {
    id: "34",
    ...
    seoTitle: "Circuit gourmand et marchés de Marrakech",
    seoDescription: "Circuit gastronomique d'une demi-journée à Marrakech : dégustez votre chemin à travers les souks aux épices.",
    faq: [
  ...
  },
  {
    ...
    brief: [
      "La plupart des circuits dans le désert mentionnent les étoiles dans la brochure, puis vous laissent les regarder seul. Celui-ci est construit autour du ciel : après la balade à dromadaire au coucher du soleil et le dîner, un guide astronome installe un télescope au campement et passe en revue les planètes, les constellations et les objets du ciel profond visibles cette nuit-là, expliqués en langage ordinaire plutôt qu'en jargon. Vous n'avez besoin d'aucun matériel ni d'aucune connaissance préalable.",
      "Si cela fonctionne précisément à l'Erg Chebbi, c'est grâce à l'éloignement de toute lumière électrique. Aucune lueur urbaine dans quelque direction que ce soit : la Voie lactée est donc visible à l'œil nu par nuit claire — non pas comme une traînée floue, mais comme une structure à travers le ciel. C'est plus rare qu'on ne le croit ; il ne reste presque nulle part en Europe d'aussi sombre.",
      "La contrepartie, c'est la route. L'Erg Chebbi se trouve à environ 560 km et quelque 8 heures de Marrakech, dans chaque sens, et il s'agit d'un circuit de deux jours — donc une longue journée de route, une nuit au campement, et une longue journée de route au retour. Le premier jour arrive pour la balade à dromadaire et le dîner ; le deuxième, c'est le lever du soleil sur les dunes et le retour. Ceux qui préfèrent fractionner ce trajet devraient plutôt envisager un itinéraire désertique de 3 ou 4 jours.",
      "Par personne : 518 € seul, 260 € à deux, 191 € à trois, 160 € à quatre, 139 € à cinq et 121 € à six. Sont inclus le transport aller-retour depuis Marrakech, la balade à dromadaire au coucher du soleil, la nuit au campement, le dîner et le petit-déjeuner, ainsi que la séance au télescope avec le guide astronome. Le déjeuner en route n'est pas inclus, même si des arrêts sont prévus, et l'assurance voyage comme les pourboires sont à part.",
      "Deux points pratiques. La phase de la lune compte davantage que la saison — une pleine lune efface les objets faibles, donc si le ciel profond est la raison de votre venue, réservez autour de la nouvelle lune. Et les nuits du désert sont froides de l'automne au printemps, plus froides que la plupart des visiteurs ne l'anticipent ; l'observation se fait dehors, immobile, bien après la tombée de la nuit. Emportez une couche chaude que vous jugeriez excessive. Groupe privé de 2 à 10 personnes.",
    ],
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Nuit étoilée à Merzouga, 2 jours",
    seoDescription: "Circuit de 2 jours Marrakech-Merzouga pour observer les étoiles — balade à dos de chameau au coucher du soleil.",
    faq: [
  ...
  },
  {
    ...
    brief: [
      "L'Azzaden est la vallée immédiatement à l'ouest du couloir Imlil–Toubkal, et la différence de fréquentation en fait tout l'intérêt. Le premier jour, 1h30 de route de Marrakech à Imlil, puis environ 700 m de montée par le col de Tizi Mzik à 2 684 m — avec le massif du Toubkal qui se déploie derrière vous — et une descente à travers la forêt de genévriers jusqu'au village de Tizi Oussem à 1 850 m. Cinq à six heures de marche. Le deuxième jour franchit le Tizi Oudid et descend vers Aguersioual, soit environ 12 km et cinq heures, puis le retour en voiture.",
      "Le niveau est modéré, et cette classification a ici un vrai sens. Pas de sommet, pas d'éboulis, et rien au-dessus d'environ 2 700 m : l'altitude ne devient donc jamais le problème qu'elle représente sur le Toubkal. Ce qu'il faut, c'est pouvoir marcher cinq à six heures sur des sentiers de montagne deux jours de suite. Les personnes qui randonnent régulièrement trouvent cela confortable ; les autres y voient un effort réel mais gérable.",
      "La nuit se passe dans une maison d'hôtes familiale à Tizi Oussem, et non dans un refuge ou sous une tente. Cela compte plus qu'il n'y paraît : un refuge, c'est un dortoir rempli de gens qui font la même ascension, tandis qu'une maison d'hôtes de village, c'est le foyer de quelqu'un, avec un dîner préparé par la famille et une vallée qui devient silencieuse à la nuit tombée. C'est ce dont les voyageurs nous reparlent ensuite.",
      "Par personne : 285 € seul, 161 € à deux, 142 € à trois, 133 € à quatre, 124 € à cinq et 116 € à six. Cela comprend le guide de montagne diplômé, la nuit en maison d'hôtes, tous les repas du trek, un mulet pour les bagages du groupe et le transfert aller-retour depuis Marrakech. Vous ne portez qu'un sac de journée. L'assurance voyage est ici recommandée plutôt qu'obligatoire, l'équipement personnel est à votre charge, et les pourboires du guide et du muletier sont à part.",
      "Si vous hésitez entre ce trek et une ascension du Toubkal, la question est de savoir ce que vous attendez de la montagne. Le Toubkal, c'est un sommet et une journée en altitude. L'Azzaden, ce sont des villages, des cultures en terrasses et des noyeraies, parcourus à un rythme qui vous laisse le temps de regarder autour de vous. Groupe privé de 2 à 12 personnes, le rythme est donc le vôtre.",
    ],
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trek de 2 jours dans la vallée d'Azzaden",
  ...
  },
  {
    ...
    brief: [
      "Trois jours de marche de vallée en vallée, sans aucun sommet au programme. Depuis Imlil, vous passez dans l'Azzaden le premier jour (4 à 5 heures), montez environ 800 m par les hauts pâturages jusqu'à Tacheddirt à 2 300 m le deuxième jour (6 heures), puis descendez le bassin de l'Ourika jusqu'à la route le troisième jour (5 heures) avant le retour à Marrakech. Chaque nuit se passe dans une maison d'hôtes de village différente : vous traversez donc un pays habité au lieu de revenir à un camp de base.",
      "L'absence de sommet est un choix, pas un compromis. Rien sur cet itinéraire ne dépasse environ 2 700 m, ce qui écarte complètement la question de l'altitude, et il n'y a ni éboulis ni départ avant l'aube. Reste une marche modérée et régulière, avec le temps et l'énergie de remarquer où vous êtes — les cultures en terrasses, les azibs de pâturage, les bergers, le changement de caractère d'une vallée à l'autre.",
      "Cela en fait un excellent premier trek de plusieurs jours. Les personnes qui marchent occasionnellement chez elles enchaînent ici trois jours sans que le voyage ne devienne une épreuve d'endurance, et comme les maisons d'hôtes sont dans des villages plutôt que sur un circuit de trekking, les soirées sont calmes et locales au lieu d'être partagées avec quarante autres marcheurs visant le même sommet.",
      "Par personne : 416 € seul, 235 € à deux, 206 € à trois, 192 € à quatre, 181 € à cinq et 169 € à six. Sont inclus le guide de montagne diplômé, les deux nuits en maison d'hôtes, tous les repas du trek, un mulet portant les bagages du groupe et le transfert aller-retour depuis Marrakech. Vous marchez avec un sac de journée. L'assurance voyage est recommandée, l'équipement personnel est à votre charge, et les pourboires du guide et du muletier sont à part.",
      "Disons-le clairement : si votre objectif est de vous tenir au sommet du Toubkal, ce n'est pas ce trek et il ne le remplacera pas. Si votre objectif est le Haut Atlas lui-même — les villages, les cols, trois jours de marche sans montre — ce circuit couvre plus de terrain et plus de variété que n'importe quel itinéraire vers un sommet. Groupe privé de 2 à 12 personnes.",
    ],
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trek de 3 jours dans l'Atlas",
  ...
  },
  {
    ...
    brief: [
      "Le trek avec des enfants fonctionne quand les journées sont courtes et qu'il y a quelque chose à regarder, et cet itinéraire est bâti selon cette règle plutôt qu'adapté après coup. Le premier jour : 1h30 de route jusqu'à Imlil et 2 à 3 heures de marche jusqu'au premier village. Le deuxième : 4 heures autour des cascades de la vallée. Le troisième : passage vers le versant de l'Ourika en 4 à 5 heures. Le quatrième : 3 heures de descente et le retour en voiture. Des demi-journées, pas des marches forcées.",
      "Le terrain est volontairement facile — le bas Imlil et l'Ourika, des passages de rivière, des noyeraies et des cascades au lieu de cols élevés. Les mulets portent tous les bagages, et ils peuvent aussi porter un enfant fatigué : c'est le détail qui transforme un après-midi difficile en non-événement. Personne ne porte de sac et personne n'est pressé.",
      "Les nuits se passent en maisons d'hôtes de village chez des familles berbères pendant trois nuits, tous les repas compris. La cuisson du pain et le thé à la menthe font partie des soirées plutôt que d'une démonstration mise en scène, et pour la plupart des familles, c'est ce dont les enfants se souviennent plutôt que de la marche.",
      "Ce circuit impose un minimum de trois personnes, la grille commence donc là : 276 € par personne à trois, 257 € à quatre, 241 € à cinq et 225 € à six, jusqu'à un groupe de quatorze. Sont inclus un guide de montagne diplômé habitué aux familles, les trois nuits en maison d'hôtes, tous les repas, les mulets et le transfert aller-retour depuis Marrakech. L'assurance voyage est recommandée, l'équipement de randonnée personnel est à votre charge, et les pourboires du guide et des muletiers sont à part.",
      "Sur l'âge : la contrainte est de marcher quelques heures sur terrain irrégulier, non la distance ou l'altitude. Les enfants en âge scolaire s'en sortent donc généralement bien, et les plus jeunes suivent grâce aux mulets. Si vous voulez une réponse ferme pour votre famille, indiquez-nous les âges lors de votre demande et nous vous dirons franchement si cela convient plutôt que de vous vendre le circuit.",
    ],
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trek en famille dans l'Atlas 4 jours",
  ...
  },
  {
    ...
    brief: [
      "C'est le circuit classique Marrakech–Erg Chebbi, avec les trajets restructurés pour fonctionner avec des enfants. L'itinéraire est celui que tout le monde emprunte : par l'Atlas jusqu'à Aït Ben Haddou et le Dadès le premier jour, à travers les gorges du Dadès et du Todra jusqu'aux dunes le deuxième, retour par Ouarzazate les troisième et quatrième jours. Ce qui change, c'est la forme des journées — environ 5 heures de route le premier jour, puis 4, 4 et 4, découpées en étapes plus courtes avec de vraies pauses plutôt qu'en deux longues traversées.",
      "La chose la plus utile à savoir, c'est que le désert est réellement loin de Marrakech. L'Erg Chebbi se trouve à environ 560 km dans chaque sens et aucun itinéraire ne peut raccourcir cette distance. Quatre jours, c'est ce qui rend le voyage confortable : trois nuits, trois lits différents, et une nuit dans les dunes qui n'est pas encadrée par deux trajets de huit heures. Les versions en 2 jours parcourent la même distance en deux fois moins de temps, et c'est précisément ce qui rend les enfants malheureux.",
      "Les nuits se passent dans un hôtel du Dadès avec dîner et petit-déjeuner, au campement familial de l'Erg Chebbi avec dîner et petit-déjeuner, et dans un hôtel à Ouarzazate avec petit-déjeuner. Le campement est conçu pour les familles et non géré comme un bivouac spartiate — balades à dos de dromadaire au coucher et au lever du soleil, descente des dunes en surf des sables, et de la place pour que les enfants soient des enfants. Aït Ben Haddou à l'aller est le ksar de Game of Thrones et de Gladiator, ce qui plaît généralement aux plus grands.",
      "La grille commence à deux personnes, car ce circuit n'est pas vendu en solo : 526 € par personne à deux, 399 € à trois, 346 € à quatre, 314 € à cinq, 270 € à six, 252 € à sept, 245 € à dix et 229 € à quatorze. Sont inclus le véhicule climatisé sur tout le trajet, un chauffeur-guide bilingue anglais/français, les trois nuits décrites, les deux balades à dromadaire ainsi que tous les transferts et droits d'accès.",
      "Les déjeuners ne sont pas inclus — comptez environ 12 à 15 € par repas — et le billet des studios de cinéma de l'Atlas est optionnel, autour de 7 €. L'assurance voyage et les pourboires sont à part. Le groupe compte de 2 à 12 personnes et le circuit est privé, ce qui, en vacances en famille, signifie surtout que vous pouvez vous arrêter quand quelqu'un en a besoin.",
    ],
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Circuit désert en famille 4 jours",
    seoDescription: "Circuit désert en famille, 4 jours de Marrakech aux dunes de l'Erg Chebbi : dromadaires, sandboard, kasbah de cinéma et campement familial. Dès 607 $.",
    faq: [
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Circuit 5 jours Sommet du Toubkal & Sahara",
    seoDescription:
      "Combinez les deux aventures phares du Maroc : gravir le Jbel Toubkal (4 167 m) puis rejoindre les dunes sahariennes de l'Erg Chebbi.",
    faq: [
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    featured: false,
    seoTitle: "Trek chamelier de 8 jours à Chegaga",
    seoDescription:
      "Marchez dans le Sahara avec une caravane : six jours à pied de la vallée du Draa aux dunes de l’erg Chegaga et à M’hamid. Camps mobiles, guide berbère.",
    faq: [
  ...
  },
  {
    ...
    includes: [
      ...
      "Dîner et petit-déjeuner les deux nuits",
      "Randonnée à dos de chameau au coucher du soleil",
      "Chauffeur anglophone ou francophone",
    ],
    excludes: ["Déjeuners", "Boissons", "Pourboires", "Droits d'entrée"],
    itinerary: [
      {
        day: 1,
        driving: "≈7 h",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Désert de Merzouga circuit partagé — €120",
    seoDescription: "Départ quotidien partagé de Marrakech vers les dunes de l'Erg Chebbi : Aït Ben Haddou, gorges du Dadès et du Todra.",
    featured: false,
  },
  {
    id: "45",
    ...
    brief: [
      "Zagora est la nuit dans le désert la plus proche de Marrakech, et c'est toute la raison de la choisir. L'itinéraire franchit le col du Tizi n'Tichka, passe par Aït Ben Haddou et Ouarzazate, rejoint les palmeraies de la vallée du Draa, puis une balade à dromadaire mène aux dunes pour le dîner, les tambours et une nuit au campement. Le deuxième jour emprunte le même chemin en sens inverse. Environ 360 km et quelque 8 heures dans chaque sens.",
      "Soyez honnête avec vous-même au sujet des dunes avant de réserver. Celles de Zagora sont petites — rien à voir avec les murs de 150 mètres de l'Erg Chebbi — car Zagora est une ville du désert avec du sable plutôt qu'un grand erg. C'est le compromis que vous acceptez pour un voyage qui tient en deux jours au lieu de trois ou quatre. Ceux qui y vont en s'attendant à Lawrence d'Arabie sont déçus ; ceux qui savent qu'il s'agit de la version courte l'apprécient.",
      "À 85 € par personne, c'est la nuit dans le désert la moins chère que nous proposons, et le prix est fixe plutôt que dégressif, car il s'agit d'un départ partagé vendu à la place. Vous voyagez en minibus climatisé avec jusqu'à seize autres personnes et un chauffeur anglophone ou francophone. L'acompte est de 19 €. Inclus : le transport, la nuit au campement, le dîner et le petit-déjeuner, ainsi que la balade à dromadaire.",
      "Non inclus : les déjeuners, les boissons, les pourboires et les droits d'entrée — Aït Ben Haddou en particulier est payant sur place. Prévoyez ces frais séparément pour que la journée ne vous réserve pas de surprise.",
      "Si vous disposez de trois ou quatre jours, Merzouga et l'Erg Chebbi offrent un meilleur désert. Si vous n'avez que deux jours, ou si vous préférez consacrer la différence à une autre étape du Maroc, ce circuit fait honnêtement le travail : une vraie nuit sous la toile dans le Sud, à un prix qui préserve le reste de votre voyage.",
    ],
    ...
    highlights: [
      ...
      "Palmeraies de la vallée du Draa",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Désert de Zagora 2 jours partagé — €85",
    seoDescription: "Départ quotidien partagé vers les dunes de Zagora : Tizi n'Tichka, Aït Ben Haddou, vallée du Draâ, balade à dos de dromadaire et nuit en campement berbère.",
    featured: false,
  },
  {
    id: "46",
    ...
    excludes: ["Déjeuner", "Billet pour le tour en barque", "Pourboires"],
    itinerary: [
      {
        day: 1,
        walking: "2–3 h",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Cascades d'Ouzoud excursion partagée — €40",
    seoDescription: "Départ quotidien partagé vers les cascades d'Ouzoud : chutes de 110 m, magots en liberté, marche dans les gorges et tour en barque.",
    featured: false,
  },
  {
    id: "47",
    ...
    excludes: ["Boissons autres que l'eau et le thé", "Pourboires", "Quad et autres suppléments"],
    itinerary: [
      {
        day: 1,
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Agafay : dîner et chameau — €30",
    seoDescription: "Soirée dans le désert de pierre d'Agafay : balade à dos de dromadaire au coucher du soleil, dîner trois services, musique live et spectacle de feu.",
    featured: false,
  },
  {
    id: "48",
    ...
    excludes: ["Déjeuner", "Guide dans la médina", "Pourboires"],
    itinerary: [
      {
        day: 1,
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — votre hôtel ou riad" },
    seoTitle: "Essaouira excursion partagée — €30",
    seoDescription: "Départ quotidien partagé vers Essaouira : médina classée à l'UNESCO, remparts du XVIIIe siècle, port de pêche bleu et coopérative d'argan en chemin.",
    featured: false,
  },
  {
    id: "50",
  ...
  },
  {
    ...
    itinerary: [
      { day: 1, driving: "≈6 h", distance: "≈370 km", stay: "Riad dans la médina de Fès", meals: "—",
        ...
        stop: { name: "Fès", lat: 34.034653, lng: -5.016193 } },
