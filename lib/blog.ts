...
`,
  },
  {
    ...
    seoDescription:
      "What the three-summit Toubkal trek costs in 2026: guide premium, two refuge nights, mule and park fees itemised, plus how it compares with a package from €302.",
    faq: [
