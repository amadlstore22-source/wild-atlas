...
export const TOURS: Tour[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    localizedSlug: "toubkal-gipfel-trek-4-tage",
    ...
    includes: [
      "Professioneller staatlich geprüfter Bergführer",
      "3 Nächte in Berghütten",
    ...
    seoTitle: "Toubkal-Gipfeltrek 4 Tage",
    seoDescription: "Bezwingen Sie den Jbel Toubkal (4.167 m) mit einem lizenzierten Berberführer. 4-tägiger Gipfeltrek ab Marrakesch — inklusive Refugien.",
    featured: true,
  },
  {
    id: "2",
    slug: "sahara-3day-marrakech",
    localizedSlug: "wuestentour-3-tage-marrakesch",
    ...
    description:
      "Drei Tage von Marrakesch in die Sahara und zurück — als Rundreise, nicht auf derselben Strecke hin und zurück. Überqueren Sie den Hohen Atlas über den Tizi n'Tichka, halten Sie an der UNESCO-Ksar Aït Ben Haddou, übernachten Sie in der Dades-Schlucht, durchwandern Sie den Todra-Canyon und reiten Sie auf Kamelen in den Erg Chebbi, während die Sonne in den Dünen versinkt. Die Rückfahrt führt westwärts über Alnif und Tazarine — Fossilienland, weit ruhiger als die Hinstrecke.",
    highlights: [
      ...
      "Dades-Schlucht und Todra-Canyon auf der Hinfahrt",
      "Andere Rückfahrt über Alnif und Tazarine — keine Wiederholung der Strecke",
    ],
    includes: [
      "Private 4x4-Fahrt auf der gesamten Strecke",
      "Kamelritt bei Sonnenuntergang",
      "1 Nacht im Wüstencamp (Abendessen und Frühstück)",
    ...
    itinerary: [
      ...
      },
      {
        ...
        title: "Dades → Todra-Schlucht → Erfoud → Erg Chebbi",
        description:
          "Vormittag in der Todra-Schlucht, wo sich die Felswände auf 10 m verengen und 300 m aufragen. Weiterfahrt über Erfoud nach Merzouga, Ankunft am frühen Nachmittag. Kamelritt in die Dünen des Erg Chebbi bei Sonnenuntergang, danach Abendessen und Gnawa-Trommeln im Camp.",
      },
      {
        day: 3,
        meals: "B",
        driving: "≈9 Std.",
        distance: "≈560 km",
        stop: { name: "Marrakesch", lat: 31.6295, lng: -7.9811 },
        title: "Erg Chebbi → Alnif → Tazarine → Ouarzazate → Marrakesch",
        description:
          "Sonnenaufgang über den Dünen und Kamelritt zurück zum Frühstück. Fahrt nach Westen auf der Wüstenstraße über Alnif und Tazarine — Fossilienland, weit ruhiger als die Hauptroute — dann Ouarzazate und zurück über den Tizi n'Tichka. Ankunft in Marrakesch am Abend.",
      },
    ],
    faq: [
      ...
      { q: "Wie ist die Nacht im Wüstencamp?", a: "Betten mit Decken im Zelt, gemeinsames Abendessen und vollkommene Stille, sobald das Camp zur Ruhe kommt. Die Dünen sind wirklich dunkel, weshalb sich die meisten eher an den Sternenhimmel als an den Kamelritt erinnern. Bringen Sie eine warme Schicht mit — außerhalb des Sommers wird es nachts kalt." },
      ...
      { q: "Wie viele Stunden Fahrt sind es pro Tag?", a: "Der erste Tag ist der längste: rund sechs bis sieben Stunden ab Marrakesch über den Tizi-n'Tichka-Pass auf 2.260 m, unterbrochen von Stopps in Aït Ben Haddou und zum Mittagessen. Tag zwei ist ruhiger, etwa vier bis fünf Stunden durch die Schluchtenlandschaft nach Merzouga. Tag drei ist die Rückfahrt und die längste zusammenhängende Etappe — wir nehmen die westliche Route über Alnif und Tazarine, die ruhiger ist als der Hinweg." },
      { q: "Wie sind die Sanitäranlagen und Duschen im Camp?", a: "Die festen Camps, die wir nutzen, haben Sanitärzelte mit fließendem Wasser und einer richtigen Dusche — privat oder gemeinschaftlich je nach Camp. Der Wasserdruck mitten im Erg ist bescheiden, aber es ist eine echte heiße Dusche und kein Eimer. Wenn Ihnen ein Zelt mit eigenem Bad wichtig ist, sagen Sie es bei der Buchung, und wir kalkulieren ein Camp, das solche hat." },
      { q: "Kann ich mein Handy in der Wüste laden?", a: "Ja. Das Camp hat Strom, Handys und Kamera-Akkus lassen sich also laden, und es gibt WLAN — mitten in den Dünen langsam, aber ausreichend für Nachrichten und Fotos." },
      { q: "Was passiert mit meinem großen Gepäck?", a: "Es bleibt im 4x4. Auf dem Kamelabschnitt zum Camp tragen Sie nur einen kleinen Tagesrucksack — packen Sie eine warme Schicht, eine Lampe und alles hinein, was Sie vor dem Morgen brauchen. Das Fahrzeug bleibt durchgehend bei unserem Fahrer." },
      { q: "Wie kalt wird es nachts?", a: "Kälter, als die meisten erwarten. Im Frühjahr und Herbst liegen die Nächte in den Dünen bei etwa 12–18 °C, im Dezember und Januar können sie an den Gefrierpunkt gehen. Das Camp stellt Decken, aber packen Sie eine warme Schicht für den Abend ein — die Temperatur fällt schnell, sobald die Sonne weg ist." },
      { q: "Ist das für Kinder geeignet?", a: "Ja, Familien buchen die Tour regelmäßig. Der Kamelritt ist kurz und freiwillig, es wird kaum gelaufen, und die Route ist als leicht eingestuft. Die eigentliche Überlegung bei kleinen Kindern sind die langen Fahrtage, nicht die Wüste selbst." },
    ],
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "3-tägige Sahara-Wüstentour ab Marrakesch",
    seoDescription: "Kameltrekking bei Sonnenuntergang in den Erg Chebbi und Übernachtung unter den Sternen. 3-tägige Tour von Marrakesch in die Sahara mit Aït Ben Haddou.",
    featured: true,
  },
  {
    id: "3",
    slug: "ourika-valley-day-hike",
    localizedSlug: "wanderung-ourika-tal",
    ...
    includes: [
      ...
      "Hin- und Rückfahrt ab Marrakesch",
      "Traditionelles Berber-Mittagessen",
      "Mineralwasser während der gesamten Tour",
    ],
    excludes: ["Persönliche Wanderausrüstung", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    faq: [
      ...
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 15 Personen, und die Tour ist privat — die Gruppe ist Ihre eigene, Sie wandern also nur mit den Personen, mit denen Sie gebucht haben. Der Preis pro Person sinkt, je größer die Gruppe wird." },
    ],
    meetingPoint: { lat: 31.3489, lng: -7.7411, name: "Ourika Valley, High Atlas" },
    seoTitle: "Ourika-Tal Tageswanderung ab Marrakesch",
    seoDescription: "Wandern Sie zu den Wasserfällen von Setti Fatma durch Berberdörfer und Gebirgsbäche, nur 45 Minuten von Marrakesch.",
    featured: true,
  },
  {
    id: "4",
    slug: "ouzoud-waterfalls-day-trip",
    localizedSlug: "ausflug-ouzoud-wasserfaelle",
    ...
    excludes: ["Mittagessen", "Trinkgelder", "Persönliche Einkäufe"],
    itinerary: [
      {
        day: 1,
        walking: "2–3 h",
    ...
    faq: [
      ...
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 15 Personen, und die Tour ist privat — die Gruppe ist Ihre eigene, Sie reisen also nur mit den Personen, mit denen Sie gebucht haben. Der Preis pro Person sinkt, je größer die Gruppe wird." },
    ...
    seoTitle: "Ouzoud-Wasserfälle Tagesausflug",
    seoDescription: "Besuchen Sie Marokkos höchsten Wasserfall — 110 Meter stürzendes Wasser, wilde Berberaffen und eine Bootsfahrt durch die Schlucht.",
    featured: false,
  },
  {
    id: "5",
    slug: "agafay-desert-sunset",
    localizedSlug: "sonnenuntergang-agafay-wueste",
    ...
    excludes: ["Alkoholische Getränke", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        meals: "D",
    ...
    seoTitle: "Agafay-Wüste Sonnenuntergangstour",
    seoDescription: "Erleben Sie die Sahara in 30 Minuten — Quad-Biking, Kamelritt bei Sonnenuntergang und ein traditionelles Berber-Dinner in der Steinwüste Agafay bei Marrakesch.",
    featured: false,
  },
  {
    id: "6",
    slug: "marrakech-medina-cultural-tour",
    localizedSlug: "kulturtour-medina-marrakesch",
    ...
    includes: [
      "Privater Guide auf Englisch, Französisch, Spanisch und Arabisch",
      "Eintrittsgelder für die Sehenswürdigkeiten",
      "Traditionelle Minztee-Zeremonie",
      "Vierstündige geführte Wanderung",
    ],
    excludes: ["Mittagessen", "Einkäufe und Souvenirs", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        walking: "4 h (on foot)",
    ...
    seoTitle: "Kulturelle Stadtführung Medina Marrakesch",
    seoDescription: "Entdecken Sie die UNESCO-Medina von Marrakesch mit einem lokalen Guide — Ledergerbereien, Ben-Youssef-Medersa, Djemaa el-Fna und versteckte Riad-Gärten.",
    featured: false,
  },
  {
    id: "7",
    slug: "marrakech-to-fes-3day",
    localizedSlug: "marrakesch-fes-3-tage",
    ...
    excludes: ["Mittag- und Abendessen", "Trinkgelder", "Rücktransport ab Fès"],
    itinerary: [
      {
        day: 1,
        meals: "D",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "3-Tage-Tour Marrakesch nach Fès",
    seoDescription: "Fahrt von Marrakesch nach Fès über den Tizi n'Tichka, Aït Ben Haddou und die Zedernwälder des Mittleren Atlas. 3-tägige private 4x4-Tour mit Riad-Unterkunft.",
    featured: false,
  },
  {
    id: "8",
    slug: "mgoun-massif-trek",
    localizedSlug: "mgoun-massiv-trek-7-tage",
    brief: [
      "Sieben Tage quer durch das Mgoun-Massiv — jenen Teil des Hohen Atlas, den der Trekkingverkehr nie erreicht. Tag eins bringt 5 Stunden Fahrt nach Aït M'hamed und eine Nacht bei einer Berberfamilie. Tag zwei führt durch das Aït Bouguemez — das „glückliche Tal“ — zum Lager in Agouti auf 2.600 m. Tag drei überquert den ersten hohen Pass, den Tizi n'Ait Imi auf 3.650 m, mit 1.050 Höhenmetern Aufstieg. Tag vier beginnt vor Sonnenaufgang mit dem 4.068 m hohen Gipfel des Jbel Mgoun, Marokkos zweithöchstem Berg, und führt danach hinunter in die Tessaoute-Schlucht.",
      "Tag fünf und sechs sind der Grund, warum erfahrene Trekker diese Route einem Toubkal-Weg vorziehen. Tag fünf durchquert die rotwandige Tessaoute-Schlucht mit Badegelegenheit im Fluss; Tag sechs verlässt die Schlucht Richtung Bou Tharar und endet mit einer Nacht bei einer Dorffamilie. Tag sieben führt durch das Rosental zurück nach Marrakesch, Ankunft gegen 16 Uhr. Vier Nächte im Zeltlager, zwei bei Familien.",
      "Die Einstufung lautet Experte, und sie bezieht sich auf die Summe, nicht auf die Technik. Kein einzelner Tag verlangt alpinistisches Können. Aber es sind sieben aufeinanderfolgende Tage in der Höhe, in einer Gegend mit wenigen Ausstiegspunkten, und das Maultierteam trägt das Lager, weil es nirgends Nachschub gibt. Wer den Toubkal problemlos bewältigt hat und den nächsten Schritt sucht, findet hier tatsächlich den nächsten Schritt.",
      "Pro Person: 1.350 € allein, 760 € zu zweit, 710 € zu dritt, 680 € zu viert, 625 € zu fünft und 596 € ab sechs, in einer auf acht Personen begrenzten Gruppe. Enthalten sind ein staatlich geprüfter Hochgebirgsführer, alle Mahlzeiten über sieben Tage, das Maultierteam, die Lager und Übernachtungen bei Familien, die Nationalparkgebühren und — bei einem so abgelegenen Trek erwähnenswert — Satellitenkommunikation für den Notfall.",
      "Reise- und Krankenversicherung ist hier verpflichtend statt empfohlen, und das ist wörtlich zu nehmen: An den Tagen drei bis sechs sind Sie weit von jeder Straße entfernt. Technische Bergsteigerausrüstung und Trinkgelder sind nicht enthalten. Wenn Sie diese Tour mit dem Toubkal vergleichen, lautet die ehrliche Unterscheidung: Der Toubkal ist ein Gipfel, der in einen Urlaub passt, und der Mgoun ist eine Expedition, die zum Urlaub wird.",
    ],
    ...
    includes: [
      "Erfahrener staatlich geprüfter Hochgebirgsführer",
      "Alle Mahlzeiten während der Tour",
      "Maultiere für den Gepäcktransport",
      "Übernachtung bei Berberfamilien und Zelten",
    ...
    seoTitle: "Mgoun-Massiv-Trek 7 Tage",
    seoDescription: "7-tägiger Expertentrek durch das abgelegene Mgoun-Massiv — Besteigung des Jbel Mgoun (4.068 m), Hochpässe und Übernachtungen bei Berberfamilien.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    localizedSlug: "paradise-valley-agadir-tagestour",
    ...
    includes: [
      "Hin- und Rückfahrt ab Agadir",
      "Staatlich geprüfter lokaler Guide",
      "Traditionelles Berber-Mittagessen",
      "Mineralwasser",
    ],
    excludes: ["Persönliche Badesachen", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    seoTitle: "Paradise Valley Tagesausflug ab Agadir",
    seoDescription: "Versteckte Palmenschlucht mit natürlichen Schwimmbecken, 35 km von Agadir entfernt. Geführte Wanderung durch Canyon-Landschaft.",
    featured: true,
  },
  {
    id: "10",
    slug: "sous-massa-national-park",
    localizedSlug: "nationalpark-souss-massa",
    ...
    faq: [
      ...
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 12 Personen, und die Tour ist privat – die Gruppe ist Ihre eigene. Die kleine Gruppengröße ist Absicht: Der Naturführer kann allen Vögel und Wildtiere zeigen." },
    ],
    meetingPoint: { lat: 30.0559, lng: -9.6320, name: "Souss-Massa National Park, Massa" },
    seoTitle: "Souss-Massa-Nationalpark Wildtiertour",
    seoDescription: "Beobachten Sie den vom Aussterben bedrohten Waldrapp und Flamingos in Marokkos wichtigstem Naturschutzgebiet. Fachkundiger Naturführer.",
    featured: true,
  },
  {
    id: "11",
    slug: "taroudant-day-trip-agadir",
    localizedSlug: "ausflug-taroudant-agadir",
    ...
    excludes: ["Mittagessen", "Einkäufe", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        walking: "2–3 h",
    ...
    faq: [
      ...
      { q: "Wie groß ist die Gruppe?", a: "Zwischen 2 und 14 Personen, und die Tour ist privat — die Gruppe ist Ihre eigene, Sie reisen also nur mit den Personen, mit denen Sie gebucht haben. Der Preis pro Person sinkt, je größer die Gruppe wird." },
    ],
    meetingPoint: { lat: 30.4702, lng: -8.8773, name: "Taroudant, Souss Valley" },
    seoTitle: "Taroudant Tagesausflug ab Agadir",
    seoDescription: "Entdecken Sie Marokkos besterhaltene Stadtmauern aus dem 16. Jahrhundert und authentische Berbermärkte in Taroudant — 80 km von Agadir.",
    featured: false,
  },
  {
    id: "12",
    slug: "agadir-surf-lesson",
    localizedSlug: "surfkurs-agadir",
    ...
    includes: [
      "2-stündige Surfstunde",
      "Leihgebühr für Surfbrett und Neoprenanzug",
      "ISA-zertifizierter Surflehrer",
      "Aufwärmen und Sicherheitseinweisung",
    ],
    excludes: ["Transport zum Strand (5 Gehminuten vom Zentrum)", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        walking: "2 h session",
    ...
    seoTitle: "Surfkurs Agadir",
    seoDescription: "Lernen Sie in der Bucht von Agadir auf warmen Atlantikwellen surfen, mit einem zertifizierten ISA-Lehrer. Board.",
    featured: false,
  },
  {
    id: "13",
    slug: "anti-atlas-trekking-agadir",
    localizedSlug: "anti-atlas-trekking-agadir",
    ...
    includes: [
      ...
      "2 Nächte in einem Berber-Gästehaus",
      "Alle Mahlzeiten",
      "Hin- und Rückfahrt ab Agadir",
      "Maultier für den Gepäcktransport",
    ],
    excludes: ["Reiseversicherung (empfohlen)", "Persönliche Wanderausrüstung", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        meals: "L,D",
    ...
    seoTitle: "Anti-Atlas-Trek 3 Tage ab Agadir",
    seoDescription: "3-tägiger Trek durch Marokkos meist unterschätztes Gebirge — rosafarbene Granitgipfel, Mandelblüten-Schluchten und abgelegene Berberdörfer.",
    featured: true,
  },
  {
    id: "14",
    slug: "sahara-2day-agadir",
    localizedSlug: "wuestentour-2-tage-agadir",
    brief: [
      "Fast jede Sahara-Reise in Marokko startet in Marrakesch. Diese startet in Agadir und nimmt die Südroute über Tata und Foum Zguid zum Erg Chegaga, der eine wirklich andere Wüste ist als die von den Postkarten. Chegaga ist das größte und abgelegenste Dünenfeld des Landes, erreicht im 4x4 über offenes Gelände statt im Reisebus zu einem Camp an der Straße.",
      "Seien Sie ehrlich zu sich selbst, was die Fahrt angeht, denn sie ist das prägende Merkmal: rund 8 Stunden und 450 km in jede Richtung, an beiden Tagen. Das ist viel Fahrzeit für eine Zweitagesreise, und es ist der Preis dafür, Chegaga überhaupt von der Küste aus zu erreichen. Dafür bekommen Sie ein Dünenfeld, in dem Sie den Sonnenuntergang nicht mit fünfzig anderen teilen. Wenn eher die langen Fahrten das Problem sind als die Entfernung, passt die 4-Tages-Variante ab Marrakesch besser.",
      "Tag eins führt von Agadir über Tata und Foum Zguid in die Dünen, mit Ankunft zum Kamelritt bei Sonnenuntergang und Abendessen im Camp. Tag zwei bringt den Sonnenaufgang über dem Erg und dann die Rückfahrt durch die Palmerie des Draa-Tals und an seinen Kasbahs vorbei. Eine Nacht unter Zeltplane, und das Camp liegt weit genug von jeder Stadt entfernt, dass die Milchstraße ohne Mühe sichtbar ist.",
      "Pro Person: 790 € allein, 400 € zu zweit, 340 € zu dritt, 310 € zu viert und 280 € ab fünf. Enthalten sind der 4x4-Transport auf der gesamten Strecke, ein erfahrener Wüstenguide, die Camp-Nacht im privaten Schlafzelt mit Abendessen und Frühstück sowie alle Kamelritte. Ein Zelt mit eigenem Bad ist verfügbar, falls Sie keine Gemeinschaftssanitäranlagen nutzen möchten — danach fragt man besser bei der Buchung als bei der Ankunft.",
      "Das Mittagessen am ersten Tag ist nicht enthalten, ebenso wenig persönliche Ausgaben und Trinkgelder. Die Gruppengröße liegt bei 2 bis 10 Personen und die Reise ist privat. Die Einstufung lautet leicht: Es wird praktisch nicht gewandert, und die einzige echte Anforderung ist die Bereitschaft zu einem langen Fahrtag auf einer Strecke, die die meisten Marokko-Besucher nie zu sehen bekommen.",
    ],
    ...
    highlights: [
      ...
      "Berber-Wüstencamp unter der Milchstraße — Zelt mit eigenem Bad optional",
      "Südroute über Tata und Foum Zguid",
    ],
    includes: [
      "4x4-Transport während der gesamten Tour",
      "Erfahrener Wüstenführer",
      "1 Nacht im Wüstencamp, eigenes Schlafzelt (Abendessen und Frühstück)",
      "Alle Kamelritte",
    ],
    excludes: ["Mittagessen an Tag 1", "Persönliche Ausgaben und Trinkgelder"],
    itinerary: [
      {
        day: 1,
        meals: "D",
    ...
    faq: [
      ...
      { q: "Wie ist das Camp?", a: "Ein festes Camp in den Chegaga-Dünen für eine Nacht, mit Abendessen und Frühstück. Im Standardpreis enthalten ist ein eigenes Schlafzelt mit einem gemeinsamen Waschblock wenige Schritte entfernt. Ein Zelt mit eigenem Bad (Dusche und WC im Zelt) gibt es für +30 € pro Person — die Tour hat nur eine Wüstennacht, der Aufpreis fällt also einmal an. Der Sternenhimmel und die Stille bleiben den meisten in Erinnerung." },
      { q: "Was ist inbegriffen?", a: "4x4-Transport durchgehend, ein erfahrener Wüstenführer, eine Nacht im Camp im eigenen Schlafzelt mit Abendessen und Frühstück sowie alle Kamelritte. Die Waschgelegenheiten sind im Standardpreis ein Gemeinschaftsblock; ein Zelt mit eigenem Bad kostet +30 € pro Person. Das Mittagessen an Tag 1, persönliche Dinge und Trinkgelder sind nicht enthalten." },
      { q: "Ist es anstrengend?", a: "Leicht. Die Strecke wird im 4x4 zurückgelegt und die Kamelritte sind kurz und optional." },
    ],
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — Ihr Hotel oder Riad" },
    seoTitle: "2-tägige Sahara-Tour ab Agadir",
    seoDescription: "Die abgelegenen Dünen von Erg Chegaga über die südliche Draa-Tal-Route — Kameltrekking, Berber-Wüstencamp und Sonnenaufgang über der Sahara.",
    featured: true,
  },
  {
    id: "15",
    slug: "souss-valley-cultural-tour",
    localizedSlug: "kulturtour-souss-tal",
    ...
    includes: [
      "Hin- und Rückfahrt ab Agadir",
      "Zweisprachiger Guide (Englisch/Französisch)",
      "Eintritt und Verkostung in einer Arganöl-Kooperative",
      "Traditionelles Berber-Mittagessen",
      "Honigverkostung",
    ],
    excludes: ["Käufe von Arganprodukten", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    seoTitle: "Souss-Tal Argan- & Kulturtagesausflug",
    seoDescription: "Besuchen Sie eine von Frauen geführte Arganöl-Kooperative, ein Honigdorf und genießen Sie ein Berber-Familienessen im Souss-Tal — Marokkos Arganöl-Herzland.",
    featured: false,
  },
  {
    id: "16",
    ...
    includes: [
      ...
      "Zweistündiger geführter Rundgang durch die Medina",
    ],
    excludes: ["Mittagessen und persönliche Einkäufe", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        walking: "2–3 h",
    ...
    seoTitle: "Essaouira Tagesausflug ab Agadir",
    seoDescription: "Tagesausflug von Agadir nach Essaouiras blau-weißer UNESCO-Medina — portugiesische Stadtmauern aus dem 18. Jahrhundert.",
    featured: false,
  },
  {
    id: "17",
    slug: "marrakech-to-chefchaouen-4day",
    localizedSlug: "marrakesch-chefchaouen-4-tage",
    ...
    seoDescription: "4-tägige Tour von Marrakesch zu den blau getünchten Gassen Chefchaouens über Fès, die römischen Ruinen von Volubilis und Meknès.",
    featured: false,
  },
  {
    id: "18",
    slug: "marrakech-imperial-cities-5day",
    localizedSlug: "koenigsstaedte-marrakesch-5-tage",
    ...
    includes: [
      "Private 4x4-Fahrt auf der gesamten Strecke",
      "Englisch-, französisch- und spanischsprachiger Guide",
      "4 Nächte in einem Riad",
      "Täglich Frühstück",
      "Alle Transfers, Mautgebühren und Eintrittsgelder",
    ],
    excludes: ["Mittag- und Abendessen", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        meals: "D",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "Alle 4 Kaiserstädte Marokkos 5-Tage-Tour",
    seoDescription: "Grand Tour durch Marokkos vier Kaiserstädte in 5 Tagen. Römische Ruinen von Volubilis, Chouara-Gerbereien, Bab Mansour und der Hassan-Turm.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    localizedSlug: "zagora-tour-2-tage-marrakesch",
    ...
    includes: [
      "Klimatisierte Minibusfahrt auf der gesamten Strecke",
      "Englischsprachiger Fahrer und Guide",
      "1 Nacht im Berber-Wüstencamp (Abendessen und Frühstück)",
    ...
    faq: [
      ...
      { q: "Warum Zagora statt Merzouga?", a: "Die Entfernung. Zagora ist in einem Fahrtag ab Marrakesch erreichbar, zwei Tage genügen also; Merzouga braucht drei. Der Preis dafür sind die Dünen — die von Zagora sind kleiner, und die Landschaft ist eher Steinwüste als der hohe Sand des Erg Chebbi, den man vor Augen hat. Bei drei Tagen bietet Merzouga das größere Bild. Bei zwei Tagen ist Zagora die ehrliche Antwort." },
      { q: "Wie ist das Camp ausgestattet?", a: "Sanitärzelte mit fließendem Wasser und Dusche, Betten mit Decken, Abendessen und Frühstück inklusive. Abends gibt es Generatorstrom. Es ist ein einfaches Wüstencamp und kein Luxuscamp, was sich im Preis widerspiegelt." },
      { q: "Wie lange dauert die Fahrt?", a: "Etwa sieben Stunden pro Richtung, über den Tizi-n'Tichka-Pass und hinunter durch die Palmenhaine des Draa-Tals. Es ist ein voller Fahrtag in jede Richtung — die ehrliche Form einer zweitägigen Wüstentour ab Marrakesch." },
      { q: "Reiten wir Kamele?", a: "Ja, ein kurzer Ritt ins Camp bei Sonnenuntergang, und er ist freiwillig — dieselbe Strecke zu laufen ist üblich. Der Ritt dauert etwa eine Stunde, was für die meisten, die noch nie auf einem Kamel saßen, gut machbar ist." },
    ],
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    featured: false,
    seoTitle: "Marrakesch nach Zagora 2-tägige Wüstentour",
    seoDescription: "Die schnellste Route zur Sahara — Aït Ben Haddou, die 200 km lange Draa-Tal-Palmenoase und ein Kameltrekking in die Dünen.",
  },
  {
    id: "24",
    slug: "erg-chegaga-3day-marrakech",
    localizedSlug: "erg-chegaga-3-tage-marrakesch",
    title: "Erg Chegaga ab Marrakesch — 3-tägige abgelegene Wüstenexpedition",
    category: "desert",
    origin: "marrakech",
    difficulty: "moderate",
    duration: "3 Tage / 2 Nächte",
    ...
    excludes: [
      ...
      "Persönliche Reiseversicherung",
      "Trinkgelder",
      "Optionale Quadtour bei M'Hamid (vor Ort buchbar)",
    ],
    itinerary: [
      {
        day: 1,
    ...
    faq: [
      ...
      { q: "Worin unterscheidet sich der Erg Chegaga vom Erg Chebbi?", a: "Chegaga ist größer, wilder und deutlich schwerer erreichbar — das letzte Stück führt querfeldein über die Reg, und am Dünenrand liegt keine Stadt. Der Erg Chebbi bei Merzouga hat eine Straße bis an die Dünen und weit mehr Camps. Wenn Sie den leereren der beiden wollen und die rauere Anfahrt nicht scheuen, ist Chegaga die Wahl." },
      { q: "Braucht man dafür einen 4x4, und ist der Offroad-Abschnitt schwierig?", a: "Ja, und er ist inbegriffen. Die letzte Annäherung an Chegaga ist echtes Geländefahren über Steinwüste — deshalb kostet diese Tour mehr als eine gleich lange Merzouga-Tour. Unsere Fahrer fahren sie routinemäßig; für Mitfahrende ist es eine holprige Stunde, keine technische Herausforderung." },
      { q: "Wie ist das Camp draußen bei Chegaga?", a: "Einfacher als in Merzouga, weil alles über die Reg herangeschafft werden muss. Sanitärzelte mit fließendem Wasser, Betten mit Decken, Abendessen und Frühstück. Genau diese Abgeschiedenheit ist der Grund, warum der Nachthimmel dort ist, wie er ist." },
      { q: "Wie kalt wird es nachts?", a: "Im Frühjahr und Herbst etwa 12–18 °C, im Hochwinter nahe dem Gefrierpunkt. Decken werden gestellt, und eine warme Schicht für den Abend lohnt sich zu jeder Jahreszeit." },
    ],
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    featured: true,
    seoTitle: "Erg Chegaga 3-tägige Wüstentour",
    seoDescription: "Marokkos abgelegenstes Wüstenerlebnis — 3 Tage ab Marrakesch zum Erg Chegaga per 4x4-Offroad-Durchquerung, eine Nacht in einem privaten Berbercamp.",
  },
  {
    id: "25",
    slug: "desert-4day-marrakech",
    localizedSlug: "wuestentour-4-tage-marrakesch",
    ...
    includes: [
      "Klimatisierte Minibus- oder 4x4-Fahrt auf der gesamten Strecke",
    ...
    excludes: [
      ...
      "Eintrittskarte für die Atlas Film Studios (optional, ~7 €)",
    ...
    faq: [
      ...
      { q: "Was bringt der vierte Tag gegenüber der Drei-Tage-Tour?", a: "Zeit, nicht mehr Strecke. Die Drei-Tage-Variante ist eine straffe Schleife mit zwei langen Fahrtagen; der vierte Tag lässt der Schluchtenlandschaft und den Dünen Luft und bedeutet meist eine zweite Nacht in der Wüstenregion statt eines Aufbruchs im Morgengrauen für die Rückfahrt. Wenn Ihnen an einer Drei-Tage-Tour die Fahrerei Sorge macht, ist das die Version, die Sie buchen sollten." },
      { q: "Wie wird übernachtet?", a: "Eine Mischung aus Wüstencamp und Hotel- oder Kasbah-Nächten, mit Abendessen und Frühstück an jeder Station. Das Camp hat Gemeinschaftsanlagen, die Hotels private Zimmer. Die genaue Aufteilung hängt von der Route ab, die wir für Ihre Daten fahren." },
      { q: "Wie kalt wird es nachts in der Wüste?", a: "Im Frühjahr und Herbst nach Einbruch der Dunkelheit etwa 12–18 °C. Im Hochwinter kann es in den Dünen an den Gefrierpunkt gehen. Im Camp gibt es Decken, aber eine warme Schicht für den Abend lohnt sich in jeder Jahreszeit — der Abfall nach Sonnenuntergang ist deutlich." },
      { q: "Können Ernährungswünsche berücksichtigt werden?", a: "Ja. Vegetarisch ist auf dieser Route unproblematisch; vegan, halal und gängige Allergien lassen sich berücksichtigen, wenn Sie es bei der Buchung angeben, damit Camp und Kasbahs vorab Bescheid wissen." },
    ],
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    featured: true,
    seoTitle: "4-tägige Wüstentour ab Marrakesch",
    seoDescription: "Die komplette Wüstenrundreise ab Marrakesch — 4 Tage durch Aït Ben Haddou, die Todra-Schlucht, ein Erg-Chebbi-Wüstencamp und die Straße der Tausend Kasbahs.",
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    localizedSlug: "merzouga-3-tage-agadir",
    ...
    includes: [
      "Klimatisierte 4x4-Fahrt auf der gesamten Strecke",
      "Englischsprachiger Fahrer und Guide",
      "1 Nacht im Hotel im Dades-Tal oder in Tinghir (Abendessen und Frühstück)",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — Ihr Hotel oder Riad" },
    featured: false,
    seoTitle: "Agadir nach Merzouga 3-tägige Wüstentour",
    seoDescription: "Von Agadirs Atlantikküste in die Sahara — über Taroudant, Taliouine, Aït Ben Haddou und ein Kameltrekking bei Sonnenuntergang auf dem Erg Chebbi.",
  },
  {
    id: "27",
    slug: "zagora-2day-agadir",
    localizedSlug: "zagora-tour-2-tage-agadir",
    ...
    includes: [
      "Klimatisierte Fahrt auf der gesamten Strecke",
      "Englischsprachiger Fahrer und Guide",
      "1 Nacht im Berber-Wüstencamp (Abendessen und Frühstück)",
      "Kameltrekking bei Sonnenuntergang",
      "Mineralwasser und Minztee",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — Ihr Hotel oder Riad" },
    featured: false,
    seoTitle: "Agadir nach Zagora 2-tägige Wüstentour",
    seoDescription: "Von Agadirs Küste in die Wüste von Zagora in 2 Tagen — über Taroudant, die 200 km lange Draa-Tal-Palmenoase und ein Kameltrekking bei Sonnenuntergang.",
  },
  {
    id: "28",
    slug: "erg-chegaga-3day-agadir",
    localizedSlug: "erg-chegaga-3-tage-agadir",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — Ihr Hotel oder Riad" },
    featured: false,
    seoTitle: "Agadir zum Erg Chegaga 3-tägige Wüstentour",
    seoDescription: "Marokkos abgelegenste Wüste ab Agadir — 3 Tage durch den Anti-Atlas zum Erg Chegaga per 4x4, eine Nacht in einem privaten Berbercamp. Weniger Touristen.",
  },
  {
    id: "29",
    slug: "desert-4day-agadir",
    localizedSlug: "wuestentour-4-tage-agadir",
    ...
    excludes: [
      "Mittagessen während der gesamten Reise (Budget 12–15 € pro Mahlzeit)",
      "Eintritt in die Atlas Film Studios (optional, ~7 €)",
      "Alkoholische Getränke",
      "Persönliche Reiseversicherung",
      "Trinkgelder",
    ],
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — Ihr Hotel oder Riad" },
    featured: false,
    seoTitle: "4-tägige Wüstentour ab Agadir — Erg Chebbi",
    seoDescription: "Die komplette Wüsten-Grand-Tour ab Agadir — 4 Tage durch Taroudant, Aït Ben Haddou, die Todra-Schlucht, ein Erg-Chebbi-Camp und die Straße der Tausend Kasbahs.",
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    localizedSlug: "agadir-fes-4-tage",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — Ihr Hotel oder Riad" },
    seoTitle: "4-Tage-Tour Agadir nach Fès — Hoher Atlas",
    seoDescription: "Fahrt von Agadir nach Fès über Marrakesch, den Tizi n'Tichka und die Zedernwälder des Mittleren Atlas. 4-tägige private 4x4-Tour mit Riad-Unterkunft. Ab $1188.",
    featured: false,
  },
  {
    id: "20",
    slug: "agadir-to-chefchaouen-5day",
    localizedSlug: "agadir-chefchaouen-5-tage",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — Ihr Hotel oder Riad" },
    seoTitle: "5-Tage-Tour Agadir nach Chefchaouen — Fès",
    seoDescription: "5-tägige Tour von Agadir zu Marokkos Blauer Stadt über Marrakesch, Fès, die römischen Ruinen von Volubilis und die kaiserlichen Tore von Meknès.",
    featured: false,
  },
  {
    id: "21",
    slug: "agadir-imperial-cities-6day",
    localizedSlug: "koenigsstaedte-agadir-6-tage",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — Ihr Hotel oder Riad" },
    seoTitle: "Alle 4 Kaiserstädte Marokkos 6-Tage-Tour",
    seoDescription: "Grand 6-Tage-Rundreise ab Agadir durch alle vier marokkanischen Kaiserstädte — Marrakesch, Meknès, Fès und Rabat. Privates 4x4 mit Riad-Unterkunft. Ab $594.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    localizedSlug: "toubkal-runde-ifni-see-6-tage",
    brief: [
    ...
    includes: [
      "Professioneller staatlich geprüfter Bergführer",
      "5 Übernachtungen (Hütten, Dorfunterkünfte und Zelten)",
      "Alle Mahlzeiten während der Tour",
    ...
    excludes: [
      ...
      "Trinkgeld für Guide, Koch und Maultiertreiber",
    ],
    itinerary: [
      {
        day: 1,
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Toubkal-Rundtrek 6 Tage, Ifni-See",
    seoDescription: "Die vollständige 6-tägige Toubkal-Rundtour ab Marrakesch — Hochpässe, der türkisfarbene Ifni-See und der Gipfel des Jbel Toubkal (4.167 m).",
    featured: false,
  },
  {
    id: "31",
    slug: "toubkal-summit-2day-marrakech",
    localizedSlug: "toubkal-besteigung-2-tage",
    brief: [
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "2-tägiger Mount-Toubkal-Trek ab Marrakesch",
    seoDescription: "Besteigen Sie den Jbel Toubkal (4.167 m) in 2 Tagen ab Marrakesch — die schnellste Route zu Nordafrikas höchstem Gipfel. Refugiumsnacht, Vollverpflegung.",
    featured: false,
  },
  {
    id: "32",
    slug: "toubkal-aguelzim-pass-3day",
    localizedSlug: "toubkal-aguelzim-pass-3-tage",
    title: "Toubkal-Gipfel über den Aguelzim-Pass ab Marrakesch — 3-tägiger Trek",
    category: "trekking",
    origin: "marrakech",
    difficulty: "challenging",
    duration: "3 Tage / 2 Nächte",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Toubkal-Trek 3 Tage über Aguelzim",
    seoDescription: "Besteigen Sie den Toubkal (4.167 m) auf dem landschaftlich schönen Weg — 3 Tage über das Azzaden-Tal.",
    featured: false,
  },
  {
    id: "33",
    slug: "toubkal-three-peaks-4000m-3day",
    localizedSlug: "toubkal-drei-gipfel-4000m-3-tage",
    title: "Toubkal Drei 4.000-m-Gipfel ab Marrakesch — 3-tägige Herausforderung",
    category: "trekking",
    origin: "marrakech",
    difficulty: "expert",
    duration: "3 Tage / 2 Nächte",
    ...
    includes: [
      "Professioneller staatlich geprüfter Bergführer (höhenqualifiziert)",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Toubkal Drei-Gipfel-4.000-m-Herausforderung",
    seoDescription: "Besteigen Sie drei 4.000-m-Gipfel des Hohen Atlas in 3 Tagen — Timesguida (4.089 m), Ras Ouanoukrim (4.083 m) und Toubkal (4.167 m).",
    featured: false,
  },
  {
    id: "34",
    slug: "marrakech-food-market-tour",
    localizedSlug: "kulinarische-tour-marrakesch",
    ...
    includes: [
      "Lokaler englischsprachiger Food-Guide",
      "Alle Verkostungen entlang der Route",
      "Zutaten und Anleitung für den Kochkurs",
      "Vollständiges Tajine-Mittagessen, das Sie mit zubereiten",
      "Minztee-Zeremonie",
    ],
    excludes: ["Abholung von Hotels außerhalb der Medina", "Trinkgeld für Guide und Gastfamilie"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    seoTitle: "Marrakesch Essens- & Markttour",
    seoDescription: "Halbtägige Marrakesch-Foodtour: Probieren Sie sich durch die Gewürzsouks und kochen Sie anschließend einen echten Tajine mit einer lokalen Familie.",
    faq: [
  ...
  },
  {
    ...
    localizedSlug: "sternenhimmel-merzouga",
    brief: [
      "Die meisten Wüstentouren erwähnen die Sterne im Prospekt und überlassen Ihnen dann das Hinschauen. Diese hier ist um den Himmel herum gebaut: Nach dem Kamelritt bei Sonnenuntergang und dem Abendessen baut ein Astronomie-Guide im Camp ein Teleskop auf und geht die Planeten, Sternbilder und Deep-Sky-Objekte durch, die in dieser Nacht zu sehen sind — erklärt in normaler Sprache statt in Fachjargon. Sie brauchen weder Ausrüstung noch Vorkenntnisse.",
      "Dass es gerade am Erg Chebbi funktioniert, liegt an der Entfernung zu allem Elektrischen. In keiner Richtung gibt es Stadtlicht, sodass die Milchstraße in einer klaren Nacht mit bloßem Auge sichtbar ist — nicht als schwacher Schleier, sondern als Struktur quer über den Himmel. Das ist seltener, als man denkt; in Europa gibt es kaum noch einen so dunklen Ort.",
      "Der Preis dafür ist die Fahrt. Der Erg Chebbi liegt rund 560 km und etwa 8 Stunden von Marrakesch entfernt, in jede Richtung, und dies ist eine Zweitagesreise — also ein langer Fahrtag, eine Nacht im Camp und ein langer Fahrtag zurück. Tag eins kommt rechtzeitig zum Kamelritt und Abendessen an; Tag zwei bringt den Sonnenaufgang über den Dünen und die Rückfahrt. Wer das lieber aufteilen möchte, sollte sich eine 3- oder 4-tägige Wüstenroute ansehen.",
      "Pro Person: 518 € allein, 260 € zu zweit, 191 € zu dritt, 160 € zu viert, 139 € zu fünft und 121 € ab sechs. Enthalten sind der Hin- und Rücktransport ab Marrakesch, der Kamelritt bei Sonnenuntergang, die Camp-Nacht, Abendessen und Frühstück sowie die Teleskopsitzung mit dem Astronomie-Guide. Das Mittagessen unterwegs ist nicht enthalten, Stopps gibt es aber; Reiseversicherung und Trinkgelder sind separat.",
      "Zwei praktische Hinweise. Die Mondphase zählt mehr als die Jahreszeit — Vollmond überstrahlt lichtschwache Objekte. Wenn also der tiefe Himmel Ihr Grund für die Reise ist, buchen Sie rund um Neumond. Und Wüstennächte sind vom Herbst bis zum Frühjahr kalt, kälter als die meisten Gäste einplanen; beobachtet wird draußen, im Stehen, lange nach Einbruch der Dunkelheit. Nehmen Sie eine warme Schicht mit, die Ihnen übertrieben vorkommt. Private Gruppe von 2 bis 10 Personen.",
    ],
    title: "Merzouga Sahara-Sternenbeobachtung ab Marrakesch — 2-tägige Dark-Sky-Wüstentour",
    category: "desert",
    origin: "marrakech",
    difficulty: "easy",
    duration: "2 Tage / 1 Nacht",
    ...
    includes: [
      ...
      "Teleskop und geführte Sternenbeobachtung",
      "Abendessen und Frühstück im Camp",
    ],
    excludes: [
      "Reiseversicherung",
      "Mittagessen unterwegs (Halte vorhanden)",
      "Trinkgeld für Guide und Camp-Team",
    ],
    itinerary: [
      {
        day: 1,
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "Merzouga Sternenbeobachtungstour",
    seoDescription: "Zwei Tage von Marrakesch nach Merzouga: Kameltrekking bei Sonnenuntergang, Teleskop-Session und eine Nacht im Erg-Chebbi-Camp.",
    faq: [
      ...
      { q: "Was ist tatsächlich zu sehen?", a: "Ohne Lichtverschmutzung auf zig Kilometern ist die Milchstraße etwa von März bis Oktober mit bloßem Auge sichtbar, dazu die großen Planeten und in guten Jahren Meteorströme. Die Mondphase zählt mehr als die Jahreszeit — Vollmond überstrahlt die feineren Details, prüfen Sie also den Kalender, wenn der Nachthimmel der Buchungsgrund ist." },
      { q: "Gibt es ein Teleskop, oder schaut man mit bloßem Auge?", a: "Die Dünen sind dunkel genug, dass das meiste, was den Abend ausmacht, mit bloßem Auge zu sehen ist. Bringen Sie ein Fernglas mit, falls vorhanden — es zeigt mehr von der Struktur der Milchstraße, als man erwartet." },
      { q: "Stören die Lichter des Camps?", a: "Der Generator wird für die Nacht abgeschaltet, und das ist Absicht. Danach ist das Camp wirklich dunkel — genau deshalb übernachtet man dort statt im Ort Merzouga." },
    ],
    featured: false,
  },
  {
    ...
    localizedSlug: "azzaden-tal-trek-2-tage",
    brief: [
      "Das Azzaden ist das Tal unmittelbar westlich des Korridors Imlil–Toubkal, und der Unterschied im Andrang macht genau den Reiz aus. Tag eins: 1,5 Stunden Fahrt von Marrakesch nach Imlil, dann rund 700 Höhenmeter hinauf über den Tizi-Mzik-Pass auf 2.684 m — mit dem Toubkal-Massiv, das sich hinter Ihnen auftut — und hinab durch Wacholderwald ins Dorf Tizi Oussem auf 1.850 m. Fünf bis sechs Stunden Gehzeit. Tag zwei überquert den Tizi Oudid und steigt nach Aguersioual ab, etwa 12 km und fünf Stunden, danach die Rückfahrt.",
      "Die Einstufung lautet mittel, und diese Einstufung bedeutet hier tatsächlich etwas. Kein Gipfel, kein Geröll und nichts über etwa 2.700 m, sodass die Höhe nie zu dem Problem wird, das sie am Toubkal darstellt. Nötig ist die Fähigkeit, an zwei aufeinanderfolgenden Tagen fünf bis sechs Stunden auf Bergpfaden zu gehen. Wer zu Hause regelmäßig wandert, empfindet das als angenehm; wer das nicht tut, als echte, aber machbare Anstrengung.",
      "Die Nacht verbringen Sie in einem familiengeführten Gästehaus in Tizi Oussem, nicht in einer Hütte oder im Zelt. Das zählt mehr, als es klingt: Eine Hütte ist ein Schlafsaal voller Menschen mit demselben Gipfelziel, ein Dorfgästehaus dagegen ist jemandes Zuhause, mit einem von der Familie gekochten Abendessen und einem Tal, das nach Einbruch der Dunkelheit still wird. Es ist der Teil, von dem uns Gäste hinterher schreiben.",
      "Pro Person: 285 € allein, 161 € zu zweit, 142 € zu dritt, 133 € zu viert, 124 € zu fünft und 116 € ab sechs. Enthalten sind der staatlich geprüfte Bergführer, die Gästehausnacht, alle Mahlzeiten während des Treks, ein Maultier für das Gruppengepäck und der Hin- und Rücktransfer ab Marrakesch. Sie tragen nur einen Tagesrucksack. Die Reiseversicherung ist hier empfohlen statt verpflichtend, persönliche Trekkingausrüstung ist Ihre Sache, und Trinkgelder für Bergführer und Maultierführer sind separat.",
      "Wenn Sie zwischen dieser Tour und einem Toubkal-Trek schwanken, lautet die Frage, was Sie von den Bergen erwarten. Der Toubkal ist ein Gipfel und ein Höhentag. Das Azzaden sind Dörfer, Terrassenfelder und Walnusshaine, in einem Tempo begangen, das Ihnen erlaubt, sich umzusehen. Private Gruppe von 2 bis 12 Personen, das Tempo ist also Ihres.",
    ],
    title: "Azzaden-Tal ab Marrakesch — 2-Tage-Trek im Atlasgebirge",
    category: "trekking",
    origin: "marrakech",
    difficulty: "moderate",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "2-Tage-Trek im Azzaden-Tal",
  ...
  },
  {
    ...
    localizedSlug: "hoher-atlas-dorftrek-3-tage",
    brief: [
      "Drei Tage Wandern von Tal zu Tal, ohne jeden Gipfel im Programm. Von Imlil wechseln Sie am ersten Tag ins Azzaden (4–5 Stunden), steigen am zweiten Tag rund 800 Höhenmeter über Hochweiden nach Tacheddirt auf 2.300 m (6 Stunden) und am dritten Tag durch das Ourika-Einzugsgebiet zur Straße ab (5 Stunden), bevor es zurück nach Marrakesch geht. Jede Nacht in einem anderen Dorfgästehaus — Sie bewegen sich also durch bewohntes Land, statt zu einem Basislager zurückzukehren.",
      "Das Fehlen eines Gipfels ist Absicht, kein Kompromiss. Nichts auf dieser Route liegt über etwa 2.700 m, was die Höhe völlig aus der Gleichung nimmt, und es gibt weder Geröll noch Aufbrüche vor Sonnenaufgang. Übrig bleibt gleichmäßiges, mittelschweres Gehen mit der Zeit und Kraft, wahrzunehmen, wo man ist — die Terrassenfelder, die Weide-Azibs, die Hirten, der Wechsel im Charakter von einem Tal zum nächsten.",
      "Das macht es zu einem starken ersten Mehrtagestrek. Wer zu Hause gelegentlich wandert, schafft hier drei aufeinanderfolgende Tage, ohne dass die Reise zur Ausdauerprüfung wird, und weil die Gästehäuser in Dörfern liegen und nicht an einer Trekkingroute, sind die Abende ruhig und lokal statt mit vierzig weiteren Wanderern auf demselben Gipfelweg geteilt.",
      "Pro Person: 416 € allein, 235 € zu zweit, 206 € zu dritt, 192 € zu viert, 181 € zu fünft und 169 € ab sechs. Enthalten sind der staatlich geprüfte Bergführer, beide Gästehausnächte, alle Mahlzeiten während des Treks, ein Maultier für das Gruppengepäck und der Hin- und Rücktransfer ab Marrakesch. Sie gehen mit einem Tagesrucksack. Die Reiseversicherung ist empfohlen, persönliche Trekkingausrüstung ist Ihre Sache, und Trinkgelder für Bergführer und Maultierführer sind separat.",
      "Klar gesagt: Wenn das Ziel darin besteht, auf dem Toubkal zu stehen, ist dies nicht dieser Trek und ersetzt ihn auch nicht. Wenn das Ziel der Hohe Atlas selbst ist — die Dörfer, die Pässe, drei Tage Gehen ohne Uhr —, deckt diese Tour mehr Gelände und mehr Abwechslung ab als jede Gipfelroute. Private Gruppe von 2 bis 12 Personen.",
    ],
    title: "Dörfer des Hohen Atlas ab Marrakesch — 3-Tage-Trek",
    category: "trekking",
    origin: "marrakech",
    difficulty: "moderate",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "3-Tage-Trek im Atlasgebirge",
  ...
  },
  {
    ...
    localizedSlug: "familien-atlas-trek-4-tage",
    brief: [
      "Trekking mit Kindern funktioniert, wenn die Tage kurz sind und es etwas zu sehen gibt — und genau nach dieser Regel ist diese Reise gebaut, nicht nachträglich angepasst. Tag eins: 1,5 Stunden Fahrt nach Imlil und 2–3 Stunden Gehzeit zum ersten Dorf. Tag zwei: 4 Stunden rund um die Wasserfälle des Tals. Tag drei: Wechsel auf die Ourika-Seite in 4–5 Stunden. Tag vier: 3 Stunden Abstieg und die Rückfahrt. Halbe Tage, keine Gewaltmärsche.",
      "Das Gelände ist bewusst einfach — das untere Imlil- und das Ourika-Tal, Flussquerungen, Walnusshaine und Wasserfälle statt hoher Pässe. Maultiere tragen das gesamte Gepäck und können auch ein müdes Kind tragen; genau dieses Detail macht aus einem schwierigen Nachmittag ein Nicht-Ereignis. Niemand trägt einen Rucksack und niemand wird gehetzt.",
      "Übernachtet wird drei Nächte lang in Dorfgästehäusern bei Berberfamilien, alle Mahlzeiten inklusive. Brotbacken und Minztee gehören zu den Abenden dazu, statt eine inszenierte Vorführung zu sein, und für die meisten Familien ist genau das am Ende die Erinnerung der Kinder — nicht das Wandern.",
      "Diese Reise hat eine Mindestteilnehmerzahl von drei Personen, die Staffel beginnt also dort: 276 € pro Person zu dritt, 257 € zu viert, 241 € zu fünft und 225 € ab sechs, bis zu einer Gruppe von vierzehn. Enthalten sind ein staatlich geprüfter, im Umgang mit Familien erfahrener Bergführer, alle drei Gästehausnächte, sämtliche Mahlzeiten, die Maultiere und der Hin- und Rücktransfer ab Marrakesch. Die Reiseversicherung ist empfohlen, persönliche Wanderausrüstung ist Ihre Sache, und Trinkgelder für Bergführer und Maultierführer sind separat.",
      "Zum Alter: Die Einschränkung ist das mehrstündige Gehen auf unebenem Gelände, nicht Distanz oder Höhe. Kinder im Schulalter kommen daher in der Regel gut zurecht, jüngere schaffen es mit den Maultieren an der Hand. Wenn Sie eine verbindliche Antwort für Ihre Familie möchten, nennen Sie uns bei der Anfrage das Alter — wir sagen Ihnen offen, ob es passt, statt Ihnen die Reise zu verkaufen.",
    ],
    title: "Hoher Atlas für Familien ab Marrakesch — 4-Tage-Sanfttrek",
    category: "trekking",
    origin: "marrakech",
    difficulty: "easy",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Familien-Trek im Atlasgebirge 4 Tage",
  ...
  },
  {
    ...
    localizedSlug: "familien-wuestentour-4-tage",
    brief: [
      "Dies ist die klassische Runde Marrakesch–Erg Chebbi, mit umstrukturierten Fahretappen, damit sie mit Kindern funktioniert. Die Route ist dieselbe, die alle fahren: über den Atlas nach Aït Ben Haddou und ins Dades-Tal am ersten Tag, durch die Dades- und Todra-Schlucht zu den Dünen am zweiten, zurück über Ouarzazate am dritten und vierten. Was sich ändert, ist der Zuschnitt der Tage — rund 5 Stunden Fahrt am ersten Tag, dann 4, 4 und 4, aufgeteilt in kürzere Etappen mit richtigen Pausen statt zwei langer Schläge.",
      "Das Nützlichste vorweg: Die Wüste ist wirklich weit von Marrakesch entfernt. Der Erg Chebbi liegt rund 560 km entfernt, in jede Richtung, und kein Reiseplan kann diese Strecke verkürzen. Vier Tage sind es, was die Reise angenehm macht: drei Nächte, drei verschiedene Betten und eine Dünennacht, die nicht von zwei Achtstundenfahrten eingerahmt wird. Die 2-Tages-Varianten legen dieselbe Strecke in der halben Zeit zurück — und genau das macht Kindern das Leben schwer.",
      "Die Nächte sind ein Hotel im Dades-Tal mit Abendessen und Frühstück, das Familiencamp am Erg Chebbi mit Abendessen und Frühstück und ein Hotel in Ouarzazate mit Frühstück. Das Camp ist für Familien eingerichtet und wird nicht als spartanisches Biwak geführt — Kamelritte bei Sonnenuntergang und Sonnenaufgang, Sandboarding auf den Dünen und Platz, damit Kinder Kinder sein können. Aït Ben Haddou auf dem Hinweg ist die Kasbah aus Game of Thrones und Gladiator, was bei älteren Kindern meist gut ankommt.",
      "Die Staffel beginnt bei zwei Personen, weil diese Reise nicht allein verkauft wird: 526 € pro Person zu zweit, 399 € zu dritt, 346 € zu viert, 314 € zu fünft, 270 € zu sechst, 252 € zu siebt, 245 € ab zehn und 229 € ab vierzehn. Enthalten sind das klimatisierte Fahrzeug auf der gesamten Strecke, ein zweisprachiger Fahrer-Guide (Englisch/Französisch), die drei beschriebenen Nächte, beide Kamelritte sowie alle Transfers und Eintrittsgebühren.",
      "Mittagessen sind nicht enthalten — rechnen Sie mit etwa 12–15 € pro Mahlzeit — und das Ticket für die Atlas-Filmstudios ist optional und kostet rund 7 €. Reiseversicherung und Trinkgelder sind separat. Die Gruppengröße liegt bei 2 bis 12 Personen und die Reise ist privat, was im Familienurlaub vor allem heißt: Sie können anhalten, wenn jemand anhalten muss.",
    ],
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "Familien-Wüstentour 4 Tage",
    ...
    faq: [
      ...
      { q: "Für welche Altersgruppen eignet sich die Tour?", a: "Sie ist als leicht eingestuft, und Familien buchen sie über eine große Altersspanne. Der Kamelritt ist kurz und freiwillig, gelaufen wird kaum. Der begrenzende Faktor ist die Fahrerei — ein Kind, dem mehrere Stunden im Auto schwerfallen, wird den ersten Tag lang finden, und genau deshalb ist dies die Vier-Tage- und nicht die Drei-Tage-Version." },
      { q: "Gibt es im Camp Beschäftigung für Kinder?", a: "Die Dünen erledigen das meiste — Sandboarden und Hinauf- und Hinunterlaufen beschäftigt die meisten Kinder bis zum Abendessen. Die Abende bestehen aus Trommeln und Feuer statt aus geplantem Programm." },
      { q: "Können wählerische Esser und Ernährungswünsche berücksichtigt werden?", a: "Ja. Tajine und Couscous sind die Grundlage, und einfachere Optionen gibt es immer. Teilen Sie uns Allergien oder Ernährungswünsche bei der Buchung mit, damit das Camp vor Ihrer Ankunft Bescheid weiß." },
      { q: "Gibt es Familienzimmer, oder werden wir getrennt?", a: "Zelte und Zimmer werden so vergeben, dass Familien zusammenbleiben — Sie werden nicht über das Camp verteilt. Nennen Sie uns bei der Buchung Alter und Zusammensetzung der Gruppe, dann richten wir es ein." },
    ],
    featured: false,
  },
  {
    ...
    localizedSlug: "hoher-atlas-durchquerung-15-tage",
    title: "Große Durchquerung des Hohen Atlas ab Marrakesch — 15-Tage-Trek vom M'Goun zum Toubkal",
    category: "trekking",
    origin: "marrakech",
    difficulty: "expert",
  ...
  },
  {
    ...
    localizedSlug: "toubkal-sahara-5-tage",
    title: "Toubkal-Gipfel & Sahara ab Marrakesch — 5-Tage-Tour vom Gebirge in die Wüste",
    category: "trekking",
    origin: "marrakech",
    difficulty: "challenging",
    duration: "5 Tage / 4 Nächte",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "5-Tage-Tour Toubkal-Gipfel & Sahara",
    seoDescription:
      "Verbinden Sie Marokkos zwei Höhepunkte: den Jbel Toubkal (4.167 m) besteigen und dann zu den Sahara-Dünen des Erg Chebbi.",
    faq: [
  ...
  },
  {
    ...
    localizedSlug: "kameltrekking-chegaga-8-tage",
    title: "Draa-Tal nach M’hamid — 8-tägiges Kameltrekking zum Chegaga",
    duration: "8 Tage / 7 Nächte",
    groupSize: "2–16 Personen",
    shortDescription:
      "Sechs Tage zu Fuß neben einer Kamelkarawane, vom Draa-Tal zu den Chegaga-Dünen — ohne Fahrzeug, ohne festes Camp, ohne Straße.",
    description:
      "Das ist die Sahara zu Fuß. Keine Stunde auf einem Kamel bei Sonnenuntergang, sondern sechs volle Tage neben einer Karawane, die das Lager trägt — von den letzten Palmen des Draa-Tals über die Hamada bis zum 50 km langen Dünenmeer des Erg Chegaga und weiter nach M’hamid.\n\nSie gehen etwa fünf bis sieben Stunden am Tag im Tempo der Karawane, das langsamer ist als Ihres. Die Kamele tragen Zelte, Verpflegung und Wasser; Sie tragen einen Tagesrucksack. Jeden Abend baut die Crew das Lager dort auf, wo der Tag endet — jedes Mal an einem anderen Ort, ohne Einrichtungen und ohne andere Reisende, denn ein mobiles Camp kann niemand sonst buchen.\n\nDie beiden Enden sind Fahrtage: Marrakesch über den Tizi n’Tichka ins Draa-Tal und von M’hamid zurück nach Marrakesch. Alles dazwischen wird gelaufen, und auf diesem Abschnitt gibt es keine Straße, auf der Sie es sich anders überlegen könnten.\n\nEingestuft als moderat und nicht als schwer: Das Gelände ist flach, die Höhe vernachlässigbar, aber die aufeinanderfolgenden Tage und der Sand machen daraus ein echtes Trekking. Wer schon einmal eine mehrtägige Route gegangen ist, ist dafür bereit.",
    highlights: [
      ...
      "Der Palmengürtel des Draa-Tals, der Abbes-Pass und die Oued-Naam-Dünen",
      "Berberführer und Koch begleiten Sie durch die gesamte Durchquerung",
      "Einer der dunkelsten Nachthimmel Marokkos, sieben Nächte in Folge",
    ],
    includes: [
      "Private Transfers Marrakesch ↔ Wüste auf Hin- und Rückweg",
      "Lizenzierter Berber-Wüstenführer (Englisch und Französisch)",
      "Kamele und Kameltreiber für Gepäck und Ausrüstung",
      "Koch, Küchenteam und die gesamte Campausrüstung",
      "Alle Mahlzeiten vom Abendessen an Tag 1 bis zum Mittagessen an Tag 8",
      "Sieben Nächte: Hotel in Marrakesch und mobile Wüstencamps",
      "Trinkwasser während der gesamten Tour",
    ],
    excludes: [
      "Internationale Flüge",
      "Reiseversicherung — für diese Tour erforderlich",
      "Schlafsack (Verleih auf Anfrage möglich)",
      "Ein Kamel zum Reiten statt daneben zu gehen (20 € pro Kamel und Tag)",
      "Erfrischungsgetränke und Flaschengetränke",
      "Trinkgeld für Guide, Koch und Kameltreiber",
    ],
    itinerary: [
      { day: 1, title: "Marrakesch — Ankunft und Briefing", description: "Ankunft in Marrakesch und Bezug des Hotels. Ihr Guide trifft Sie am Abend, geht die Route durch, prüft die Ausrüstung und beantwortet die Fragen, die vor einer ersten Wüstendurchquerung alle haben. Wer früh landet, hat noch Zeit für die Medina.", stop: { name: "Marrakesch", lat: 31.6295, lng: -7.9811 }, meals: "D", stay: "Hotel in Marrakesch" },
      { day: 2, title: "Marrakesch → Draa-Tal — Treffen mit der Karawane", description: "Die lange Fahrt nach Süden über den Tizi n’Tichka, durch Ouarzazate und hinunter ins Draa-Tal über Agdz und Zagora. Am späten Nachmittag verlassen Sie bei Faija die Straße und treffen auf Kamele, Kameltreiber und Koch. Erste Nacht im Zelt, die Karawane beladen und bereit.", stop: { name: "Draa-Tal (Faija)", lat: 30.3167, lng: -5.8375 }, meals: "B,L,D", stay: "Mobiles Wüstencamp", driving: "8–9 Std.", distance: "≈460 km" },
      { day: 3, title: "Draa-Tal → Hamada", description: "Der erste volle Wandertag. Sie verlassen den Palmengürtel und queren auf die Hamada — die Steinwüste — mit dem Grat des Jbel Bani am Horizont. Mittagessen und lange Rast in einer Oase, solange die Sonne hoch steht, dann weiter zum Camp, während das Licht schwindet.", stop: { name: "Hamada du Draa", lat: 30.1500, lng: -5.9500 }, meals: "B,L,D", stay: "Mobiles Wüstencamp", walking: "6–7 Std." },
      { day: 4, title: "Abbes-Pass → Erg Chegaga", description: "Über den Abbes-Pass und hinein in den Sand. Die Dünen wachsen im Lauf des Vormittags, bis Sie am Nachmittag den Erg Chegaga erreichen — das größte Dünenfeld Marokkos, 50 km lang und 15 km breit. Nach zwei Tagen zu Fuß dort anzukommen, ist etwas anderes, als aus einem 4x4 zu steigen.", stop: { name: "Erg Chegaga", lat: 29.841402, lng: -6.29299 }, meals: "B,L,D", stay: "Mobiles Camp in den Dünen", walking: "6–7 Std." },
      { day: 5, title: "Erg Chegaga → Bougarne-Dünen", description: "Ein ruhigerer Tag durch das Dünenmeer Richtung M’hamid, die Mittagsstunden unter Tamarisken, bis die Hitze nachlässt. Die Dünen sind hier stiller als am Westrand des Chegaga, wo die Tagesausflüge umkehren.", stop: { name: "Erg Bougarne", lat: 29.8500, lng: -5.8500 }, meals: "B,L,D", stay: "Mobiles Wüstencamp", walking: "5–6 Std." },
      { day: 6, title: "Bougarne → Oued Naam", description: "Früher Aufbruch, um in der Kühle zu gehen: über ein Felsplateau zwischen zwei Dünensystemen, bevor es zu den Oued-Naam-Dünen hinuntergeht. Das ist der leerste Abschnitt der Route — außerhalb Ihrer eigenen Gruppe werden Sie den ganzen Tag kaum jemanden sehen.", stop: { name: "Oued Naam", lat: 29.8000, lng: -5.7500 }, meals: "B,L,D", stay: "Mobiles Wüstencamp", walking: "6–7 Std." },
      { day: 7, title: "Oued Naam → M’hamid → Marrakesch", description: "Ein letzter kürzerer Marsch durch Regaga nach M’hamid el Ghizlane, wo die Straße wieder beginnt und die Karawane endet. Abschied von der Kamelcrew, dann zurück durch das Draa-Tal nach Marrakesch — zu einem Bett, einer Dusche und einem Wasserhahn.", stop: { name: "M’hamid el Ghizlane", lat: 29.8264, lng: -5.7222 }, meals: "B,L,D", stay: "Hotel in Marrakesch", walking: "3 Std.", driving: "7–8 Std." },
      { day: 8, title: "Marrakesch — Abreise", description: "Frühstück und, wenn der Flug es zulässt, noch Zeit in der Stadt, bevor der Transfer zum Flughafen ansteht.", stop: { name: "Marrakesch", lat: 31.6295, lng: -7.9811 }, meals: "B" },
    ],
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    featured: false,
    seoTitle: "8-tägiges Kameltrekking zum Chegaga",
    seoDescription:
      "Zu Fuß durch die Sahara mit einer Kamelkarawane: sechs Tage vom Draa-Tal zu den Erg-Chegaga-Dünen und nach M’hamid. Mobile Camps, Berberführer, Vollpension.",
    faq: [
      { q: "Reite ich auf dem Kamel oder gehe ich zu Fuß?", a: "Sie gehen. Die Kamele tragen Zelte, Verpflegung, Wasser und Ihr Gepäck — Sie tragen nur einen Tagesrucksack. Genau das macht daraus ein Trekking und keinen Kamelritt. Wenn Sie einen Teil der Strecke reiten möchten, lässt sich ein Reitkamel für rund 20 € pro Kamel und Tag hinzubuchen, vor der Abreise zu vereinbaren." },
      { q: "Wie anstrengend ist es wirklich?", a: "Moderat. Sie gehen sechs Tage hintereinander fünf bis sieben Stunden täglich, aber der Boden ist flach, es gibt keine Höhe, und die Karawane gibt ein langsames Tempo vor. Die Schwierigkeit liegt in der Wiederholung und im Sand, nicht in einem einzelnen harten Tag. Wer schon eine mehrtägige Route gegangen ist, schafft das bequem." },
      { q: "Wie sind die Camps?", a: "Mobil und einfach, und genau darum geht es. Die Crew stellt traditionelle Berberzelte dort auf, wo der Tag endet — also jede Nacht an einem anderen Platz, ohne feste Bauten, ohne Strom und ohne Waschhaus; an jedem Camp wird ein Toilettenzelt aufgebaut. Dafür schlafen Sie dort, wo kein Fahrzeug hinkommt und keine andere Gruppe übernachtet." },
      { q: "Gibt es eine Mindestteilnehmerzahl?", a: "Ja — zwei. Reisen über sieben Tage brauchen mindestens zwei Teilnehmende, denn eine vollständige Kamelcrew, ein Guide und ein Koch fahren unabhängig von der Personenzahl mit. Der Preis pro Person sinkt mit wachsender Gruppe deutlich: 1.040 € pro Person zu zweit, 790 € zu viert und 695 € ab fünf Personen." },
      { q: "Wann ist die beste Reisezeit?", a: "Oktober bis Mai. Der Sommer erreicht in diesem Teil der Sahara Temperaturen, die mehrtägiges Gehen wirklich unsicher machen, deshalb bieten wir das Trekking von Juni bis September nicht an. Die klarsten, kältesten Nächte — und die besten Sterne — liegen zwischen Dezember und Februar, wenn ein warmer Schlafsack zählt." },
      { q: "Worin unterscheidet sich das von Ihrer 3-Tage-Tour zum Erg Chegaga?", a: "Die [3-Tage-Tour](/de/tours/erg-chegaga-3-tage-marrakesch) erreicht dieselben Dünen mit dem 4x4 und übernachtet in einem festen Camp — die richtige Wahl, wenn Sie drei Tage haben. Dies sind acht Tage zu Fuß: Sie nähern sich dem Chegaga über zwei Wüstentage, schlafen jede Nacht in einem anderen Wildcamp und ziehen durch die Dünen weiter nach M’hamid, statt umzukehren." },
    ],
  },
  {
    id: "44",
    slug: "shared-merzouga-3day-marrakech",
    localizedSlug: "merzouga-wueste-3-tage-geteilt",
    title: "Merzouga-Wüste ab Marrakesch — 3-Tage-Gruppentour",
    category: "desert",
    origin: "marrakech",
    difficulty: "easy",
    duration: "3 Tage / 2 Nächte",
    groupSize: "Bis zu 16 Personen",
    tourType: "shared",
    reviewCount: 0,
    ...
    shortDescription:
      "Die klassische Route Marrakesch-Merzouga als tägliche Gruppenabfahrt: Aït Ben Haddou, die Schluchten und eine Nacht in den Dünen des Erg Chebbi.",
    description:
      "Dieselbe Route wie unsere private 3-Tages-Tour, auf einer festen täglichen Abfahrt, die Sie mit anderen Reisenden teilen. Über den Tizi n'Tichka, vorbei am UNESCO-Ksar Aït Ben Haddou, durch die Dades- und Todra-Schluchten, dann ein Kamelritt in den Erg Chebbi und eine Nacht im Wüstencamp. Sie geben die Freiheit auf, anzuhalten, wo Sie wollen; dafür bekommen Sie die Sahara zu einem Drittel des Privatpreises.",
    highlights: [
      "Tizi-n'Tichka-Pass durch den Hohen Atlas",
      "UNESCO-Ksar von Aït Ben Haddou",
      "Dades- und Todra-Schlucht",
      "Kamelritt in die Dünen des Erg Chebbi bei Sonnenuntergang",
      "Nacht in einem Berber-Wüstencamp",
    ],
    includes: [
      "Fahrt im klimatisierten Sammelminibus",
      "Zwei Übernachtungen (Hotel und Wüstencamp)",
      "Abendessen und Frühstück an beiden Abenden",
      "Kameltrekking bei Sonnenuntergang",
      "Englisch- oder französischsprachiger Fahrer",
    ],
    excludes: ["Mittagessen", "Getränke", "Trinkgelder", "Eintrittsgelder"],
    itinerary: [
      {
        day: 1,
        driving: "≈7 h",
        ...
        title: "Marrakesch → Aït Ben Haddou → Dades-Schlucht",
        description:
          "Abfahrt in Marrakesch gegen 7:00 Uhr und Überquerung des Tizi-n'Tichka-Passes. Halt in Aït Ben Haddou und Ouarzazate, dann weiter entlang des Tals der tausend Kasbahs. Übernachtung in der Dades-Schlucht.",
      ...
      },
      {
        ...
        driving: "≈5 h",
        distance: "≈300 km",
        title: "Dades → Todra-Schlucht → Merzouga",
        description:
          "Vormittag in der Todra-Schlucht, dann weiter über Erfoud nach Merzouga. Kamelritt in die Dünen bei Sonnenuntergang, Abendessen und Trommelmusik im Camp.",
        stop: { name: "Erg Chebbi, Merzouga", lat: 31.138236, lng: -3.970775 },
      },
      {
        day: 3,
        driving: "≈9 h",
        distance: "≈560 km",
        title: "Sonnenaufgang über den Dünen → Marrakesch",
        description:
          "Sonnenaufgang über dem Erg Chebbi, dann die lange Rückfahrt nach Marrakesch über Alnif, Tazarine und Ouarzazate. Ankunft am frühen Abend.",
        stop: { name: "Marrakech", lat: 31.6295, lng: -7.9811 },
      },
    ],
    faq: [
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "Merzouga-Wüste 3-Tage-Gruppentour — €120",
    seoDescription: "Tägliche Gruppenabfahrt ab Marrakesch zu den Dünen des Erg Chebbi: Aït Ben Haddou, Dades- und Todra-Schlucht, Kamelritt und Übernachtung im Wüstencamp.",
    featured: false,
  },
  {
    id: "45",
    slug: "shared-zagora-2day-marrakech",
    localizedSlug: "zagora-wueste-2-tage-geteilt",
    brief: [
      "Zagora ist die nächstgelegene Wüstenübernachtung ab Marrakesch, und genau darin liegt ihr Reiz. Die Route führt über den Tizi-n'Tichka-Pass, vorbei an Aït Ben Haddou und Ouarzazate, in die Palmenhaine des Draa-Tals, dann per Kamelritt zu einem Camp mit Abendessen und Trommelmusik. Tag zwei geht denselben Weg zurück. Rund 360 km und etwa 8 Stunden in jede Richtung.",
      "Seien Sie vor der Buchung ehrlich zu sich selbst, was die Dünen angeht. Die von Zagora sind klein — nichts im Vergleich zu den 150 Meter hohen Wänden des Erg Chebbi —, denn Zagora ist eine Wüstenstadt mit Sand und kein großer Erg. Das ist der Tausch für eine Reise, die in zwei statt in drei oder vier Tage passt. Wer Lawrence von Arabien erwartet, wird enttäuscht; wer weiß, dass dies die Kurzfassung ist, genießt sie.",
      "Mit 85 € pro Person ist es die günstigste Wüstennacht, die wir anbieten, und der Preis ist fest statt gestaffelt, weil es sich um eine geteilte Abfahrt handelt, die pro Platz verkauft wird. Sie reisen in einem klimatisierten Minibus mit bis zu sechzehn weiteren Gästen und einem englisch- oder französischsprachigen Fahrer. Die Anzahlung beträgt 19 €. Enthalten: Transport, die Camp-Nacht, Abendessen und Frühstück sowie der Kamelritt.",
      "Nicht enthalten: Mittagessen, Getränke, Trinkgelder und Eintrittsgebühren — insbesondere in Aït Ben Haddou wird vor Ort Eintritt verlangt. Planen Sie diese Posten separat ein, damit der Tag keine Überraschungen bereithält.",
      "Wenn Sie drei oder vier Tage haben, sind Merzouga und der Erg Chebbi die bessere Wüste. Wenn Sie zwei Tage haben oder die Differenz lieber anderswo in Marokko ausgeben möchten, erfüllt diese Tour ihren Zweck ehrlich: eine echte Nacht unter Zeltplane im Süden, zu einem Preis, der den Rest Ihrer Reise unangetastet lässt.",
    ],
    title: "Zagora-Wüste ab Marrakesch — 2-Tage-Gruppentour",
    category: "desert",
    origin: "marrakech",
    difficulty: "easy",
    duration: "2 Tage / 1 Nacht",
    ...
    shortDescription:
      "Der kürzeste Weg zu einer Wüstennacht: über den Atlas ins Draa-Tal, ein Kamelritt und ein Camp unter den Sternen.",
    description:
      "Zagora ist die Marrakesch am nächsten gelegene Wüstennacht, und genau das ist ihr Reiz: ein langer Fahrtag statt zwei. Über den Tizi n'Tichka, vorbei an Aït Ben Haddou und Ouarzazate, in die Palmenhaine des Draa-Tals, dann ein Kamelritt und ein Camp mit Abendessen und Musik. Die Dünen sind kleiner als am Erg Chebbi — das ist der Preis der kürzeren Reise.",
    highlights: [
      "Tizi-n'Tichka-Pass und Aït Ben Haddou",
      "Palmenhaine des Draa-Tals",
      "Kamelritt in die Dünen von Zagora",
      "Nacht in einem Berbercamp mit Abendessen und Musik",
    ],
    includes: [
      "Fahrt im klimatisierten Sammelminibus",
      "Eine Nacht in einem Wüstencamp",
    ...
    itinerary: [
      {
        ...
        driving: "≈8 h",
        distance: "≈360 km",
        title: "Marrakesch → Aït Ben Haddou → Zagora",
        description:
          "Frühe Abfahrt über den Tizi n'Tichka. Halt in Aït Ben Haddou und Ouarzazate, dann nach Süden durch das Draa-Tal. Kamelritt in die Dünen bei Sonnenuntergang, Abendessen im Camp.",
      ...
      },
      {
        ...
        driving: "≈8 h",
        distance: "≈360 km",
        title: "Sonnenaufgang → Marrakesch",
        description:
          "Sonnenaufgang über den Dünen, Frühstück im Camp, dann die Rückfahrt nach Marrakesch durch das Draa-Tal und über den Atlas. Ankunft am späten Nachmittag.",
        stop: { name: "Marrakech", lat: 31.6295, lng: -7.9811 },
      },
    ],
    faq: [
      { q: "Zagora oder Merzouga?", a: "Zagora liegt näher — ein Fahrtag statt zwei — aber die Dünen dort sind niedrig und mit Buschwerk bestanden. Der Erg Chebbi bei Merzouga ist das hohe goldene Sandmeer, das die meisten vor Augen haben, und dafür braucht es die [3-Tage-Tour](/de/tours/merzouga-wueste-3-tage-geteilt). Wenn die Zeit knapp ist: Zagora. Wenn Sie die Dünen von den Fotos wollen: Merzouga." },
      { q: "Wie lange dauert die Fahrt?", a: "Etwa acht Stunden pro Richtung. Das ist ein langer Tag im Fahrzeug für eine einzige Wüstennacht — der ehrliche Kompromiss des Zwei-Tage-Formats." },
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "Zagora-Wüste 2-Tage-Gruppentour — €85",
  ...
  },
  {
    ...
    localizedSlug: "ouzoud-wasserfaelle-gruppentour",
    title: "Ouzoud-Wasserfälle — Gruppentagestour ab Marrakesch",
    category: "day-tours",
    origin: "marrakech",
    difficulty: "easy",
    duration: "1 Tag",
    ...
    shortDescription:
      "Der höchste Wasserfall Nordafrikas als tägliche Gruppenabfahrt: 110 m Kaskaden, wilde Berberaffen und ein Boot am Fuß der Fälle.",
    description:
      "Die Ouzoud-Fälle stürzen 110 Meter in drei Stufen durch eine Schlucht voller Olivenbäume und alter Mühlen, mit einer Kolonie wilder Berberaffen entlang des oberen Weges. Jeden Morgen fährt ein Sammelminibus aus Marrakesch; Sie steigen zum Fuß der Fälle hinab, nehmen das kleine Boot durch die Gischt und sind am Abend zurück in der Stadt.",
    highlights: [
      "Die 110 m hohen Ouzoud-Wasserfälle, die höchsten Nordafrikas",
      "Wilde Berberaffen auf dem Schluchtenpfad",
      "Bootsfahrt am Fuß der Wasserfälle",
      "Traditionelle Wassermühlen, die noch mahlen",
    ],
    includes: [
      "Hin- und Rückfahrt im Sammelminibus",
      "Lokaler Guide an den Wasserfällen",
      "Mineralwasser",
    ],
    excludes: ["Mittagessen", "Ticket für die Bootsfahrt", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        walking: "2–3 h",
        ...
        description:
          "Abfahrt in Marrakesch gegen 8:00 Uhr, Ankunft in Ouzoud am späten Vormittag. Geführter Abstieg durch die Schlucht bis zum Fuß der Fälle, Bootsfahrt, Berberaffen beobachten und freie Zeit für das Mittagessen mit Blick auf die Kaskaden. Rückkehr nach Marrakesch am frühen Abend.",
        stop: { name: "Ouzoud Falls, Middle Atlas", lat: 32.0152, lng: -6.7189 },
      },
    ],
    faq: [
      { q: "Wie viel wird gelaufen?", a: "Zwei bis drei Stunden im eigenen Tempo. Der Schluchtenpfad führt hinunter zum Fuß der Fälle und wieder hinauf, über Stufen und festgetretene Erde — nichts zum Klettern, aber ein echter Ab- und Wiederaufstieg." },
      { q: "Sehen wir die Affen?", a: "In Ouzoud lebt entlang des oberen Pfades eine Kolonie wilder Berberaffen, und Sichtungen sind häufig — es sind aber Wildtiere und daher nie garantiert. Bitte füttern Sie sie nicht." },
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "Ouzoud-Wasserfälle Gruppentagestour — €40",
    seoDescription: "Tägliche Gruppenabfahrt zu den Ouzoud-Wasserfällen: 110 m hohe Kaskaden, freilebende Berberaffen, Schluchtwanderung und Bootsfahrt.",
    featured: false,
  },
  {
    id: "47",
    slug: "shared-agafay-dinner-camel-ride",
    localizedSlug: "agafay-abendessen-kamelritt-feuershow",
    title: "Agafay-Wüste — Abendessen, Kamelritt und Feuershow",
    category: "day-tours",
    origin: "marrakech",
    difficulty: "easy",
    duration: "Halber Tag / Abend",
    groupSize: "Bis zu 20 Personen",
    tourType: "shared",
    reviewCount: 0,
    // Not rendered: cards show TRIPADVISOR.rating site-wide. Mirrors the real
    // business rating so the 1-5 invariant holds; reviewCount stays 0, which is
    ...
    description:
      "Agafay ist eher eine Steinwüste als ein Sandmeer, und ihr Reiz ist die Nähe: vierzig Minuten von Marrakesch, der Atlas am Horizont und keine Lichtverschmutzung. Der Abend führt vom Kamelritt im goldenen Licht zum Abendessen im Camp mit Musik und Feuershow, und noch am selben Abend zurück ins Riad. Es ist nicht die Sahara, und das sagen wir auch — aber als Abendausflug ist es kaum zu schlagen.",
    highlights: [
      "Kamelritt durch die Steinwüste Agafay bei Sonnenuntergang",
      "Abendessen im Wüstencamp mit dem Hohen Atlas am Horizont",
      "Live-Musik und Feuershow",
      "Am selben Abend zurück in Marrakesch",
    ],
    includes: [
    ...
    excludes: ["Getränke außer Wasser und Tee", "Trinkgelder", "Quadfahren oder andere Extras"],
    itinerary: [
      {
        day: 1,
        driving: "≈40 min each way",
        distance: "≈30 km each way",
        title: "Abend — Agafay-Wüste",
        description:
          "Abholung an Ihrem Riad am späten Nachmittag. Kamelritt durch die Steinwüste, während das Licht schwindet, danach Abendessen im Camp mit Musik und Feuershow. Rückkehr nach Marrakesch gegen 22:30 Uhr.",
        stop: { name: "Agafay Desert", lat: 31.4333, lng: -8.1500 },
      },
    ],
    faq: [
      { q: "Ist Agafay die Sahara?", a: "Nein, und wer Ihnen etwas anderes erzählt, will Ihnen etwas verkaufen. Agafay ist eine steinige, mondartige Wüste rund 30 km von Marrakesch — ohne Sanddünen. Es ist ein wirklich schöner Abend und ein schlechter Ersatz für den Erg Chebbi. Für echte Dünen brauchen Sie [Merzouga](/de/tours/merzouga-wueste-3-tage-geteilt) oder [Zagora](/de/tours/zagora-wueste-2-tage-geteilt)." },
      { q: "Wann endet der Ausflug?", a: "Gegen 22:30 Uhr zurück an Ihrem Riad. Die Abholung erfolgt am mittleren bis späten Nachmittag, je nach Jahreszeit und Sonnenuntergang." },
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "Agafay-Wüste: Abendessen & Kamelritt — €30",
  ...
  },
  {
    ...
    localizedSlug: "essaouira-gruppentagestour",
    title: "Essaouira — Gruppentagestour ab Marrakesch",
    category: "day-tours",
    origin: "marrakech",
    difficulty: "easy",
    duration: "1 Tag",
    ...
    shortDescription:
      "Die atlantische Hafenstadt als tägliche Gruppenabfahrt: Stadtmauern, blaue Fischerboote, Medina und Arganöl-Kooperativen unterwegs.",
    description:
      "Essaouira ist eine befestigte Hafenstadt am Atlantik, drei Stunden westlich von Marrakesch: weiß und blau, gut zu Fuß zu erkunden und im Sommer weit kühler als die Stadt. Die Gruppentour hält unterwegs an einer Arganöl-Kooperative und lässt Ihnen dann mehrere freie Stunden in der UNESCO-Medina, auf den Stadtmauern und im Fischerhafen, bevor es zurückgeht.",
    highlights: [
      "UNESCO-Medina und Stadtmauern aus dem 18. Jahrhundert",
      "Die blaue Fischereiflotte im aktiven Hafen",
      "Arganöl-Kooperative an der Straße nach Marrakesch",
      "Atlantikluft und ein langer Strand",
    ],
    includes: [
      "Hin- und Rückfahrt im klimatisierten Sammelminibus",
      "Halt bei einer Arganöl-Kooperative",
      "Freizeit in der Medina",
    ],
    excludes: ["Mittagessen", "Guide in der Medina", "Trinkgelder"],
    itinerary: [
      {
        day: 1,
        driving: "≈3 h each way",
        distance: "≈190 km each way",
        title: "Ganzer Tag — Essaouira",
        description:
          "Abfahrt in Marrakesch gegen 8:00 Uhr, unterwegs Halt bei einer Arganöl-Kooperative. Ankunft in Essaouira am späten Vormittag, freie Zeit für Medina, Stadtmauern, Hafen und Mittagessen. Rückfahrt am frühen Nachmittag, Ankunft in Marrakesch am frühen Abend.",
        stop: { name: "Essaouira Medina", lat: 31.5125, lng: -9.7700 },
      },
    ],
    faq: [
      { q: "Wie viel Zeit haben wir wirklich in Essaouira?", a: "Etwa vier bis fünf Stunden, genug für die Medina, die Stadtmauern, den Hafen und ein gemütliches Mittagessen. Für den Strand reicht es nicht mehr als im Vorbeigehen — dafür müssten Sie übernachten." },
      { q: "Ist ein Guide für die Medina dabei?", a: "Nein. Sie haben freie Zeit zum Erkunden auf eigene Faust, was in einer so gut zu Fuß erschließbaren Stadt die meisten bevorzugen. Transport und der Stopp bei der Arganöl-Kooperative sind enthalten." },
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakesch — Ihr Hotel oder Riad" },
    seoTitle: "Essaouira Gruppentagestour — €30",
    seoDescription: "Tägliche Gruppenabfahrt nach Essaouira: UNESCO-Medina, Stadtmauern aus dem 18. Jahrhundert, blauer Fischerhafen und unterwegs eine Arganöl-Kooperative.",
    featured: false,
  },
  {
    id: "50",
    ...
    shortDescription:
      "Der höchste Gipfel Nordafrikas und die Dünen des Erg Chebbi in einer 8-tägigen Reise, mit festen Terminen und 14 Plätzen.",
    description:
    ...
    faq: [
      ...
      { q: "Wie ist das Wetter an diesen Terminen?", a: "Die Termine reichen von März bis Mitte April, und der Berg verändert sich in diesem Zeitraum deutlich. Im März ist der Toubkal noch ein Winterberg: Schnee an den oberen Hängen und Minusgrade am Gipfel im Morgengrauen, Steigeisen und Eispickel werden gestellt, wenn die Bedingungen es verlangen. An den April-Terminen ist die Schneegrenze meist zurückgewichen und das Gehen leichter, auch wenn der Gipfel vor Sonnenaufgang noch unter null liegen kann. In der Wüste ist es an allen Terminen umgekehrt: warme Tage, kalte und klare Nächte." },
      { q: "Warum ist Tag 6 eine so lange Fahrt?", a: "Weil der Erg Chebbi das echte Sandmeer ist, rund 560 km von Marrakesch entfernt. Anbieter, die einen kurzen Wüstentransfer versprechen, fahren meist zu den viel kleineren Dünen bei Zagora. Wir finden, die zusätzlichen Stunden kaufen etwas, das sich lohnt." },
      { q: "Was bedeutet das Limit von 14 Plätzen konkret?", a: "Der Termin schließt, sobald 14 Plätze verkauft sind. Wir deckeln dort, weil sowohl die Toubkal-Hütte als auch das Wüstencamp begrenzten Platz haben und weil ein Guide an einem Gipfelmorgen nur eine begrenzte Zahl von Menschen betreuen kann." },
    ],
    category: "trekking",
    origin: "marrakech",
    difficulty: "challenging",
    ...
    itinerary: [
      ...
      },
      {
        ...
        ascent: "+1,470 m",
        stop: { name: "Toubkal Refuge", lat: 31.063483, lng: -7.937584 },
        title: "Marrakesch – Imlil und Aufstieg zur Toubkal-Hütte (3.207 m)",
        description:
      ...
      },
      {
        ...
        ascent: "+960 m / -2,430 m",
        stop: { name: "Jbel Toubkal Summit", lat: 31.060297, lng: -7.915258 },
        title: "Toubkal-Gipfel (4.167 m) und Abstieg nach Imlil",
        description:
      ...
      },
      {
        ...
        title: "Imlil – Ait Ben Haddou und die Dades-Schlucht",
        description:
      ...
      },
      {
        ...
        distance: "~290 km",
        stop: { name: "Erg Chebbi, Merzouga", lat: 31.138236, lng: -3.970775 },
        title: "Dades – Todra-Schlucht und mit Kamelen in den Erg Chebbi",
        description:
      ...
      },
      {
        ...
        distance: "~560 km",
        stop: { name: "Marrakech", lat: 31.6295, lng: -7.9811 },
        title: "Merzouga – zurück nach Marrakesch",
        description:
      ...
      },
      {
        ...
        title: "Geführter Medina-Rundgang und freier Abend",
        description:
  ...
  },
  {
    ...
    featured: false,
    localizedSlug: "casablanca-fes-sahara-marrakesch-5-tage",
    title: "Von Casablanca nach Marrakesch — Königsstädte und Sahara in 5 Tagen",
    duration: "5 Tage / 4 Nächte",
    shortDescription:
      "In fünf Tagen von Nord nach Süd: Rabat, das römische Volubilis, Meknès, zwei Nächte in Fès, die Dünen des Erg Chebbi und die Schluchten bis Marrakesch.",
    description:
      "Eine Reise durch die ganze Länge des Landes — sie beginnt dort, wo die meisten landen, und endet dort, wo die meisten hinwollen. Vom Atlantik in die Sahara und zurück in den Hohen Atlas: drei Königsstädte, die besterhaltene römische Stätte Marokkos, ein ganzer Tag mit Führung in der Medina von Fès, eine Nacht in den Dünen des Erg Chebbi und die Schluchtenstraße durch Todra und Dades. Privates Fahrzeug und Fahrer-Guide durchgehend, das Tempo bestimmen Sie.",
    highlights: [
      "Hassan-Turm und Kasbah der Udayas in Rabat",
      "Volubilis — römische Mosaike, noch an Ort und Stelle unter freiem Himmel",
      "Bab Mansour und die kaiserlichen Speicher von Meknès",
      "Ein ganzer geführter Tag in der Medina von Fès",
      "Kamelritt und Übernachtung im Camp im Erg Chebbi",
      "Todra-Schlucht und das Dades-Tal",
      "Aït Ben Haddou und die Filmstudios von Ouarzazate",
    ],
    itinerary: [
      { day: 1, driving: "≈6 Std.", distance: "≈370 km", stay: "Riad in der Medina von Fès", meals: "—",
        title: "Casablanca → Rabat → Volubilis → Meknès → Fès",
        description: "Abholung an Ihrem Hotel in Casablanca oder am Flughafen. Nordwärts nach Rabat zum Hassan-Turm und zur Kasbah der Udayas über der Flussmündung. Landeinwärts nach Volubilis, der römischen Stadt, deren Bodenmosaike noch unter freiem Himmel an ihrem Platz liegen, dann Meknès mit Bab Mansour und den kaiserlichen Speichern Moulay Ismails. Ankunft in Fès am Abend; Nacht in einem Riad in der Medina.",
        stop: { name: "Fès", lat: 34.034653, lng: -5.016193 } },
      { day: 2, driving: "—", distance: "Zu Fuß", stay: "Riad in der Medina von Fès", meals: "Frühstück",
        title: "Fès — ein ganzer geführter Tag in der Medina",
        description: "Ein lizenzierter Guide aus Fès für den ganzen Tag, was die Medina wirklich verlangt: Fès el-Bali hat rund neuntausend Gassen und keine Fahrzeuge. Die Chouara-Gerbereien, die Medresen Al-Attarine und Bou Inania, die Qarawiyyin — 859 gegründet und die älteste durchgehend betriebene Universität der Welt —, die nach Gewerken geordneten Souks und das Töpferviertel. Zweite Nacht im selben Riad.",
        stop: { name: "Medina von Fès", lat: 34.0653, lng: -4.9734 } },
      { day: 3, driving: "≈7,5 Std.", distance: "≈460 km", stay: "Wüstencamp, Erg Chebbi", meals: "Frühstück, Abendessen im Camp",
        title: "Fès → Ifrane → Midelt → Erfoud → Erg Chebbi",
        description: "Der lange Tag, in Etappen zerlegt. Hinauf durch die Zedernwälder des Mittleren Atlas nach Ifrane, einer Stadt mit Steildächern auf 1.665 m, mit Berberaffen in den Zedern dahinter. Hinunter über Midelt und das Ziz-Tal — eine kilometerlange Schlucht voller Dattelpalmen — nach Errachidia und Erfoud. Kamelritt in die Dünen bei Sonnenuntergang, Abendessen und Berbermusik im Camp.",
        stop: { name: "Erg Chebbi, Merzouga", lat: 31.138236, lng: -3.970775 } },
      { day: 4, driving: "≈4,5 Std.", distance: "≈280 km", stay: "Hotel im Dades-Tal", meals: "Frühstück, Abendessen",
        title: "Erg Chebbi → Merzouga → Todra-Schlucht → Dades",
        description: "Sonnenaufgang über den Dünen und der Kamelritt zurück zum Frühstück. Westwärts auf der alten Karawanenstraße über Tinghir zur Todra-Schlucht, wo die Wände auf zehn Meter zusammenrücken und dreihundert Meter aufragen. Weiter ins Dades-Tal zur Übernachtung, unter den Felsformationen, die man hier Affenfinger nennt.",
        stop: { name: "Dades-Schluchten", lat: 31.5203, lng: -5.9906 } },
      { day: 5, driving: "≈5,5 Std.", distance: "≈330 km", stay: "—", meals: "Frühstück",
        title: "Dades → Kalaat M'Gouna → Ouarzazate → Aït Ben Haddou → Marrakesch",
        description: "Durch Kalaat M'Gouna, die Rosenstadt, in der die Damaszener Rosen des Tals destilliert werden, nach Ouarzazate und zu den Atlas Film Studios. Mittagessen in Aït Ben Haddou, dem UNESCO-Ksar, der auf der Leinwand für die halbe Antike eingestanden hat, dann über den Tizi n'Tichka (2.260 m) und am späten Nachmittag nach Marrakesch.",
        stop: { name: "Marrakesch", lat: 31.6295, lng: -7.9811 } },
    ],
    faq: [
      {
        q: "Beginnt die Tour in Casablanca und endet in Marrakesch?",
        a: "Ja. Wir holen Sie in Casablanca ab — an Ihrem Hotel oder am Flughafen, wie es Ihnen passt — und die Tour endet am fünften Tag in Marrakesch. Sie ist als Durchquerung des Landes angelegt und nicht als Rundreise, und genau das erlaubt Ihnen, den Norden, die Sahara und den Hohen Atlas zu sehen, ohne dieselbe Strecke zweimal zu fahren.",
      },
      {
        q: "Können Sie uns am Ende zurück nach Casablanca bringen?",
        a: "Ja, als Extra und nicht als Teil der Tour. Es sind rund 270 km Autobahn ab Marrakesch, etwa drei Stunden, und wir nennen Ihnen den Preis mit Ihrer Buchung. Viele Reisende fliegen stattdessen ab Marrakesch oder nehmen den Zug, der in etwa drei Stunden nach Casablanca fährt und bequem und günstig ist.",
      },
      {
        q: "Wie lang sind die Fahrtage?",
        a: "Tag eins etwa sechs Stunden, verteilt auf drei Stopps; Tag zwei ohne Fahrt; Tag drei ist mit rund siebeneinhalb Stunden der längste, unterbrochen von Ifrane und dem Ziz-Tal; Tag vier etwa viereinhalb und Tag fünf etwa fünfeinhalb Stunden. Der volle Tag in Fès liegt bewusst zwischen den beiden längsten Etappen.",
      },
      {
        q: "Warum brauchen wir in Fès einen lokalen Guide?",
        a: "Weil Fès el-Bali rund neuntausend Gassen hat, keine Fahrzeuge und keine Logik, die sich an einem Nachmittag erschließt. Ein lizenzierter Guide aus Fès ist für den ganzen Tag inbegriffen: Er bringt Sie in die Medresen und Gerbereien, erklärt, was Sie sehen, und beendet das ständige Verhandeln, das Alleinreisende anzieht. Das ist der größte Unterschied zwischen einem guten und einem zermürbenden Tag in Fès.",
      },
      {
        q: "Wie ist das Wüstencamp?",
        a: "Sie erreichen es bei Sonnenuntergang per Kamel; es ist ein privates Zelt für Ihre Gruppe mit Abendessen, Frühstück und Berbermusik am Feuer. Die Badsituation hängt von der Camp-Kategorie ab, und wir sagen Ihnen vor der Buchung genau, was Sie bekommen. Unser [Wüstencamp-Leitfaden](/de/blog/wuestencamp-marokko-wie-es-wirklich-ist) erklärt die Unterschiede vollständig.",
      },
      {
        q: "Ist das besser, als in Marrakesch zu starten?",
        a: "Das hängt davon ab, wo Sie landen. Wenn Sie nach Casablanca fliegen — wie die meisten Langstreckenflüge —, sparen Sie sich die Fahrt nach Süden, bevor der Urlaub überhaupt beginnt. Sind Sie bereits in Marrakesch, deckt unsere [3-Tage-Tour Marrakesch–Fès](/de/tours/marrakesch-fes-3-tage) dieselbe Strecke in umgekehrter Richtung ab.",
      },
    ],
    seoTitle: "Casablanca nach Marrakesch — 5 Tage",
    seoDescription:
      "Private 5-Tage-Tour ab Casablanca: Rabat, Volubilis, Meknès, zwei Nächte in Fès, die Dünen des Erg Chebbi und die Schluchten bis Marrakesch.",
    meetingPoint: { lat: 33.5731, lng: -7.5898, name: "Casablanca — Ihr Hotel oder Flughafen Mohammed V" },
  },
];
