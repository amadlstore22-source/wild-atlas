...
export const TOURS: Tour[] = [
  ...
  // ─────────────────────────────────────────────
  {
    ...
    includes: [
      ...
      "3 noches de alojamiento en refugio de montaña",
      "Todas las comidas durante el trek",
      "Mulero para el equipaje del grupo",
    ...
    seoTitle: "Trekking a la Cima del Toubkal 4 Días",
    seoDescription: "Conquista el Jbel Toubkal (4.167 m) con un guía bereber titulado. Trekking de cima de 4 días desde Marrakech, con refugios.",
    featured: true,
  },
  {
    id: "2",
    ...
    includes: [
      ...
      "1 noche en campamento en el desierto (cena y desayuno)",
      "1 night hotel in Ouarzazate, Merzouga or Dades Gorges",
      "Guía del desierto con experiencia",
    ],
    excludes: [
      "Almuerzos",
    ...
    faq: [
      ...
      { q: "¿Cómo son los baños y las duchas del campamento?", a: "Los campamentos permanentes que utilizamos tienen tiendas de baño con agua corriente y ducha de verdad — privada o compartida según el campamento. La presión en mitad del Erg es modesta, pero es una ducha caliente de verdad y no un cubo. Si le importa tener una tienda con baño privado, indíquelo al reservar y le presupuestaremos un campamento que las tenga." },
      { q: "¿Puedo cargar el móvil en el desierto?", a: "Sí. El campamento tiene electricidad, así que puede cargar el móvil y la batería de la cámara, y hay wifi: lento en mitad de las dunas, pero suficiente para mensajes y fotos." },
    ...
    seoTitle: "Tour de 3 Días por el Desierto del Sáhara",
    seoDescription: "Paseo en camello hacia Erg Chebbi al atardecer y noche bajo las estrellas. Tour de 3 días de Marrakech al Sáhara con Aït Ben Haddou.",
    featured: true,
  },
  {
    id: "3",
    ...
    faq: [
      ...
      { q: "¿De qué tamaño es el grupo?", a: "Entre 2 y 15 personas, y la excursión es privada: el grupo es el suyo, así que solo caminará con las personas con las que ha reservado. El precio por persona baja a medida que crece el grupo." },
    ],
    meetingPoint: { lat: 31.3489, lng: -7.7411, name: "Ourika Valley, High Atlas" },
    seoTitle: "Excursión de un Día al Valle de Ourika",
    seoDescription: "Camina hasta las cascadas de Setti Fatma a través de pueblos bereberes y arroyos de montaña, a solo 45 minutos de Marrakech.",
    featured: true,
  },
  {
    id: "4",
    ...
    faq: [
      ...
      { q: "¿De qué tamaño es el grupo?", a: "Entre 2 y 15 personas, y la excursión es privada: el grupo es el suyo, así que solo viajará con las personas con las que ha reservado. El precio por persona baja a medida que crece el grupo." },
    ...
    seoTitle: "Cascadas de Ouzoud, excursión de un día",
    seoDescription: "Visita la cascada más alta de Marruecos — 110 metros de agua en caída, monos de Berbería salvajes y un paseo en barca por la garganta.",
    featured: false,
  },
  {
    id: "5",
    ...
    seoTitle: "Tour al Atardecer en el Desierto de Agafay",
    seoDescription: "Vive el Sáhara en 30 minutos — quad, paseo en camello al atardecer y una cena bereber tradicional en el desierto de piedra de Agafay, cerca de Marrakech.",
    featured: false,
  },
  {
    id: "6",
    ...
    includes: [
      "Guía privado en inglés, francés, español y árabe",
    ...
    seoTitle: "Tour Cultural por la Medina de Marrakech",
    seoDescription: "Explora la medina de Marrakech, Patrimonio de la UNESCO, con un guía local — curtidurías, Medersa Ben Yusef, Jemaa el-Fna y jardines ocultos de riad.",
    featured: false,
  },
  {
    id: "7",
    ...
    includes: [
      ...
      "2 noches de alojamiento en riad",
      "Desayuno diario",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Tour de 3 Días de Marrakech a Fez",
    seoDescription: "Viaja de Marrakech a Fez pasando por Tizi n'Tichka, Aït Ben Haddou y los bosques de cedros del Atlas Medio.",
    featured: false,
  },
  {
    id: "8",
    ...
    brief: [
      "Siete días cruzando el macizo del Mgoun, que es la parte del Alto Atlas a la que el tránsito de trekking nunca llega. El primer día son 5 horas de carretera hasta Aït M'hamed y una noche con una familia bereber. El segundo atraviesa el Aït Bouguemez —el «valle feliz»— hasta acampar en Agouti, a 2.600 m. El tercero cruza el primer puerto alto, el Tizi n'Ait Imi a 3.650 m, con 1.050 m de desnivel. El cuarto arranca antes del amanecer para coronar el Jbel Mgoun, de 4.068 m, la segunda cumbre más alta de Marruecos, y baja después a la garganta del Tessaoute.",
      "Los días quinto y sexto son la razón por la que los trekkers con experiencia eligen esto en lugar de una ruta al Toubkal. El quinto recorre la garganta del Tessaoute, de paredes rojas, con baño salvaje en el río; el sexto sale de la garganta hacia Bou Tharar y una noche con una familia de la aldea. El séptimo regresa a Marrakech por el valle de las rosas y termina hacia las 16:00. Cuatro noches de acampada y dos con familias.",
      "Está clasificado como experto, y la clasificación tiene que ver con la acumulación más que con la técnica. Ningún día exige conocimientos de alpinismo. Pero son siete días consecutivos en altura, en un territorio con pocos puntos de salida, y el equipo de mulas transporta el campamento porque no hay dónde reabastecerse. Quien haya hecho el Toubkal con comodidad y busque el siguiente paso encontrará que esto es, realmente, el siguiente paso.",
      "Por persona: 1.350 € en solitario, 760 € para dos, 710 € para tres, 680 € para cuatro, 625 € para cinco y 596 € para seis, en un grupo limitado a ocho. Incluye un guía de alta montaña titulado y experto, todas las comidas durante siete días, el equipo de mulas, los campamentos y las estancias con familias, las tasas del parque nacional y —algo digno de mención en un trek tan remoto— comunicación por satélite de emergencia.",
      "Aquí el seguro de viaje y médico es obligatorio y no recomendable, y conviene leerlo tal cual: del tercer al sexto día se está muy lejos de una carretera. El equipo técnico de alpinismo y las propinas no están incluidos. Si compara esto con el Toubkal, la distinción honesta es que el Toubkal es una cima que cabe dentro de unas vacaciones y el Mgoun es una expedición que se convierte en las vacaciones.",
    ],
    ...
    includes: [
      "Guía experto titulado de alta montaña",
      "Todas las comidas del circuito",
      "Mulas para el transporte del equipaje",
      "Alojamiento con familias bereberes y camping",
    ...
    seoTitle: "Trekking al Macizo del M'Goun 7 Días",
    seoDescription: "Trekking de nivel experto de 7 días por el remoto macizo del M'Goun — cima del Jbel M'Goun (4.068 m).",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    seoTitle: "Excursión de un Día al Valle del Paraíso",
  ...
  },
  {
    ...
    faq: [
      ...
      { q: "¿De qué tamaño es el grupo?", a: "Entre 2 y 12 personas, y la excursión es privada: el grupo es el suyo. El grupo reducido es intencionado: el guía naturalista puede mostrar aves y fauna a todos." },
    ],
    meetingPoint: { lat: 30.0559, lng: -9.6320, name: "Souss-Massa National Park, Massa" },
    seoTitle: "Souss-Massa: fauna e ibis eremita",
    seoDescription: "Observa el ibis eremita, en peligro crítico de extinción, y flamencos en la reserva natural más importante de Marruecos. Guía naturalista experto.",
    featured: true,
  },
  {
    id: "11",
    ...
    faq: [
      ...
      { q: "¿De qué tamaño es el grupo?", a: "Entre 2 y 14 personas, y la excursión es privada: el grupo es el suyo, así que solo viajará con las personas con las que ha reservado. El precio por persona baja a medida que crece el grupo." },
    ],
    meetingPoint: { lat: 30.4702, lng: -8.8773, name: "Taroudant, Souss Valley" },
    seoTitle: "Excursión de un Día a Taroudant",
    seoDescription: "Descubre las murallas del siglo XVI mejor conservadas de Marruecos y los auténticos mercados bereberes de Taroudant, a 80 km de Agadir.",
    featured: false,
  },
  {
    id: "12",
    ...
    seoTitle: "Clase de Surf en Agadir",
    seoDescription: "Aprende a surfear en las cálidas olas atlánticas de la bahía de Agadir con un instructor ISA titulado. Tabla.",
    featured: false,
  },
  {
    id: "13",
    ...
    includes: [
      ...
      "2 noches de alojamiento en casa de huéspedes bereber",
      "Todas las comidas",
      "Transporte de ida y vuelta desde Agadir",
      "Mula para el transporte del equipaje",
    ],
    ...
    seoTitle: "Trekking al Antiatlas 3 Días desde Agadir",
    seoDescription: "Trekking de 3 días por la cadena montañosa más infravalorada de Marruecos — picos de granito rosa, gargantas floridas de almendros y pueblos bereberes remotos.",
    featured: true,
  },
  {
    id: "14",
    ...
    brief: [
      "Casi todos los viajes al Sáhara en Marruecos salen de Marrakech. Este sale de Agadir y toma la ruta del sur por Tata y Foum Zguid hasta el Erg Chegaga, que es un desierto verdaderamente distinto del de las postales. Chegaga es el campo de dunas más grande y remoto del país, al que se llega en 4x4 campo a través y no en autocar hasta un campamento junto a la carretera.",
      "Sea claro consigo mismo respecto a la carretera, porque es el rasgo que define el viaje: unas 8 horas y 450 km en cada sentido, los dos días. Es mucho vehículo para un circuito de dos días, y es el precio de alcanzar Chegaga desde la costa. A cambio se obtiene un campo de dunas donde no se comparte la puesta de sol con otras cincuenta personas. Si el problema son los trayectos largos más que la distancia, la versión de 4 días desde Marrakech encaja mejor.",
      "El primer día va de Agadir a Tata y Foum Zguid y entra en las dunas, con llegada para el paseo en camello al atardecer y la cena en el campamento. El segundo día es el amanecer sobre el erg y luego la vuelta por el palmeral del valle del Draa y sus kasbahs. Una noche bajo lona, y el campamento queda lo bastante lejos de cualquier población como para que la Vía Láctea se vea sin esfuerzo.",
      "Por persona: 790 € en solitario, 400 € para dos, 340 € para tres, 310 € para cuatro y 280 € para cinco. Incluye el transporte en 4x4 durante todo el trayecto, un guía del desierto con experiencia, la noche en el campamento en tienda de dormir privada con cena y desayuno, y todos los paseos en camello. Hay tienda con baño privado disponible si prefiere no usar instalaciones compartidas: conviene preguntarlo al reservar y no a la llegada.",
      "La comida del primer día no está incluida, ni tampoco los artículos personales ni las propinas. El grupo es de 2 a 10 personas y el viaje es privado. Está clasificado como fácil: no hay prácticamente nada de caminata y lo único que realmente exige es tolerar una jornada larga en vehículo por una carretera que la mayoría de los visitantes de Marruecos no llega a ver nunca.",
    ],
    ...
    highlights: [
      ...
      "Campamento bereber bajo la Vía Láctea — tienda con baño privado opcional",
      "Ruta sur pasando por Tata y Foum Zguid",
    ],
    includes: [
      "Transporte en 4x4 durante todo el recorrido",
      "Guía del desierto con experiencia",
      "1 noche en campamento, tienda privada para dormir (cena y desayuno)",
      "Todos los paseos en camello",
    ],
    excludes: ["Almuerzo el día 1", "Gastos personales y propinas"],
    itinerary: [
      {
        day: 1,
        meals: "D",
    ...
    faq: [
      ...
      { q: "¿Cómo es el campamento?", a: "Un campamento permanente en las dunas de Chegaga para una noche, con cena y desayuno incluidos. La tarifa estándar incluye una tienda privada para dormir con un bloque de aseos compartido a pocos pasos. Hay tiendas con baño privado (ducha y aseo dentro de la tienda) por +30 € por persona; el circuito tiene una sola noche en el desierto, así que el suplemento se aplica una vez. El cielo estrellado y el silencio son lo que la mayoría recuerda." },
      { q: "¿Qué está incluido?", a: "Transporte en 4x4 durante todo el viaje, un guía del desierto experimentado, una noche en el campamento en tienda privada con cena y desayuno, y todos los paseos en camello. Los aseos en la tarifa estándar son un bloque compartido; la tienda con baño privado cuesta +30 € por persona. El almuerzo del día 1, los artículos personales y las propinas no están incluidos." },
      { q: "¿Es exigente?", a: "Fácil. La distancia se cubre en 4x4 y los paseos en camello son cortos y opcionales." },
    ],
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — tu hotel o riad" },
    seoTitle: "Tour de 2 Días al Sáhara desde Agadir",
    seoDescription: "Las remotas dunas de Erg Chegaga por la ruta sur del valle del Draa — paseo en camello, campamento bereber y amanecer sobre el Sáhara.",
    featured: true,
  },
  {
    id: "15",
    ...
    seoTitle: "Valle del Souss: argán y cultura",
    seoDescription: "Una cooperativa de argán gestionada por mujeres, un apicultor y un almuerzo con una familia bereber en el valle del Souss.",
    featured: false,
  },
  {
    id: "16",
    ...
    seoTitle: "Excursión de un Día a Essaouira",
    seoDescription: "Excursión de un día desde Agadir hasta la medina azul y blanca de Essaouira, Patrimonio de la UNESCO — murallas portuguesas del siglo XVIII.",
    featured: false,
  },
  {
    id: "17",
    ...
    seoDescription: "Tour de 4 días desde Marrakech hasta las calles azules de Chefchaouen, pasando por Fez, las ruinas romanas de Volubilis y Mequinez.",
    featured: false,
  },
  {
    id: "18",
    ...
    includes: [
      "Transporte privado en 4x4 durante todo el recorrido",
      "Guía de habla inglesa, francesa y española",
      "4 noches de alojamiento en riad",
      "Desayuno diario",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Ciudades Imperiales de Marruecos, 5 días",
    seoDescription: "Gran circuito por las cuatro capitales imperiales de Marruecos en 5 días. Ruinas romanas de Volubilis, curtidurías Chouara, Bab Mansour y la Torre Hassan.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    includes: [
      "Transporte en minibús con aire acondicionado durante todo el recorrido",
      "Chófer-guía de habla inglesa",
      "1 noche en campamento bereber en el desierto (cena y desayuno)",
      "Excursión en camello al atardecer",
      "Agua mineral y té",
    ],
    excludes: [
      "Almuerzos ambos días",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    featured: false,
    seoTitle: "Tour de 2 Días de Marrakech a Zagora",
    seoDescription: "La ruta más rápida al Sáhara — Aït Ben Haddou, los 200 km de palmeral del valle del Draa y un paseo en camello por las dunas.",
  },
  {
    id: "24",
    ...
    includes: [
      ...
      "Todas las excursiones en camello",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    featured: true,
    seoTitle: "Tour de Desierto de 3 Días a Erg Chegaga",
    seoDescription: "La experiencia más remota del desierto de Marruecos — 3 días desde Marrakech a Erg Chegaga vía cruce en 4x4, una noche en un campamento bereber privado.",
  },
  {
    id: "25",
    ...
    includes: [
      "Transporte en minibús o 4x4 con aire acondicionado durante todo el recorrido",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    featured: true,
    seoTitle: "Tour de Desierto de 4 Días desde Marrakech",
    seoDescription: "El circuito completo del desierto: 4 días por Aït Ben Haddou, la garganta de Todra, Erg Chebbi y la Ruta de las Mil Kasbahs.",
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    includes: [
      "Transporte en 4x4 con aire acondicionado durante todo el recorrido",
      "Chófer-guía de habla inglesa",
      "1 noche de hotel en el valle del Dades o en Tinghir (cena y desayuno)",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — tu hotel o riad" },
    featured: false,
    seoTitle: "Tour Desierto 3 Días de Agadir a Merzouga",
    seoDescription: "De la costa atlántica de Agadir al Sáhara — vía Taroudant, Taliouine, Aït Ben Haddou y un paseo en camello al atardecer en Erg Chebbi.",
  },
  {
    id: "27",
    ...
    includes: [
      "Transporte con aire acondicionado durante todo el recorrido",
      "Chófer-guía de habla inglesa",
      "1 noche en campamento bereber en el desierto (cena y desayuno)",
      "Excursión en camello al atardecer",
      "Agua mineral y té de menta",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — tu hotel o riad" },
    featured: false,
    seoTitle: "Tour Desierto 2 Días de Agadir a Zagora",
    seoDescription: "De la costa de Agadir al desierto de Zagora en 2 días — vía Taroudant, los 200 km de palmeral del valle del Draa y un paseo en camello al atardecer.",
  },
  {
    id: "28",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — tu hotel o riad" },
    featured: false,
    seoTitle: "Erg Chegaga 3 días desde Agadir",
    seoDescription: "El desierto más remoto de Marruecos desde Agadir — 3 días por el Antiatlas hasta Erg Chegaga en 4x4, una noche en un campamento bereber privado. Menos turistas.",
  },
  {
    id: "29",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — tu hotel o riad" },
    featured: false,
    seoTitle: "Tour de Desierto de 4 Días desde Agadir",
    seoDescription: "El gran tour de desierto completo desde Agadir — 4 días por Taroudant, Aït Ben Haddou, la garganta de Todra.",
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — tu hotel o riad" },
    seoTitle: "Tour de 4 Días de Agadir a Fez — Alto Atlas",
    seoDescription: "Viaja de Agadir a Fez pasando por Marrakech, Tizi n'Tichka y los bosques de cedros del Atlas Medio. Tour privado en 4x4 de 4 días con alojamiento en riad.",
    featured: false,
  },
  {
    id: "20",
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — tu hotel o riad" },
    seoTitle: "Tour de 5 Días de Agadir a Chefchaouen",
    seoDescription: "Tour de 5 días desde Agadir hasta la Ciudad Azul de Marruecos, pasando por Marrakech, Fez, las ruinas romanas de Volubilis y las puertas imperiales de Mequinez.",
    featured: false,
  },
  {
    id: "21",
    ...
    includes: [
      "Transporte privado en 4x4 durante todo el recorrido",
      "Guía de habla inglesa, francesa y española",
      "5 noches de alojamiento en riad",
      "Desayuno diario",
      "Todos los traslados, peajes y entradas",
    ],
    excludes: ["Almuerzos y cenas", "Propinas"],
    ...
    meetingPoint: { lat: 30.4278, lng: -9.5981, name: "Agadir — tu hotel o riad" },
    seoTitle: "Ciudades Imperiales de Marruecos, 6 días",
    seoDescription: "Gran circuito de 6 días desde Agadir por las cuatro ciudades imperiales de Marruecos — Marrakech, Mequinez, Fez y Rabat. 4x4 privado con alojamiento en riad.",
    featured: false,
  },
  ...
  // ─────────────────────────────────────────────
  {
    ...
    includes: [
      "Guía de montaña profesional titulado",
      "5 noches de alojamiento (refugios, casas rurales y camping)",
      "Todas las comidas durante el trek",
      "Mulas y muleros para el equipaje del grupo y el campamento",
      "Entradas al Parque Nacional del Toubkal",
      "Traslado de ida y vuelta desde Marrakech",
    ],
    excludes: [
      "Seguro de viaje (obligatorio)",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trekking de 6 Días",
    seoDescription: "El circuito completo de 6 días del Toubkal desde Marrakech — puertos de altura, el turquesa Lago Ifni y la cima del Jbel Toubkal (4.167 m).",
    featured: false,
  },
  {
    id: "31",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trekking al Monte Toubkal en 2 Días",
    seoDescription: "Sube al Jbel Toubkal (4.167 m) en 2 días desde Marrakech — la ruta más rápida al pico más alto del norte de África. Noche en refugio, todas las comidas.",
    featured: false,
  },
  {
    id: "32",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Toubkal 3 días por Aguelzim",
    seoDescription: "Sube al Toubkal (4.167 m) por la ruta escénica — 3 días por el valle de Azzaden, las cascadas de Ighouliden y el Puerto de Aguelzim (3.560 m). Guía titulado.",
    featured: false,
  },
  {
    id: "33",
    ...
    includes: [
      "Guía de montaña profesional titulado (cualificado en alta montaña)",
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Tres Picos de 4.000 m del Toubkal",
    seoDescription: "Corona tres cimas de 4.000 m del Alto Atlas en 3 días — Timesguida (4.089 m), Ras Ouanoukrim (4.083 m) y Toubkal (4.167 m).",
    featured: false,
  },
  {
    id: "34",
    ...
    includes: [
      ...
      "Todas las degustaciones a lo largo del recorrido",
      "Ingredientes y clase de cocina",
      "Almuerzo completo de tajín que ayudas a preparar",
      "Ceremonia del té a la menta",
    ],
    excludes: ["Recogida en hoteles fuera de la medina", "Propinas para el guía y la familia anfitriona"],
    itinerary: [
      {
        day: 1,
        meals: "L",
    ...
    seoTitle: "Tour gastronómico de Marrakech",
    seoDescription: "Tour gastronómico de medio día por Marrakech: recorre los zocos de especias probando platos y luego cocina un auténtico tajín con una familia local.",
    faq: [
  ...
  },
  {
    ...
    brief: [
      "La mayoría de los circuitos por el desierto mencionan las estrellas en el folleto y luego le dejan mirarlas por su cuenta. Este está construido alrededor del cielo: después del paseo en camello al atardecer y la cena, un guía astrónomo monta un telescopio en el campamento y repasa los planetas, las constelaciones y los objetos de cielo profundo visibles esa noche, explicados en lenguaje corriente y no en jerga. No hace falta equipo ni conocimientos previos.",
      "La razón por la que funciona precisamente en el Erg Chebbi es la distancia a cualquier luz eléctrica. No hay resplandor urbano en ninguna dirección, así que la Vía Láctea se ve a simple vista en una noche despejada, no como una mancha tenue sino como una estructura que cruza el cielo. Eso es más raro de lo que la gente imagina; en Europa casi no queda ningún lugar tan oscuro.",
      "La contrapartida es el trayecto. El Erg Chebbi está a unos 560 km y cerca de 8 horas de Marrakech, en cada sentido, y este es un circuito de dos días: una jornada larga de carretera, una noche en el campamento y otra jornada larga de vuelta. El primer día se llega para el paseo en camello y la cena; el segundo es el amanecer sobre las dunas y el regreso. Quien prefiera repartir ese trayecto debería plantearse un itinerario por el desierto de 3 o 4 días.",
      "Por persona: 518 € en solitario, 260 € para dos, 191 € para tres, 160 € para cuatro, 139 € para cinco y 121 € para seis. Incluye el transporte de ida y vuelta desde Marrakech, el paseo en camello al atardecer, la noche en el campamento, la cena y el desayuno, y la sesión con telescopio junto al guía astrónomo. La comida del mediodía en ruta no está incluida, aunque hay paradas, y el seguro de viaje y las propinas van aparte.",
      "Dos apuntes prácticos. La fase lunar importa más que la estación: la luna llena borra los objetos débiles, así que si viene por el cielo profundo, reserve en torno a la luna nueva. Y las noches del desierto son frías del otoño a la primavera, más de lo que la mayoría prevé; la observación se hace al aire libre, quieto y bien entrada la noche. Traiga una capa de abrigo que le parezca excesiva. Grupo privado de 2 a 10 personas.",
    ],
    ...
    excludes: [
      "Seguro de viaje",
      "Almuerzo en ruta (hay paradas disponibles)",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Observación de Estrellas Merzouga",
    seoDescription: "Dos días de Marrakech a Merzouga para ver las estrellas: camellos al atardecer, telescopio guiado y una noche en Erg Chebbi.",
    faq: [
  ...
  },
  {
    ...
    brief: [
      "El Azzaden es el valle inmediatamente al oeste del corredor Imlil–Toubkal, y la diferencia de afluencia es justamente lo interesante. El primer día son 1,5 horas de carretera desde Marrakech hasta Imlil, después unos 700 m de subida por el puerto de Tizi Mzik, a 2.684 m —con el macizo del Toubkal abriéndose a su espalda—, y un descenso entre bosque de enebros hasta la aldea de Tizi Oussem, a 1.850 m. Cinco o seis horas de marcha. El segundo día cruza el Tizi Oudid y baja a Aguersioual, unos 12 km y cinco horas, y después el regreso en coche.",
      "Está clasificado como moderado, y esa clasificación aquí significa algo. No hay cima, no hay pedreras y nada supera los 2.700 m aproximadamente, así que la altitud nunca llega a ser el problema que sí es en el Toubkal. Lo que hace falta es poder caminar cinco o seis horas por senderos de montaña dos días seguidos. Quien camina con regularidad lo encuentra cómodo; quien no, lo vive como un esfuerzo real pero asumible.",
      "La noche se pasa en una casa de huéspedes familiar en Tizi Oussem, no en un refugio ni en una tienda. Eso importa más de lo que parece: un refugio es un dormitorio lleno de gente que hace la misma ascensión, mientras que una casa de huéspedes de aldea es el hogar de alguien, con la cena preparada por la familia y un valle que se queda en silencio al anochecer. Es la parte de la que los viajeros nos escriben después.",
      "Por persona: 285 € en solitario, 161 € para dos, 142 € para tres, 133 € para cuatro, 124 € para cinco y 116 € para seis. Cubre el guía de montaña titulado, la noche en la casa de huéspedes, todas las comidas del trek, una mula para el equipaje del grupo y el traslado de ida y vuelta desde Marrakech. Usted solo lleva una mochila de día. El seguro de viaje aquí es recomendable más que obligatorio, el equipo personal corre de su cuenta y las propinas del guía y del muletero van aparte.",
      "Si duda entre este trek y uno del Toubkal, la pregunta es qué espera de la montaña. El Toubkal es una cima y una jornada de altitud. El Azzaden son aldeas, bancales y nogales, recorridos a un ritmo que le deja mirar alrededor. Grupo privado de 2 a 12 personas, así que el ritmo es el suyo.",
    ],
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trekking de 2 días por el valle de Azzaden",
  ...
  },
  {
    ...
    brief: [
      "Tres días caminando de valle en valle, sin ninguna cima en el plan. Desde Imlil se pasa al Azzaden el primer día (4 o 5 horas), se suben unos 800 m por los pastos altos hasta Tacheddirt, a 2.300 m, el segundo día (6 horas), y el tercero se desciende por la cuenca del Ourika hasta la carretera (5 horas) para volver a Marrakech. Cada noche es una casa de huéspedes de aldea distinta, así que se atraviesa un territorio habitado en lugar de regresar a un campamento base.",
      "La ausencia de cima es el diseño, no una renuncia. Nada de esta ruta supera los 2.700 m aproximadamente, lo que deja la altitud fuera de la ecuación, y no hay pedreras ni salidas antes del amanecer. Queda una marcha moderada y constante, con el tiempo y la energía para fijarse en dónde está uno: los bancales, los azibs de pastoreo, los pastores, el cambio de carácter de un valle al siguiente.",
      "Eso lo convierte en un primer trek de varios días muy sólido. Quien camina de vez en cuando encadena aquí tres días sin que el viaje se vuelva una prueba de resistencia, y como las casas de huéspedes están en aldeas y no en un circuito de trekking, las tardes son tranquilas y locales en lugar de compartidas con otros cuarenta caminantes que persiguen la misma cima.",
      "Por persona: 416 € en solitario, 235 € para dos, 206 € para tres, 192 € para cuatro, 181 € para cinco y 169 € para seis. Incluye el guía de montaña titulado, las dos noches en casa de huéspedes, todas las comidas del trek, una mula que carga el equipaje del grupo y el traslado de ida y vuelta desde Marrakech. Se camina con una mochila de día. El seguro de viaje es recomendable, el equipo personal corre de su cuenta y las propinas del guía y del muletero van aparte.",
      "Conviene decirlo con claridad: si el objetivo es pisar el Toubkal, este no es ese trek y no lo sustituye. Si el objetivo es el Alto Atlas en sí —las aldeas, los puertos, tres días de marcha sin reloj—, este circuito cubre más terreno y más variedad que cualquier ruta de cima. Grupo privado de 2 a 12 personas.",
    ],
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trekking de 3 días por el Atlas",
  ...
  },
  {
    ...
    brief: [
      "Caminar por la montaña con niños funciona cuando las jornadas son cortas y hay algo que mirar, y este itinerario está construido con esa regla y no adaptado después. El primer día: 1,5 horas de coche hasta Imlil y una caminata de 2 o 3 horas hasta la primera aldea. El segundo: 4 horas por las cascadas del valle. El tercero: cruce al lado del Ourika en 4 o 5 horas. El cuarto: 3 horas de bajada y el regreso en coche. Medias jornadas, no marchas forzadas.",
      "El terreno es deliberadamente fácil: el bajo Imlil y el Ourika, vados, nogales y cascadas en vez de puertos altos. Las mulas cargan todo el equipaje y también pueden llevar a un niño cansado, que es el detalle que convierte una tarde difícil en un no problema. Nadie carga mochila y a nadie se le mete prisa.",
      "Las noches son casas de huéspedes de aldea con familias bereberes durante tres noches, con todas las comidas incluidas. Hornear pan y el té con menta forman parte de las veladas en lugar de ser una demostración montada, y para la mayoría de las familias eso resulta ser lo que los niños recuerdan, más que la caminata.",
      "Este viaje tiene un mínimo de tres personas, así que la escala empieza ahí: 276 € por persona para tres, 257 € para cuatro, 241 € para cinco y 225 € para seis, hasta un grupo de catorce. Incluye un guía de montaña titulado con experiencia en familias, las tres noches en casa de huéspedes, todas las comidas, las mulas y el traslado de ida y vuelta desde Marrakech. El seguro de viaje es recomendable, el equipo de senderismo personal corre de su cuenta y las propinas del guía y de los muleteros van aparte.",
      "Sobre las edades: la limitación es caminar unas horas por terreno irregular, no la distancia ni la altitud, así que los niños en edad escolar suelen desenvolverse bien y los más pequeños se apañan con las mulas a mano. Si quiere una respuesta firme para su familia, díganos las edades al consultar y le diremos con franqueza si encaja en lugar de venderle el viaje.",
    ],
    ...
    meetingPoint: { lat: 31.1369, lng: -7.9169, name: "Imlil Village, Atlas Mountains" },
    seoTitle: "Trekking familiar por el Atlas 4 días",
  ...
  },
  {
    ...
    brief: [
      "Este es el circuito clásico Marrakech–Erg Chebbi con los trayectos reorganizados para que funcione con niños. La ruta es la que hace todo el mundo: cruzar el Atlas hasta Aït Ben Haddou y el Dades el primer día, atravesar las gargantas del Dades y del Todra hasta las dunas el segundo, y volver por Ouarzazate el tercero y el cuarto. Lo que cambia es la forma de las jornadas: unas 5 horas de coche el primer día y después 4, 4 y 4, divididas en etapas más cortas con paradas de verdad en lugar de dos tiradas largas.",
      "Lo más útil que conviene saber es que el desierto está realmente lejos de Marrakech. El Erg Chebbi queda a unos 560 km en cada sentido y ningún itinerario puede acortar esa distancia. Cuatro días es lo que lo hace cómodo: tres noches, tres camas distintas y una noche en las dunas que no va precedida y seguida de dos viajes de ocho horas. Las versiones de 2 días recorren la misma distancia en la mitad de tiempo, que es precisamente lo que hace que los niños lo pasen mal.",
      "Las noches son un hotel en el Dades con cena y desayuno, el campamento familiar del Erg Chebbi con cena y desayuno, y un hotel en Ouarzazate con desayuno. El campamento está pensado para familias y no gestionado como un vivac espartano: paseos en camello al atardecer y al amanecer, sandboard en las dunas y espacio para que los niños sean niños. Aït Ben Haddou, de camino, es la kasbah de Juego de Tronos y Gladiator, algo que suele funcionar bien con los mayores.",
      "La escala empieza en dos personas porque este viaje no se vende en solitario: 526 € por persona para dos, 399 € para tres, 346 € para cuatro, 314 € para cinco, 270 € para seis, 252 € para siete, 245 € para diez y 229 € para catorce. Incluye el vehículo con aire acondicionado durante todo el trayecto, un chófer-guía bilingüe inglés/francés, las tres noches descritas, los dos paseos en camello y todos los traslados y tasas de acceso.",
      "Las comidas del mediodía no están incluidas —calcule unos 12 a 15 € por comida— y la entrada a los estudios de cine del Atlas es opcional, unos 7 €. El seguro de viaje y las propinas van aparte. El grupo es de 2 a 12 personas y el viaje es privado, lo que en unas vacaciones en familia significa sobre todo que se puede parar cuando alguien lo necesita.",
    ],
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Tour familiar al desierto 4 días",
  ...
  },
  {
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Circuito 5 días Cima del Toubkal y Sáhara",
    seoDescription:
      "Combina las dos aventuras estrella de Marruecos: coronar el Jbel Toubkal (4167 m) y llegar a las dunas saharianas de Erg Chebbi.",
    faq: [
  ...
  },
  {
    ...
    includes: [
      "Traslados privados Marrakech ↔ desierto a la ida y a la vuelta",
      "Guía bereber del desierto titulado (inglés y francés)",
      "Camellos y camelleros para transportar el equipaje y el material",
      "Cocinero, equipo de cocina y todo el material de campamento",
      "Todas las comidas desde la cena del día 1 hasta el almuerzo del día 8",
      "Siete noches: hotel en Marrakech y campamentos móviles en el desierto",
      "Agua potable durante todo el trek",
    ],
    excludes: [
      "Vuelos internacionales",
      "Seguro de viaje: obligatorio para este trek",
      "Saco de dormir (alquiler disponible bajo petición)",
      "Un camello para montar en lugar de caminar al lado (20 € por camello y día)",
      "Refrescos y bebidas embotelladas",
      "Propinas para el guía, el cocinero y los camelleros",
    ],
    itinerary: [
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    featured: false,
    seoTitle: "Trek en camello de 8 días a Chegaga",
    seoDescription:
      "Camina por el Sáhara con una caravana de camellos: seis días a pie del valle del Draa a las dunas del erg Chegaga y M’hamid. Campamentos móviles, guía bereber.",
    faq: [
  ...
  },
  {
    ...
    highlights: [
      "Puerto de Tizi n'Tichka a través del Alto Atlas",
      "Ksar de Aït Ben Haddou, Patrimonio de la UNESCO",
      "Gargantas del Dades y del Todra",
      "Travesía en camello por las dunas de Erg Chebbi al atardecer",
      "Noche en un campamento bereber en el desierto",
    ],
    includes: [
    ...
    itinerary: [
      {
        ...
        title: "Marrakech → Aït Ben Haddou → Gargantas del Dades",
        description:
          "Salida de Marrakech sobre las 7:00 y paso del puerto de Tizi n'Tichka. Parada en Aït Ben Haddou y Uarzazate, y continuación por el Valle de las Mil Kasbahs. Noche en las gargantas del Dades.",
      ...
      },
      {
        ...
        driving: "≈5 h",
        distance: "≈300 km",
        title: "Dades → Garganta del Todra → Merzouga",
        description:
          "Mañana en la garganta del Todra y después ruta vía Erfoud hasta Merzouga. Paseo en camello por las dunas al atardecer, cena y percusión en el campamento.",
        stop: { name: "Erg Chebbi, Merzouga", lat: 31.138236, lng: -3.970775 },
      },
      {
        day: 3,
        driving: "≈9 h",
        distance: "≈560 km",
        title: "Amanecer sobre las dunas → Marrakech",
        description:
          "Amanecer sobre el Erg Chebbi y después el largo trayecto de regreso a Marrakech vía Alnif, Tazarine y Uarzazate. Llegada a primera hora de la tarde-noche.",
        stop: { name: "Marrakech", lat: 31.6295, lng: -7.9811 },
      },
    ],
    faq: [
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Merzouga 3 días tour compartido — €120",
    seoDescription: "Salida diaria compartida desde Marrakech a las dunas de Erg Chebbi: Aït Ben Haddou, gargantas del Dades y del Todra, paseo en camello y noche en campamento.",
    featured: false,
  },
  {
    id: "45",
    ...
    brief: [
      "Zagora es la noche en el desierto más cercana a Marrakech, y en eso consiste todo su atractivo. La ruta cruza el puerto de Tizi n'Tichka, pasa por Aït Ben Haddou y Ouarzazate, entra en los palmerales del valle del Draa y después un paseo en camello lleva hasta las dunas para la cena, los tambores y una noche en el campamento. El segundo día se vuelve por el mismo camino. Unos 360 km y alrededor de 8 horas en cada sentido.",
      "Sea honesto consigo mismo sobre las dunas antes de reservar. Las de Zagora son pequeñas —nada que ver con los muros de 150 metros del Erg Chebbi— porque Zagora es una ciudad del desierto con arena y no un gran erg. Ese es el intercambio que se acepta a cambio de un viaje que cabe en dos días en lugar de tres o cuatro. Quien va esperando Lawrence de Arabia se decepciona; quien va sabiendo que esta es la versión corta lo disfruta.",
      "A 85 € por persona es la noche en el desierto más barata que operamos, y el precio es fijo en lugar de una escala de grupo porque se trata de una salida compartida vendida por plaza. Se viaja en minibús con aire acondicionado junto a hasta otras dieciséis personas y un chófer que habla inglés o francés. El depósito es de 19 €. Incluye: transporte, la noche en el campamento, cena y desayuno, y el paseo en camello.",
      "No incluye: comidas del mediodía, bebidas, propinas ni entradas: Aït Ben Haddou en concreto cobra entrada en el propio sitio. Presupueste esos gastos aparte para que la jornada no le dé sorpresas.",
      "Si dispone de tres o cuatro días, Merzouga y el Erg Chebbi son mejor desierto. Si tiene dos días, o prefiere gastar la diferencia en otro punto de Marruecos, este circuito cumple con honestidad: una noche real bajo lona en el sur, a un precio que deja intacto el resto del viaje.",
    ],
    ...
    highlights: [
      "Puerto de Tizi n'Tichka y Aït Ben Haddou",
      "Palmerales del valle del Draa",
      "Paseo en camello por las dunas de Zagora",
      "Noche en un campamento bereber con cena y música",
    ],
    includes: [
      "Transporte en minibús compartido con aire acondicionado",
      "Una noche en un campamento en el desierto",
      "Cena y desayuno",
      "Paseo en camello",
      "Conductor de habla inglesa o francesa",
    ],
    ...
    itinerary: [
      {
        ...
        description:
          "Salida temprano por el Tizi n'Tichka. Paradas en Aït Ben Haddou y Uarzazate, y después hacia el sur por el valle del Draa. Paseo en camello por las dunas al atardecer y cena en el campamento.",
      ...
      },
      {
        ...
        driving: "≈8 h",
        distance: "≈360 km",
        title: "Amanecer → Marrakech",
        description:
          "Amanecer sobre las dunas, desayuno en el campamento y regreso a Marrakech por el valle del Draa y el Atlas. Llegada a última hora de la tarde.",
        stop: { name: "Marrakech", lat: 31.6295, lng: -7.9811 },
      },
    ],
    faq: [
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Desierto de Zagora tour compartido — €85",
  ...
  },
  {
    ...
    highlights: [
      "Las cascadas de Ouzoud, de 110 m, las más altas del norte de África",
      "Macacos de Berbería en libertad en el sendero del cañón",
      "Paseo en barca al pie de las cascadas",
      "Molinos de agua tradicionales todavía en funcionamiento",
    ],
    includes: [
    ...
    itinerary: [
      {
        ...
        title: "Día completo — Cascadas de Ouzoud",
        description:
          "Salida de Marrakech sobre las 8:00 y llegada a Ouzoud a media mañana. Bajada guiada por el cañón hasta la base de las cascadas, paseo en barca, avistamiento de macacos y tiempo libre para comer frente a los saltos de agua. Regreso a Marrakech a primera hora de la tarde-noche.",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Cascadas de Ouzoud excursión — €40",
    seoDescription: "Salida diaria compartida a las cascadas de Ouzoud: saltos de 110 m, monos de Berbería en libertad, paseo por el desfiladero y paseo en barca.",
    featured: false,
  },
  {
    id: "47",
    ...
    highlights: [
      "Paseo en camello por el desierto de piedra de Agafay al atardecer",
      "Cena en un campamento del desierto con el Alto Atlas en el horizonte",
      "Música en vivo y espectáculo de fuego",
      "De vuelta en Marrakech esa misma tarde-noche",
    ],
    includes: [
      "Traslado de ida y vuelta desde tu riad u hotel en Marrakech",
      "Paseo en camello",
      "Cena de tres platos",
      "Música en vivo y espectáculo de fuego",
    ],
    ...
    itinerary: [
      {
        ...
        title: "Tarde-noche — Desierto de Agafay",
        description:
          "Recogida en tu riad a última hora de la tarde. Paseo en camello por el desierto de piedra mientras cae la luz y después cena en el campamento con música y espectáculo de fuego. Regreso a Marrakech sobre las 22:30.",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Agafay: cena y paseo en camello — €30",
    seoDescription: "Velada en el desierto pétreo de Agafay: paseo en camello al atardecer, cena de tres platos, música en vivo y espectáculo de fuego, a 40 minutos de Marrakech.",
    featured: false,
  },
  {
    id: "48",
    ...
    highlights: [
      ...
      "El aire del Atlántico y una playa larga",
    ],
    includes: [
    ...
    itinerary: [
      {
        ...
        title: "Día completo — Essaouira",
        description:
          "Salida de Marrakech sobre las 8:00, con parada en una cooperativa de aceite de argán por el camino. Llegada a Essaouira a última hora de la mañana, con tiempo libre para la medina, las murallas, el puerto y la comida. Salida a media tarde y regreso a Marrakech a primera hora de la tarde-noche.",
    ...
    meetingPoint: { lat: 31.6295, lng: -7.9811, name: "Marrakech — tu hotel o riad" },
    seoTitle: "Essaouira excursión compartida — €30",
    seoDescription: "Salida diaria compartida a Essaouira: medina Patrimonio de la Humanidad, murallas del siglo XVIII, puerto pesquero azul y cooperativa de argán en el camino.",
    featured: false,
  },
  {
    id: "50",
  ...
  },
  {
    ...
    featured: false,
    localizedSlug: "casablanca-fez-sahara-marrakech-5-dias",
    title: "De Casablanca a Marrakech — Ciudades imperiales y Sáhara en 5 días",
    duration: "5 días / 4 noches",
    shortDescription:
      "De norte a sur de Marruecos en cinco días: Rabat, la Volubilis romana, Mequinez, dos noches en Fez, las dunas de Erg Chebbi y las gargantas hasta Marrakech.",
    description:
      "Un solo viaje a lo largo de todo el país, que empieza donde aterriza la mayoría y termina donde casi todos quieren estar. Del Atlántico al Sáhara y de vuelta al Alto Atlas: tres ciudades imperiales, el yacimiento romano mejor conservado de Marruecos, un día entero con guía en la medina de Fez, una noche en las dunas de Erg Chebbi y la carretera de las gargantas por Todra y Dades. Vehículo privado y conductor-guía durante todo el recorrido, así que el ritmo lo marca usted.",
    highlights: [
      "La torre Hassan y la kasbah de los Udayas en Rabat",
      "Volubilis — mosaicos romanos aún en su sitio, a cielo abierto",
      "Bab Mansour y los graneros imperiales de Mequinez",
      "Un día completo con guía en la medina de Fez",
      "Paseo en camello y noche en campamento en Erg Chebbi",
      "La garganta del Todra y el valle del Dades",
      "Aït Ben Haddou y los estudios de cine de Uarzazate",
    ],
    itinerary: [
      { day: 1, driving: "≈6 h", distance: "≈370 km", stay: "Riad en la medina de Fez", meals: "—",
        title: "Casablanca → Rabat → Volubilis → Mequinez → Fez",
        description: "Recogida en su hotel de Casablanca o en el aeropuerto. Hacia el norte a Rabat, para la torre Hassan y la kasbah de los Udayas sobre la desembocadura del río. Tierra adentro a Volubilis, la ciudad romana cuyos mosaicos siguen en el suelo a cielo abierto, y luego Mequinez para Bab Mansour y los graneros imperiales de Mulay Ismail. Llegada a Fez por la tarde; noche en un riad dentro de la medina.",
        stop: { name: "Fez", lat: 34.034653, lng: -5.016193 } },
      { day: 2, driving: "—", distance: "A pie", stay: "Riad en la medina de Fez", meals: "Desayuno",
        title: "Fez — un día completo en la medina con guía",
        description: "Un guía local autorizado durante todo el día, que la medina realmente exige: Fez el-Bali tiene unas nueve mil callejuelas y ningún vehículo. Las curtidurías Chouara, las madrazas Al-Attarine y Bou Inania, la Qarawiyyin —fundada en 859 y la universidad en funcionamiento más antigua del mundo—, los zocos organizados por oficios y el barrio de los alfareros. Segunda noche en el mismo riad.",
        stop: { name: "Medina de Fez", lat: 34.0653, lng: -4.9734 } },
      { day: 3, driving: "≈7 h 30", distance: "≈460 km", stay: "Campamento en Erg Chebbi", meals: "Desayuno, cena en el campamento",
        title: "Fez → Ifrán → Midelt → Erfoud → Erg Chebbi",
        description: "El día largo, repartido en etapas. Subida por los cedrales del Atlas Medio hasta Ifrán, una localidad de tejados a dos aguas a 1.665 m, con macacos de Berbería en los cedros de los alrededores. Bajada por Midelt y el valle del Ziz —un cañón de palmeras datileras que se extiende kilómetros— hacia Errachidia y Erfoud. Paseo en camello por las dunas al atardecer, cena y música bereber en el campamento.",
        stop: { name: "Erg Chebbi, Merzouga", lat: 31.138236, lng: -3.970775 } },
      { day: 4, driving: "≈4 h 30", distance: "≈280 km", stay: "Hotel en el valle del Dades", meals: "Desayuno, cena",
        title: "Erg Chebbi → Merzouga → Garganta del Todra → Dades",
        description: "Amanecer sobre las dunas y regreso en camello para desayunar. Hacia el oeste por la antigua ruta de caravanas y Tinghir hasta la garganta del Todra, donde las paredes se estrechan a diez metros y se elevan trescientos. Luego el valle del Dades para pasar la noche, bajo las formaciones rocosas que aquí llaman dedos de mono.",
        stop: { name: "Gargantas del Dades", lat: 31.5203, lng: -5.9906 } },
      { day: 5, driving: "≈5 h 30", distance: "≈330 km", stay: "—", meals: "Desayuno",
        title: "Dades → Kalaat M'Gouna → Uarzazate → Aït Ben Haddou → Marrakech",
        description: "Por Kalaat M'Gouna, el pueblo rosero donde se destilan las rosas de Damasco del valle, hasta Uarzazate y los Atlas Film Studios. Almuerzo en Aït Ben Haddou, el ksar declarado por la UNESCO que ha hecho de medio mundo antiguo en el cine, y después el puerto de Tizi n'Tichka (2.260 m) hasta Marrakech a última hora de la tarde.",
        stop: { name: "Marrakech", lat: 31.6295, lng: -7.9811 } },
    ],
    faq: [
      {
        q: "¿El circuito empieza en Casablanca y termina en Marrakech?",
        a: "Sí. Le recogemos en Casablanca —en su hotel o en el aeropuerto, lo que prefiera— y el circuito termina en Marrakech el quinto día. Está pensado como una travesía del país y no como un circuito circular, que es lo que permite ver el norte, el Sáhara y el Alto Atlas sin repetir carretera.",
      },
      {
        q: "¿Pueden llevarnos de vuelta a Casablanca al final?",
        a: "Sí, como extra y no dentro del precio. Son unos 270 km de autopista desde Marrakech, alrededor de tres horas, y se lo presupuestamos junto con la reserva. Muchos viajeros salen en avión desde Marrakech o toman el tren, que llega a Casablanca en unas tres horas y es cómodo y económico.",
      },
      {
        q: "¿Cuántas horas de carretera hay cada día?",
        a: "El primer día unas seis horas repartidas en tres paradas, el segundo ninguna, el tercero es el más largo con unas siete horas y media partidas por Ifrán y el valle del Ziz, el cuarto unas cuatro y media y el quinto unas cinco y media. El día completo en Fez está colocado a propósito entre las dos jornadas más largas.",
      },
      {
        q: "¿Por qué hace falta un guía local en Fez?",
        a: "Porque Fez el-Bali tiene unas nueve mil callejuelas, ningún vehículo y ninguna lógica que se revele en una tarde. Un guía autorizado de Fez está incluido el día entero: le hace entrar en las madrazas y las curtidurías, le explica lo que está viendo y corta la negociación constante que atrae a quien camina solo. Es la mayor diferencia entre un buen día en Fez y uno frustrante.",
      },
      {
        q: "¿Cómo es el campamento del desierto?",
        a: "Se llega en camello al atardecer, y es una jaima privada para su grupo con cena, desayuno y música bereber junto al fuego. Los baños varían según la categoría del campamento y le diremos exactamente cuál le corresponde antes de reservar. Nuestra [guía de campamentos del desierto](/es/blog/campamento-desierto-marruecos-realidad) explica todas las diferencias.",
      },
      {
        q: "¿Es mejor que empezar en Marrakech?",
        a: "Depende de dónde aterrice. Si vuela a Casablanca —como la mayoría de los vuelos de larga distancia— se ahorra el viaje hacia el sur antes de empezar las vacaciones. Si ya está en Marrakech, nuestro [circuito de 3 días Marrakech-Fez](/es/tours/marrakech-fez-3-dias) cubre el mismo terreno en sentido contrario.",
      },
    ],
    seoTitle: "De Casablanca a Marrakech — 5 días",
    seoDescription:
      "Circuito privado de 5 días desde Casablanca: Rabat, Volubilis, Mequinez, dos noches en Fez, las dunas de Erg Chebbi y las gargantas hasta Marrakech.",
    meetingPoint: { lat: 33.5731, lng: -7.5898, name: "Casablanca — su hotel o el aeropuerto Mohammed V" },
  },
];
