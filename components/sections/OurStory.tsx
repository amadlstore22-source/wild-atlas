    ...
    <section className="py-28 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="relative rounded-3xl overflow-hidden min-h-[560px] reveal-scale">
            <Image
            ...
            <div className="absolute bottom-6 left-6">
              <div className="bg-white/95 backdrop-blur-sm rounded-2xl px-6 py-5 shadow-2xl">
                <div className="font-serif text-forest text-4xl font-bold leading-none">{SITE.experienceYears}+</div>
          ...
          <div className="reveal-up">
            ...
            <h2 className="font-serif text-charcoal font-bold leading-[1.05] mb-8"
